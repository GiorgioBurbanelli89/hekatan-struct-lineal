...
import { j as Lt, l as Et, g as zt, c as Pt, __tla as __tla_1 } from "./aiAgent-DJM3ulrp.js";
              ...
              if (!c) {
                ...
                try {
                  const { modalAnalysis: N } = await ot(async () => {
                    const { modalAnalysis: I } = await import("./index-D1DJ3Bj_.js").then(async (m2) => {
                      await m2.__tla;
                      return m2;
                    });
                    return {
