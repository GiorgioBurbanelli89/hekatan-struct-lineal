import { v } from "./theme-C-zoknmI.js";
import { A as _, D as m, c as y } from "./aiAgent-DN1k8d69.js";
/**
* @license
...
* SPDX-License-Identifier: BSD-3-Clause
*/
const C = { CHILD: 2 }, w = (t) => (...e) => ({ _$litDirective$: t, values: e });
class z {
  constructor(e) {
  }
  get _$AU() {
...
const H = (t) => {
  t.type == C.CHILD && (t._$AP ?? (t._$AP = b), t._$AQ ?? (t._$AQ = G));
};
class M extends z {
  constructor() {
...
const d = /* @__PURE__ */ new WeakMap(), N = w(class extends M {
  render(t) {
    return _;
  }
  update(t, [e]) {
    var _a;
    const s = e !== this.G;
    return s && this.G !== void 0 && this.rt(void 0), (s || this.lt !== this.ct) && (this.G = e, this.ht = (_a = t.options) == null ? void 0 : _a.host, this.rt(this.ct = t.element)), _;
  }
  rt(t) {
  ...
  get lt() {
    var _a, _b;
    return typeof this.G == "function" ? (_a = d.get(this.ht ?? globalThis)) == null ? void 0 : _a.get(this.G) : (_b = this.G) == null ? void 0 : _b.value;
  }
  disconnected() {
...
function k({ dialogBody: t }) {
  const e = document.createElement("div"), s = D();
  function i() {
    return y`
      <dialog ref=${N(s)}>
