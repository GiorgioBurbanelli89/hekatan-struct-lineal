...
import { d as q, __tla as __tla_0 } from "./didacticCpp-CzlDWovh.js";
let J;
let __tla = Promise.all([
  ...
  J = {
    ...
    build(r, m) {
      ...
      for (let e = 0; e < x.length; e++) g.set(e, r.E_c), B.set(e, r.nu_c), E.set(e, w), k.set(e, R), v.set(e, 24);
      for (let e = 0; e < c.length; e++) {
        const a = x.length + e;
        g.set(a, r.E_s), k.set(a, r.E_s / 2.6), I.set(a, r.A_b * 1e-6), S.set(a, r.Iy_b * 1e-5), A.set(a, r.Iz_b * 1e-5), L.set(a, 31e-8), v.set(a, 78.5);
      }
