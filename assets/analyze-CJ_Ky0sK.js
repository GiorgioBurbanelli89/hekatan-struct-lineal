...
function go(t, n, e, a, c, f, r = {}) {
  const i = r.tipo ?? 9, h = r.gammaFac ?? 0.4, w = r.mod ?? null;
  let s, J, d;
...
function Jo(t, n, e, a) {
  ...
  if (Math.abs(l) > 1e-20) {
    ...
    const rt = ((_d = e == null ? void 0 : e.drillingTypes) == null ? void 0 : _d.get(a)) ?? 9, st = ((_e = e == null ? void 0 : e.drillingPenaltyScales) == null ? void 0 : _e.get(a)) ?? 0.4, I = (_f = e == null ? void 0 : e.membraneModifiers) == null ? void 0 : _f.get(a), Kt = (_g = e == null ? void 0 : e.shellModifiers) == null ? void 0 : _g.get(a), Jt = Array.isArray(Kt) && Kt.length >= 3 ? [Kt[0], Kt[1], Kt[2]] : typeof I == "number" && I !== 1 ? [I, I, I] : null;
    try {
