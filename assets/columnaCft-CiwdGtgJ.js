import { d as O, __tla as __tla_0 } from "./didacticCpp-ClOTguHC.js";
...
let __tla = Promise.all([
  ...
  Q = {
    ...
    build(e, f) {
      ...
      for (let t = 0; t < s.length; t++) u.set(t, R), F.set(t, A), M.set(t, A), P.set(t, E), $.set(t, x), C.set(t, D), I.set(t, 24 / 9.80665), L.set(t, e.t_tube), g.set(t, 0.2);
      f.elementInputs.val = {
        areas: u,
        momentsOfInertiaZ: M,
        momentsOfInertiaY: F,
