import { a as q } from "./analyze-C-HJ03ae.js";
import { d as A, __tla as __tla_0 } from "./didacticCpp-CzlDWovh.js";
let C;
let __tla = Promise.all([
  ...
  C = {
    ...
    build(t, a) {
      ...
      for (let e = 0; e < i; e++) g.set(e, t.t), p.set(e, t.E), f.set(e, t.nu), h.set(e, 24), S.set(e, 2);
      const j = t.bW * t.bH, H = t.bW * t.bH ** 3 / 12, L = t.bH * t.bW ** 3 / 12, k = H + L, N = t.E / (2 * (1 + t.nu)), O = /* @__PURE__ */ new Map();
      for (let e = 0; e < b; e++) {
        const n = i + e;
        p.set(n, t.E), f.set(n, t.nu), h.set(n, 24), _.set(n, j), y.set(n, H), E.set(n, L), X.set(n, k), O.set(n, N), Y.set(n, [
          t.bH,
          t.bW
        ]), I.set(n, [
          0,
