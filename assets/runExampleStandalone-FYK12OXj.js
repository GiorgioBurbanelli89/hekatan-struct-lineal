const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-D-3Y-F-j.js","assets/analyze-7BhWFIY2.js","assets/pureFunctionsAny.generated-DeJSBP3k.js","assets/didacticCpp-B0dUJB8U.js","assets/deform-A0Lxka8J.js","assets/preload-helper-V2P8TQsQ.js","assets/planeQ4-DsCzHfbV.js","assets/layeredQ4-DuXBBCkf.js","assets/mitc3-2FJr2z_r.js","assets/fiberSectionCft-CvKVMF85.js","assets/menegottoPinto-9Id4uJ7l.js"])))=>i.map(i=>d[i]);
import { _ as ot } from "./preload-helper-V2P8TQsQ.js";
import { o as kt, w as wt, V as B, x as xt, B as ut, b as ht, d as _t, y as $t, v as K } from "./theme-C-zoknmI.js";
import { P as Mt } from "./tweakpane-BXg6ZhiP.js";
import { c as Lt, d as Et, g as zt } from "./getViewer-BvS7-Znx.js";
      ...
      if (l == null ? void 0 : l.addFolder) {
        ...
        y.on("click", async () => {
          ...
          try {
            ...
            n("\u23F3 calculando\u2026");
            const t = new Worker(new URL("/hekatan-struct-lineal/assets/modal.worker-ChdrYMRl.js", import.meta.url), {
              type: "module"
            }), i = (D) => {
              const N = {};
              ...
              if (!c) {
                ...
                try {
                  const { modalAnalysis: N } = await ot(async () => {
                    const { modalAnalysis: I } = await import("./index-D-3Y-F-j.js").then(async (m2) => {
                      await m2.__tla;
                      return m2;
                    });
                    return {
