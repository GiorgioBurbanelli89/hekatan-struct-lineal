import { N as Zt, a6 as Bn, q as Es, v as G, a7 as Vs, D as kt, M as et, B as Me, F as vt, a8 as Ts, x as pt, a9 as $s, aa as Ls, h as qo, ab as Ko, r as an, ac as Yn, ad as Un, a4 as is, _ as je, a as ct, L as Kt, w as ls, b as Is, ae as Rs, f as it, V as _, $ as sn, af as fo, H as bo, d as _t, c as ho, Y as rs, Z as qn, G as Bs, z as Pn, A as Ds, ag as Zn, t as Xs, o as Ns, I as en, a2 as Sn, E as Go, S as xn, m as mo, ah as kn, g as Ho, i as Wo, j as Jo, C as Oo, K as Ys, U as Us, W as Zs, X as qs, T as Dn, P as wo, O as Ks } from "./theme-U-6D_qyI.js";
...
function xo(e, l) {
  ...
  const S = new Zt(p.grid), A = new Zt(p.grid).multiplyScalar(0.45), M = (se, V, ae, Q) => {
...
function ta(e, l, p, h) {
  ...
  return G.derive(() => {
    ...
    for (const M of A) {
      ...
      if (!ie) continue;
      const ce = new _(...K.slice(0, 3));
      if (ce.lengthSq() < 1e-30) continue;
      ce.normalize();
      const se = new sn(ce, new _(...ie), 1, 15637248, 0.3, 0.3), V = g * h.rawVal;
...
function es(e, l) {
  const p = new je(), h = Math.min(0.05 * e, 0.6), c = an(), m = new St("X", "red", "transparent"), f = new St(l ? "Z" : "Y", "green", "transparent"), g = new St(l ? "Y" : "Z", "blue", "transparent"), y = new sn(new _(1, 0, 0), new _(0, 0, 0), 1, c.axisArrow, 0.2, 0.2), S = new sn(new _(0, 1, 0), new _(0, 0, 0), 1, c.axisArrow, 0.2, 0.2), A = new sn(new _(0, 0, 1), new _(0, 0, 0), 1, c.axisArrow, 0.2, 0.2);
...
function Gn(e, l) {
  const p = new _(...e), c = new _(...l).clone().sub(p), m = c.length(), f = c.dot(new _(1, 0, 0)) / m, g = c.dot(new _(0, 1, 0)) / m, y = c.dot(new _(0, 0, 1)) / m, S = Math.sqrt(f ** 2 + g ** 2);
  let A = new fo().fromArray([[f, g, y], [-g / S, f / S, 0], [-f * y / S, -g * y / S, S]].flat());
  return y === 1 && (A = new fo().fromArray([[0, 0, 1], [0, 1, 0], [-1, 0, 0]].flat())), y === -1 && (A = new fo().fromArray([[0, 0, -1], [0, 1, 0], [1, 0, 0]].flat())), new bo().setFromMatrix3(A);
}
function vo(e, l) {
...
function aa(e, l, p) {
  const h = Cn([l, p]), c = Cn([e, p]), m = Cn([e, l]), f = new _(...h).sub(new _(...c)).normalize(), g = new _(...p).sub(new _(...m)).normalize(), y = f.clone().cross(g).normalize(), S = y.clone().cross(f).normalize();
...
function ia(e, l, p, h) {
  ...
  return m.setAttribute("color", new vt([...M, ...M, ...K, ...K, ...ie, ...ie], 3)), G.derive(() => {
    ...
    l.deformedShape.val, l.orientations.val && (c.clear(), (_a2 = e.elements) == null ? void 0 : _a2.val.forEach((ce) => {
      ...
      if (ce.length === 2 && (se.position.set(...vo(V, ae)), se.rotation.setFromRotationMatrix(Gn(V, ae))), ce.length === 3) {
...
function ra(e, l, p, h) {
  ...
  return G.derive(() => {
    ...
    $.forEach((L, te) => {
      ...
      if (!R) return;
      const pe = [(ue[0] + re[0]) / 2, (ue[1] + re[1]) / 2, (ue[2] + re[2]) / 2], W = Gn(ue, re);
      if (R.type === "CFT") {
...
function ua(e, l, p) {
  const h = new je();
  h.name = "extrusion";
  const c = new ho({ color: 8369151, transparent: true, opacity: 0.92, side: kt }), m = new ho({ color: 12623968, transparent: true, opacity: 0.85, side: kt }), f = new ho({ color: 11583173, transparent: true, opacity: 0.85, side: kt }), g = new je();
  g.add(new rs(16777215, 0.55));
  const y = new qn(16777215, 0.75);
  y.position.set(30, 25, 40);
  const S = new qn(16777215, 0.35);
    ...
    try {
      ie.forEach((Q, be) => {
        ...
        if (Q.length === 2) {
          ...
          Y.position.set(B[0], B[1], B[2]), Y.rotation.setFromRotationMatrix(Gn(B, Z)), h.add(Y);
          return;
        }
...
class Xn extends je {
  constructor(l, p, h, c, m, f, g) {
    ...
    const M = new Zn(y), K = new it({ color: f[1] > 0 ? 24435 : 11411474, side: kt });
...
class ts extends je {
  constructor(l, p, h, c, m, f, g) {
    ...
    if (this.text = new St(`${m[0].toFixed(4)}`), this.text2 = new St(`${(m[1] * -1).toFixed(4)}`), this.normalizedResult = f, this.textPosition = vo(l, p), this.text2Position = vo(p, l), this.text.position.set(...this.textPosition), this.text2.position.set(...this.text2Position), this.text.rotation.setFromRotationMatrix(c), this.text2.rotation.setFromRotationMatrix(c), this.add(this.text, this.text2), S) {
      ...
      const ae = new Zn(A), Q = new Zn(M), be = new it({ color: f[0] > 0 ? 24435 : 11411474, side: kt }), ye = new it({ color: -f[1] > 0 ? 24435 : 11411474, side: kt });
      ...
      const ie = new Zn(A), ce = new it({ color: f[0] > 0 ? 24435 : 11411474, side: kt });
...
function fa(e, l, p, h) {
  ...
  }, m = new je(), f = { normals: Xn, shearsY: Xn, shearsZ: Xn, torsions: Xn, bendingsY: ts, bendingsZ: ts };
  return G.derive(() => {
    var _a2, _b;
    ...
    (_b = (_a2 = e.analyzeOutputs) == null ? void 0 : _a2.rawVal[g]) == null ? void 0 : _b.forEach((y, S) => {
      ...
      if (!M || !K) return;
      const ie = new _(...K).distanceTo(new _(...M)), ce = ha((_b2 = e.analyzeOutputs) == null ? void 0 : _b2.rawVal[g]), se = y == null ? void 0 : y.map((Q) => Q / (ce === 0 ? 1 : ce)), V = Gn(M, K), ae = new f[g](M, K, ie, V, y ?? [0, 0], se ?? [0, 0], !!["normals", "shearsZ", "torsions", "bendingsY"].includes(g));
...
function ya({ drawingObj: e, gridObj: l, scene: p, getActiveCamera: h, controls: c, gridSize: m, derivedDisplayScale: f, rendererElm: g, viewerRender: y }) {
  ...
  }, Q = new Yn(new Me(), new Un()), be = new Yn(new Me(), new Un({ color: "gray", sizeAttenuation: false, size: 6 })), ye = new Yn(new Me(), new Un({ color: "orange", sizeAttenuation: false, size: 5 }));
  p.add(ye);
  ...
  const T = new _(), Y = (t, o, a, n, s, i) => {
    ...
    const b = g.getBoundingClientRect(), z = b.left + (T.x * 0.5 + 0.5) * b.width, u = b.top + (-T.y * 0.5 + 0.5) * b.height;
    ...
    if (o === "circle" && Ve.length === 1) {
      const b = Ve[0];
      Ve = [], (_e2 = window.__hekatanDrawCircle) == null ? void 0 : _e2.call(window, b[0], b[1], b[2], t), ne(`\u2713 C\xEDrculo r=${t} m en (${b[0].toFixed(2)}, ${b[1].toFixed(2)}, ${b[2].toFixed(2)}).`);
      try {
  ...
  window.__hekatanTypeCoord = (t) => {
    ...
    const a = ue(o);
    if (!a) return false;
    Xo(new _(a[0], a[1], a[2]), null), B = a, N.blur();
    try {
  ...
  const Dt = new _(), Ge = new _(), Ye = new _(), ze = (t) => {
    if (!Ie) return null;
  ...
  const Be = new _t(new Me().setFromPoints([new _(), new _()]), new ct({ color: 16766720, transparent: true, opacity: 0.95, depthTest: false }));
  ...
  const At = (t, o, a, n) => {
    ...
    for (const r of ke) {
      ...
      if (d === "pt") {
        ...
        const w = o[+v[0]], b = t[w == null ? void 0 : w[+v[1]]], z = t[w == null ? void 0 : w[+v[1] + 1]];
        if (!b || !z) continue;
        const u = new Me().setFromPoints([new _(b[0], b[1], b[2]), new _(z[0], z[1], z[2])]), E = new _t(u, new ct({ color: Yt, transparent: true, opacity: 0.95, depthTest: false }));
        ...
        const z = new Me().setFromPoints(b), u = new _t(z, new ct({ color: Yt, transparent: true, opacity: 0.95, depthTest: false }));
        u.renderOrder = 999, Ct.add(u);
      } else if (d === "aux") {
        const w = n[+v[0]];
        if (!w || w.length !== 6) continue;
        const b = new Me().setFromPoints([new _(w[0], w[1], w[2]), new _(w[3], w[4], w[5])]), z = new _t(b, new ct({ color: Yt, transparent: true, opacity: 0.95, depthTest: false }));
  ...
  const Ot = (t, o, a, n, s, i, r, d, v) => {
    const w = r - n, b = d - s, z = v - i, u = w * w + b * b + z * z;
    if (u < 1e-12) return Math.hypot(t - n, o - s, a - i);
    let E = ((t - n) * w + (o - s) * b + (a - i) * z) / u;
    E = Math.max(0, Math.min(1, E));
    const ee = n + E * w, C = s + E * b, P = i + E * z;
    ...
    const v = e.points.rawVal, w = /* @__PURE__ */ new Map(), b = [];
    for (let u = 0; u < v.length; u++) d.has(u) && (w.set(u, b.length), b.push(v[u]));
  ...
  const En = () => {
    ...
    for (const s of o) {
      ...
      const d = [0, 1, 2].map((b) => r.reduce((z, u) => z + u[b], 0) / r.length), v = r.map((b) => Math.hypot(b[0] - d[0], b[1] - d[1], b[2] - d[2])), w = v.reduce((b, z) => b + z, 0) / v.length;
      w < 1e-9 || v.some((b) => Math.abs(b - w) > 5e-3 * w) || n.push({ c: d, r: w });
    }
    return An = n;
  };
  window.__hekatanCentrosDeducidos = En, window.__hekatanDrawCircle = (t, o, a, n, s = window.__hekatanArcSegs ?? 12, i = "xy") => {
    ...
    const s = Math.max(4, Math.round(n)), i = new _(...t), r = new _(...o), d = new _(...a), v = new _().subVectors(r, i), w = new _().subVectors(d, i), b = new _().crossVectors(v, w).normalize(), z = new _().addVectors(i, r).multiplyScalar(0.5), u = new _().addVectors(r, d).multiplyScalar(0.5), E = new _().crossVectors(v, b).normalize(), ee = new _().crossVectors(new _().subVectors(d, r), b).normalize(), C = new _().subVectors(u, z), P = E.x * ee.y - E.y * ee.x;
    let x;
    if (Math.abs(P) > 1e-9) {
      const Se = (C.x * ee.y - C.y * ee.x) / P;
      x = new _().addVectors(z, E.clone().multiplyScalar(Se));
    } else x = z.clone();
    const F = i.distanceTo(x), H = new _().subVectors(i, x), U = new _().subVectors(d, x), le = Math.acos(Math.max(-1, Math.min(1, H.dot(U) / (F * F)))), q = e.points.rawVal.length, O = [], Ae = b.clone();
    for (let Se = 0; Se <= s; Se++) {
      const Fe = Se / s, Re = le * Fe, Ke = new mo().setFromAxisAngle(Ae, Re), tt = H.clone().applyQuaternion(Ke).add(x);
    ...
    const i = Math.min(t[0], o[0]), r = Math.max(t[0], o[0]), d = Math.min(t[1], o[1]), v = Math.max(t[1], o[1]), w = (t[2] + o[2]) / 2, b = r - i, z = v - d, u = Math.min(a, b / 2 - 0.01, z / 2 - 0.01);
    if (u <= 0) return;
    const E = e.points.rawVal.length, ee = [], C = [], P = (x, F) => {
      ee.push([x, F, w]), C.push(E + ee.length - 1);
    };
    for (let x = 0; x <= s; x++) P(i + u + (b - 2 * u) * x / s, d);
    for (let x = 1; x <= n; x++) {
    ...
    for (let x = 1; x <= s; x++) P(r - u - (b - 2 * u) * x / s, v);
    for (let x = 1; x <= n; x++) {
      const F = Math.PI / 2 + Math.PI / 2 * x / n;
    ...
    let w;
    if (V && e.gridTarget) {
      const b = e.gridTarget.rawVal, z = new kn(...b.rotation), u = new _(1, 0, 0).applyEuler(z), E = new _(0, 1, 0).applyEuler(z), ee = new _(...b.position), C = new _(n, s, i), P = new _(r, d, v), x = C.clone().sub(ee).dot(u), F = C.clone().sub(ee).dot(E), H = P.clone().sub(ee).dot(u), U = P.clone().sub(ee).dot(E), le = (q, O) => ee.clone().addScaledVector(u, q).addScaledVector(E, O).toArray();
    ...
    if (window.__hekatanPushUndo && window.__hekatanPushUndo(), e.points.val = [...e.points.rawVal, ...w], e.polylines) {
      const b = e.polylines.rawVal, z = b.length - 1, u = [a, a + 1, a + 2, a + 3, a];
      e.polylines.val = [...b.slice(0, -1), u, []], e.areas && (e.areas.val = [...e.areas.rawVal, z]);
    }
    try {
      (_a2 = window.__hekatanRebuild) == null ? void 0 : _a2.call(window);
    } catch {
    ...
    const Fe = (we, Te) => {
      ...
      for (let Vt = 0, $t = F.length - 1; Vt < F.length; $t = Vt++) {
        const [Nt, Wt] = F[Vt], [co, on] = F[$t];
        Wt > Te != on > Te && we < (co - Nt) * (Te - Wt) / (on - Wt) + Nt && (nt = !nt);
      }
      return nt;
  ...
  window.__hekatanFinalizePolyArea = un, window.__hekatanSetInclinedPlaneFrom3 = (t, o, a) => {
    ...
    r.normalize();
    const d = new mo().setFromUnitVectors(new _(0, 0, 1), r), v = new kn().setFromQuaternion(d);
    e.gridTarget && (e.gridTarget.val = { position: [n.x, n.y, n.z], rotation: [v.x, v.y, v.z] }), V = true;
    const w = new _().addVectors(n, s).add(i).multiplyScalar(1 / 3), b = Math.max(n.distanceTo(s), n.distanceTo(i), s.distanceTo(i)) * 2.2 + 4, z = b / 2;
    $e.geometry.dispose(), $e.geometry = new en(b, b), _e.geometry.dispose(), _e.geometry = new Go(new en(b, b)), Oe(z, 1), he.position.copy(w), he.quaternion.copy(d), he.scale.set(1, 1, 1), he.visible = true;
    try {
      (_a2 = window.__hekatanRefreshStatus) == null ? void 0 : _a2.call(window);
    } catch {
    }
    ...
    e.gridTarget && (e.gridTarget.val = { position: [0, 0, 0], rotation: [0, 0, 0] }), V = false, he.visible = false, y();
  };
  const Lt = new je();
  Lt.visible = false, p.add(Lt), window.__hekatanShowAxes = (t, o, a = 12, n = 2) => {
    ...
    const s = Math.min(...o) - n, i = Math.max(...o) + n, r = Math.min(...t) - n, d = Math.max(...t) + n, v = "ABCDEFGHIJKLMNOPQRSTUVWXYZ", w = (b, z, u, E, ee) => {
      const C = document.createElement("canvas");
      C.width = 64, C.height = 32;
      const P = C.getContext("2d");
      P.fillStyle = ee, P.font = "bold 22px sans-serif", P.textAlign = "center", P.fillText(b, 32, 26);
      const x = new Ho(C), F = new Wo({ map: x, transparent: true }), H = new Jo(F);
      return H.position.set(z, u, E), H.scale.set(1.2, 0.6, 1), H;
    };
    t.forEach((b, z) => {
      const u = z < v.length ? v[z] : `X${z}`, E = new Me().setFromPoints([new _(b, s, 0), new _(b, i, 0), new _(b, s, 0), new _(b, s, a)]), ee = new Sn({ color: 6333946, dashSize: 0.3, gapSize: 0.15, transparent: true, opacity: 0.6 }), C = new Kt(E, ee);
      C.computeLineDistances(), Lt.add(C), Lt.add(w(u, b, s - 0.5, 0, "#60a5fa")), Lt.add(w(u, b, i + 0.5, 0, "#60a5fa"));
    }), o.forEach((b, z) => {
      const u = `${z + 1}`, E = new Me().setFromPoints([new _(r, b, 0), new _(d, b, 0), new _(r, b, 0), new _(r, b, a)]), ee = new Sn({ color: 16478597, dashSize: 0.3, gapSize: 0.15, transparent: true, opacity: 0.6 }), C = new Kt(E, ee);
      C.computeLineDistances(), Lt.add(C), Lt.add(w(u, r - 0.5, b, 0, "#fb7185")), Lt.add(w(u, d + 0.5, b, 0, "#fb7185"));
    }), Lt.visible = true, y();
  ...
  window.__hekatanShowRefPlanes = (t = [0, 3, 6, 9, 12], o = 20, a = 0, n = 0) => {
    ...
    t.forEach((i, r) => {
      const d = s[r % s.length], v = o / 2, w = [new _(a - v, n - v, i), new _(a + v, n - v, i), new _(a + v, n + v, i), new _(a - v, n + v, i), new _(a - v, n - v, i)], b = new Me().setFromPoints(w), z = new ct({ color: d, transparent: true, opacity: 0.55 });
      qt.add(new _t(b, z));
  ...
  xt.add(Wn([-hn, 0, 0], [hn, 0, 0], 16711680)), xt.add(Wn([0, -hn, 0], [0, hn, 0], 65280)), xt.add(Wn([0, 0, -hn], [0, 0, hn], 35071)), xt.visible = false, xt.frustumCulled = false, p.add(xt);
  let Jn = 2;
  const Vn = (t) => {
    ...
    const t = Jn * Vn(xt.position) / 0.015;
    xt.scale.setScalar(Math.max(1e-4, Math.min(1e5, t)));
  };
  let On = 10;
  const Qn = (t) => Math.max(1e-4, On * Vn(t));
  window.__hekatanAperturaPx = (t) => (typeof t == "number" && t > 0 && (On = t), On), window.__hekatanUpdateSnapScale = vn, window.__hekatanSnapMarker = xt, window.__hekatanMetrosPorPixel = Vn, window.__hekatanSnapPx = (t) => (typeof t == "number" && t > 0 && (Jn = t, vn(), y()), Jn);
  const Po = () => {
  ...
  window.__hekatanUpdateSelectionPtScale = Po, c.addEventListener("change", () => {
    ...
    if (a.length) {
      ...
      if (d === "select" || !d) {
        ...
        if (u >= 0) {
          ...
          Be.geometry.setFromPoints([new _(U[0], U[1], U[2]), new _(le[0], le[1], le[2])]), Be.visible = true, Ue.visible = false, ht = ((_f = (_e2 = e.areas) == null ? void 0 : _e2.rawVal) == null ? void 0 : _f.includes(E.polyIdx)) ?? false ? { kind: "poly", a: E.polyIdx } : { kind: "seg", a: E.polyIdx, b: E.segIdx };
        } else if (ee >= 0) {
          const H = (((_g = window.__hekatanDrawingAuxLines) == null ? void 0 : _g.rawVal) ?? [])[ee];
          H && (Be.geometry.setFromPoints([new _(H[0], H[1], H[2]), new _(H[3], H[4], H[5])]), Be.visible = true, Ue.visible = false, ht = { kind: "aux", a: ee });
      ...
      if (d === "delete" || d === "trim" || d === "extend" || d === "offset") {
        ...
        ee ? (Qe = E, ve = -1, Je = -1, cn(E)) : u ? (ve = u.polyIdx, Je = u.segIdx, Qe = -1, Hn(u.polyIdx, u.segIdx)) : (ve = -1, Je = -1, Qe = -1, Ee.visible = false), pe.visible = false, ut.visible = false, D(), oe.style.left = t.clientX + "px", oe.style.top = t.clientY + "px", oe.style.display = "block";
      ...
      oe.style.left = t.clientX + "px", oe.style.top = t.clientY + "px", oe.style.display = "block";
      const v = ((_j = e.polylines) == null ? void 0 : _j.rawVal) ?? [], w = v[v.length - 1] ?? [], b = e.points.rawVal ?? [];
      if (w.length > 0 && b[w[w.length - 1]]) {
        const z = w[w.length - 1], u = b[z];
        let E = Ie;
        if (Jt = null, !E && window.__hekatanAxisSnap !== false) {
          const Re = g.getBoundingClientRect(), Ke = t.clientX, tt = t.clientY, dt = ((_k = settings.gridSize) == null ? void 0 : _k.rawVal) ?? 10, rt = new _(u[0], u[1], u[2]), ft = [["x", new _(1, 0, 0)], ["y", new _(0, 1, 0)], ["z", new _(0, 0, 1)]], Pe = (at) => {
            const we = at.clone().project(o);
            return { x: (we.x * 0.5 + 0.5) * Re.width + Re.left, y: (-we.y * 0.5 + 0.5) * Re.height + Re.top };
          };
          let He = null;
          for (const [at, we] of ft) {
            const Te = Pe(rt.clone().addScaledVector(we, -dt)), nt = Pe(rt.clone().addScaledVector(we, dt)), Vt = nt.x - Te.x, $t = nt.y - Te.y, Nt = Ke - Te.x, Wt = tt - Te.y, co = Vt * Vt + $t * $t || 1;
            let on = (Nt * Vt + Wt * $t) / co;
            on = Math.max(0, Math.min(1, on));
            const No = Math.hypot(Ke - (Te.x + on * Vt), tt - (Te.y + on * $t));
            if (He === null || No < He.dpx) {
              const po = S.ray, Yo = rt.clone().sub(po.origin), uo = we.dot(po.direction), Uo = we.dot(Yo), Fs = po.direction.dot(Yo), Zo = 1 - uo * uo, As = Math.abs(Zo) < 1e-6 ? -Uo : (uo * Fs - Uo) / Zo;
        ...
        H && (H.textContent = F), pe.geometry.setFromPoints([new _(u[0], u[1], u[2]), new _(n.x, n.y, n.z)]), (_n2 = pe.computeLineDistances) == null ? void 0 : _n2.call(pe), pe.visible = true, Y(u[0], u[1], u[2], n.x, n.y, n.z);
        ...
        We(O), O && (lt.style.left = t.clientX + "px", lt.style.top = t.clientY + "px"), k.geometry.setFromPoints([new _(u[0] - U, u[1], u[2]), new _(u[0] + U, u[1], u[2])]), (_o2 = k.computeLineDistances) == null ? void 0 : _o2.call(k), I.geometry.setFromPoints([new _(u[0], u[1] - U, u[2]), new _(u[0], u[1] + U, u[2])]), (_p = I.computeLineDistances) == null ? void 0 : _p.call(I), J.geometry.setFromPoints([new _(u[0], u[1], u[2] - U), new _(u[0], u[1], u[2] + U)]), (_q = J.computeLineDistances) == null ? void 0 : _q.call(J), ut.visible = true;
    ...
    xa(l, { position: new _(...e.gridTarget.val.position), quaternion: new mo().setFromEuler(new kn(...e.gridTarget.val.rotation)) }, y), K.position.set(...e.gridTarget.val.position), K.quaternion.setFromEuler(new kn(...e.gridTarget.val.rotation)), K.updateMatrixWorld();
    const t = new _(0, 0, 1).applyEuler(new kn(...e.gridTarget.val.rotation));
    V = !(Math.abs(t.x) > 0.999 || Math.abs(t.y) > 0.999 || Math.abs(t.z) > 0.999);
  }), G.derive(() => {
  ...
  const eo = (t, o, a, n, s) => {
    ...
    var _a2, _b, _c, _d;
    const i = Math.min(t, a), r = Math.max(t, a), d = Math.min(o, n), v = Math.max(o, n), w = a < t, b = g.getBoundingClientRect(), z = h();
    z.updateMatrixWorld();
    const u = (q) => {
      const O = new _(q[0], q[1], q[2]);
      return O.project(z), { x: b.left + (O.x * 0.5 + 0.5) * b.width, y: b.top + (-O.y * 0.5 + 0.5) * b.height };
  ...
  const zo = () => {
    ...
    for (let ee = 0; ee < a.length; ee++) {
      ...
      if (C && C.size > 0) {
        let P = [];
        for (let x = 0; x < a[ee].length; x++) P.push(a[ee][x]), x < a[ee].length - 1 && C.has(x) && (P.length >= 2 && z.push(P), P = [], b++);
  ...
  const xs = () => {
    ...
    t.addEventListener("mousedown", (r) => {
      ...
      if (!o) return;
      const d = r.clientX - a, v = r.clientY - n, w = Math.max(0, Math.min(window.innerWidth - 80, s + d)), b = Math.max(0, Math.min(window.innerHeight - 40, i + v));
      Tt.style.left = `${w}px`, Tt.style.top = `${b}px`;
    }), window.addEventListener("mouseup", () => {
      if (o) {
        o = false;
        try {
  ...
  const gt = (t, o, a, n) => {
    ...
    const b = `\u{1F3AF} ${ke.size} item(s) \u2014 ${w.join(", ")}`;
    st = new cs({ container: Tt, title: b });
    {
  ...
  let to = 4;
  const no = () => {
    Xt.visible && Xt.scale.setScalar(to * Vn(Xt.position));
  };
  window.__hekatanOsnapMarkerRef = Xt, window.__hekatanUpdateOsnapScale = no, window.__hekatanOsnapPx = (t) => (typeof t == "number" && t > 0 && (to = t, no(), y()), to);
  const Ln = () => {
    Xt.visible = false;
  }, Ms = (t, o, a, n) => {
    var _a2, _b, _c, _d;
    ...
    const b = window.__hekatanAxisGrids ?? [], z = window.__hekatanLevels ?? [], u = b.filter((C) => C && C.start && C.end).map((C) => [C.start, C.end]);
    for (const [C, P] of u) {
  ...
  window.__hekatanDestello = (t) => {
    ...
    for (const s of t || []) {
      ...
      if (i[0] === "pt") {
        ...
        const w = a[+i[1]] || [], b = o[w[+i[2]]], z = o[w[+i[2] + 1]];
        b && z && (r = [b, z]);
      } else i[0] === "poly" && (r = (a[+i[1]] || []).map((b) => o[b]).filter(Boolean));
      if (r.length < 2) continue;
      const d = new Me().setFromPoints(r.map((w) => new _(w[0], w[1], w[2]))), v = new _t(d, Eo);
  ...
  window.__hekatanCadRefreshPrompt = Rt, window.__hekatanRefreshStatus = () => {
    ...
    Ve = [], fe = [], W.visible = false, oo(), bt = null, y(), ne("\u{1F6E0} Tool cambiado \u2014 clicks pendientes limpiados"), Rt();
  };
  function oo() {
    if (!e.polylines) return;
  ...
  const ao = () => {
    Ve = [], bt = null, oo(), Ie = null, Gt(), pe.visible = false, ut.visible = false, D(), ne("\u23F9 Dibujo finalizado \u2014 click para empezar otra serie"), y(), Rt();
  };
  ...
  const ks = () => {
    ...
    const r = [o[0] - t[0], o[1] - t[1], o[2] - t[2]], d = [n[0] - a[0], n[1] - a[1], n[2] - a[2]], v = [t[0] - a[0], t[1] - a[1], t[2] - a[2]], w = r[0] * r[0] + r[1] * r[1] + r[2] * r[2], b = r[0] * d[0] + r[1] * d[1] + r[2] * d[2], z = d[0] * d[0] + d[1] * d[1] + d[2] * d[2], u = r[0] * v[0] + r[1] * v[1] + r[2] * v[2], E = d[0] * v[0] + d[1] * v[1] + d[2] * v[2], ee = w * z - b * b;
    if (ee < 1e-12) return null;
    const C = (b * E - z * u) / ee, P = (w * E - b * u) / ee;
    ...
    const d = a[bt.poly], v = n[d[bt.seg]], w = n[d[bt.seg + 1]], b = a[i], z = b[r], u = b[r + 1];
    ...
    const E = n[z], ee = n[u];
    if (t === "trim") {
      const C = io(E, ee, v, w, false, false);
      if (!C) {
      ...
      const P = n.length;
      e.points.val = [...n, C];
      const x = [...b.slice(0, r + 1), P, ...b.slice(r + 1)];
      ...
      const C = io(E, ee, v, w, true, false);
      if (!C) {
  ...
  window.__hekatanSelectionSize = () => ke.size, window.__hekatanSelectLast = () => {
    ...
    const i = [...ke], r = e.points.rawVal, d = ((_a2 = e.polylines) == null ? void 0 : _a2.rawVal) ?? [], v = new Set(((_b = e.areas) == null ? void 0 : _b.rawVal) ?? []), w = /* @__PURE__ */ new Set(), b = /* @__PURE__ */ new Set(), z = [];
    if (i.forEach((P) => {
      if (P.startsWith("pt:")) {
        const x = +P.slice(3);
        r[x] && w.add(x);
    ...
    (t.ctrlKey || t.metaKey) && (n = new _(Math.round(a[0].point.x), Math.round(a[0].point.y), Math.round(a[0].point.z)));
    {
      ...
      if (i.length > 0) {
        ...
        if (d) {
          ...
          let w = Ie;
          if (!w && v) {
            const b = Math.abs(n.x - d[0]), z = Math.abs(n.y - d[1]), u = Math.abs(n.z - d[2]);
            w = b >= z && b >= u ? "x" : z >= u ? "y" : "z";
          }
          w === "x" ? n = new _(n.x, d[1], d[2]) : w === "y" ? n = new _(d[0], n.y, d[2]) : w === "z" && (n = new _(d[0], d[1], n.z));
        }
      }
    }
  ...
  const Xo = (t, o) => {
    ...
    if (a === "polyarea") {
      fe.push([t.x, t.y, t.z]), W.geometry.setFromPoints(fe.map((n) => new _(n[0], n[1], n[2]))), W.visible = fe.length >= 1, ne(`\u25B0 \xC1rea libre \u2014 ${fe.length} punto(s). Click m\xE1s v\xE9rtices, o Enter / click-derecho para cerrar y mallar (m\xEDn. 3).`), y();
      return;
    }
    if (a === "plane3") {
    ...
    if (a === "extl") {
      ...
      e.points.val = [...e.points.rawVal, [v[0], v[1], v[2]], [w[0], w[1], w[2]], [w[0], w[1], w[2] + b], [v[0], v[1], v[2] + b]];
  ...
  g.addEventListener("click", () => Rt()), g.addEventListener("contextmenu", (t) => {
    ...
    if (n.length && s.length) {
      const i = new _(...e.points.rawVal[n[0].index]), r = new _(...s[0].point), d = i.sub(r), v = (_a2 = s[0].face) == null ? void 0 : _a2.normal;
  ...
  g.addEventListener("pointermove", (t) => {
    ...
    const n = S.intersectObject(Q), s = ae();
    if (n.length && s.length) {
      const r = new _(...e.points.rawVal[n[0].index]), d = new _(...s[0].point), v = r.sub(d), w = (_a2 = s[0].face) == null ? void 0 : _a2.normal;
    ...
    const n = S.intersectObject(Q), s = ae();
    if (n.length && s.length) {
      const d = new _(...e.points.rawVal[n[0].index]), v = new _(...s[0].point), w = d.sub(v), b = (_a2 = s[0].face) == null ? void 0 : _a2.normal;
      b.transformDirection(K.matrixWorld), Math.abs(w.dot(b)) < 1e-4 && (a = true);
    }
    if (!a) return;
    const i = [...e.points.rawVal];
...
function Sa(e, l, p, h) {
  ...
  return G.derive(() => {
    ...
    for (const { idx: L, vals: te } of ce) {
      ...
      R.normalize();
      const W = Math.abs(R.y) < 0.99 ? new _(0, 1, 0) : new _(1, 0, 0), fe = new _().crossVectors(R, W).normalize(), he = new _().crossVectors(R, fe).normalize(), $e = go + 1, _e = va;
...
function Va(e) {
  ...
  const V = new it({ color: Nn, transparent: true, opacity: 0.95, depthTest: false }), ae = new it({ color: Nn, transparent: true, opacity: 0.85, depthTest: false }), Q = new Oo(1, 1, 1, 12), be = new it({ color: Nn, transparent: true, opacity: 0.55, side: kt, depthTest: false }), ye = new ct({ color: Nn, linewidth: 4, transparent: true, opacity: 1, depthTest: false }), N = [];
...
function Ga({ mesh: e, settingsObj: l, drawingObj: p, objects3D: h, solids: c }) {
  ...
  M.enableDamping = true, M.dampingFactor = 0.1, M.screenSpacePanning = true, M.zoomSpeed = 0.8, M.panSpeed = 1.2, M.rotateSpeed = 0.9, M.keyPanSpeed = 12, M.listenToKeyEvents(window), M.touches = { ONE: Dn.ROTATE, TWO: Dn.DOLLY_PAN }, A.domElement.addEventListener("wheel", (k) => {
    if (!k.ctrlKey && Math.abs(k.deltaX) > Math.abs(k.deltaY) * 1.5) {
      k.preventDefault();
      const I = M.target, J = new _().subVectors(g.position, I), X = new _();
  ...
  const K = new wo(new _(-1, 0, 0), 0), ie = new wo(new _(0, -1, 0), 0), ce = new wo(new _(0, 0, -1), 0);
  ...
  const B = () => {
    ...
    N.traverse((I) => {
      ...
      const X = I.name ?? "";
      let de = 0.35;
      X.includes("border") ? de = 1 : X.includes("major") && (de = 0.75), J.opacity = k * de;
    });
  };
  ...
  function he(k, I) {
    ...
    if (y.left = -xe * me, y.right = xe * me, y.updateProjectionMatrix(), k && oe) {
      if (R ? (R.object = oe, R.update()) : (R = new Qo(oe, A.domElement), R.enableDamping = true, R.dampingFactor = 0.1, R.screenSpacePanning = true, R.zoomSpeed = 0.8, R.panSpeed = 1.2, R.rotateSpeed = 0.9, R.touches = { ONE: Dn.ROTATE, TWO: Dn.DOLLY_PAN }, R.target.copy(M.target), R.addEventListener("change", W), R.enabled = false), !pe) {
        const ge = (Xe) => {
          if (!re || !R) return;
  ...
  const De = (k, I, J) => {
    ...
    const J = M.target, X = new _().subVectors(S.position, J), de = X.length(), me = new _(), xe = new _();
    ...
    const I = new _().subVectors(S.position, M.target);
