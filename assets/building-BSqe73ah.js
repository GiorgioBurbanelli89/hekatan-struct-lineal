...
import { g as D } from "./getViewer-DoAG4kNs.js";
import { g as O } from "./getParameters-DTL1yrut.js";
import { g as L } from "./styles-0iLl92Fx.js";
import { g as x, a as G, b as H, c as j, d as C, __tla as __tla_0 } from "./getSolids-Bf8L_aj9.js";
...
Promise.all([
  ...
  a.derive(() => {
    ...
    for (let e = 0; e < S.stories.value.val; e++) {
      ...
      const f = [];
      let w = o.length;
      for (let t = 0; t < u.length; t++) o.push(u[t]), f.push(t + w);
      p.push(f), m.push(w), d.set(e, [
        e
      ]), h.set(e, {
        analysisInput: {
          areaLoad: 1,
