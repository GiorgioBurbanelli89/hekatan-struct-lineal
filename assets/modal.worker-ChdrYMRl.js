(async ()=>{
    ...
    async function Le(L = {}) {
        ...
        var Me;
        function ar() {
            return d.locateFile ? ne("deform.wasm") : new URL("/hekatan-struct-lineal/assets/deform-Dnm5xNkJ.wasm", import.meta.url).href;
        }
        function $e(e) {
        ...
        }, Ne = [], Ke = (e)=>Ne.push(e), Ee = [], lr = (e)=>Ee.push(e), se = (e)=>(u(typeof e == "number", `ptrToString expects a number, got ${typeof e}`), e >>>= 0, "0x" + e.toString(16).padStart(8, "0")), y = (e)=>zr(e), g = ()=>Wr(), ee = (e)=>{
            ee.shown ||= {}, ee.shown[e] || (ee.shown[e] = 1, q && (e = "warning: " + e), I(e));
        }, De = globalThis.TextDecoder && new TextDecoder, Ye = (e, r, t, n)=>{
...
`));
                ...
                class a {
                    ...
                    cacheLength() {
                        ...
                        de.setDataGetter((Z)=>{
                            ...
                            return H = Math.min(H, h - 1), typeof de.chunks[Z] > "u" && (de.chunks[Z] = W(Ie, H)), typeof de.chunks[Z] > "u" && R("doXHR failed!"), de.chunks[Z];
                        }), (C || !h) && (O = h = 1, h = this.getter(0).length, O = h, ue("LazyFiles on gzip forces download of the whole file when length is accessed")), this._length = h, this._chunkSize = O, this.lengthKnown = !0;
                    }
                    get length() {
        ...
        function en(e, r, t, n, o, a, s, c, l, f, m, v, _, h, S, N, C) {
            var O = g();
            try {
                w(e)(r, t, n, o, a, s, c, l, f, m, v, _, h, S, N, C);
            } catch (W) {
                if (y(O), !(W instanceof p)) throw W;
                E(1, 0);
            }
        }
        ...
        function tn(e, r, t, n, o, a, s, c, l, f, m, v, _, h, S) {
            var N = g();
            try {
        ...
        function un(e, r, t, n, o, a, s, c, l, f, m, v, _, h) {
            var S = g();
            try {
        ...
        function En(e, r, t, n, o, a, s, c, l, f, m, v, _, h, S, N, C, O) {
            var W = g();
            try {
        ...
        function wn(e, r, t, n, o, a, s, c, l, f, m, v, _, h, S, N) {
            var C = g();
            try {
                w(e)(r, t, n, o, a, s, c, l, f, m, v, _, h, S, N);
            } catch (O) {
                if (y(C), !(O instanceof p)) throw O;
                E(1, 0);
            }
        }
        ...
        function bn(e, r, t, n, o, a, s, c, l, f, m, v, _, h, S, N) {
            var C = g();
            try {
                w(e)(r, t, n, o, a, s, c, l, f, m, v, _, h, S, N);
            } catch (O) {
        ...
        function Nn(e, r, t, n, o, a, s, c, l, f, m) {
            var v = g();
            try {
    ...
    await Le();
    const b = await Le();
    function Wn(L, B, d, k, K = 10, q = 0, X = 0, Q = 1, te, Pe) {
        ...
        A.push(or);
        const Re = k.drillingPenaltyScales, R = Re ? Array.from(Re.keys()) : [], D = Re ? Array.from(Re.values()) : [], Me = j(R, Uint32Array, b.HEAPU32);
        A.push(Me);
        const ar = j(D, Float64Array, b.HEAPF64);
        A.push(ar);
        const $e = x(k.shearAreasY), Ge = x(k.shearAreasZ), Ve = x(k.localAngles), sr = k.momentReleases ? Array.from(k.momentReleases.keys()) : [], pr = k.momentReleases ? Array.from(k.momentReleases.values()).flatMap(Hn) : [], cr = j(sr, Uint32Array, b.HEAPU32);
        A.push(cr);
        ...
        A.push(Xe), b._modal(ne, L.length, ie, fe.length, ue, B.length, me, u, I.length, ze.keysPtr, ze.valuesPtr, ze.size, ve.keysPtr, ve.valuesPtr, ve.size, p.keysPtr, p.valuesPtr, p.size, he.keysPtr, he.valuesPtr, he.size, oe.keysPtr, oe.valuesPtr, oe.size, T.keysPtr, T.valuesPtr, T.size, He.keysPtr, He.valuesPtr, He.size, We.keysPtr, We.valuesPtr, We.size, je.keysPtr, je.valuesPtr, je.size, Ae.keysPtr, Ae.valuesPtr, Ae.size, Te.keysPtr, Te.valuesPtr, Te.size, ge, F, $.length, ir, or, ae.length, Me, ar, R.length, $e.keysPtr, $e.valuesPtr, $e.size, Ge.keysPtr, Ge.valuesPtr, Ge.size, Ve.keysPtr, Ve.valuesPtr, Ve.size, cr, qe, sr.length, Ne.keysPtr, Ne.valuesPtr, Ne.size, Q, Ke.keysPtr, Ke.valuesPtr, Ke.size, se, Ee ? Ee.length : 0, k.etabsWallJoint === !1 ? 0 : 1, K, q, X, y, g, ee, De, Ye, J, Y, Xe);
        const re = b.HEAPU32[y / 4], we = b.HEAPU32[g / 4], Je = b.HEAPU32[ee / 4], V = b.HEAPU32[De / 4], Oe = b.HEAPU32[Ye / 4], Se = b.HEAPU32[J / 4], ce = b.HEAPU32[Y / 4], ke = b.HEAPU32[Xe / 4];
        let dr = [], fr = [], ur = [];
        if (we > 0 && re) {
