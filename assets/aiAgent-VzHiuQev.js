...
function Tt(x, e, t, s, i, a, r = 8) {
  ...
  }, $ = C(t), I = C(s), E = w($, v), T = w(I, v), R = w($, y), k = w(I, y), _ = c ? w(c, y) * i : 0, S = d ? w(d, y) * i : 0, D = c ? w(c, v) * i : 0, L = d ? w(d, v) * i : 0, H = w($, p), U = w(I, p), P = [];
  for (let A = 0; A <= r; A++) {
    const O = A / r, z = 1 - 3 * O * O + 2 * O * O * O, M = f * (O - 2 * O * O + O * O * O), G = 3 * O * O - 2 * O * O * O, Y = f * (-O * O + O * O * O), V = z * E + M * _ + G * T + Y * S, X = z * R - M * D + G * k - Y * L, Z = H + (U - H) * O, me = [x[0] + p[0] * (O * f + Z), x[1] + p[1] * (O * f + Z), x[2] + p[2] * (O * f + Z)];
  ...
  return Pe((d, p) => {
    ...
    for (const k of y) {
      ...
      if (k.length === 2 && e.deformedShape.val) {
        const S = ((_f = x.nodes) == null ? void 0 : _f.val) ?? [], D = (_h = (_g = x.deformOutputs) == null ? void 0 : _g.val) == null ? void 0 : _h.deformations, L = S[k[0]], H = S[k[1]];
        if (L && H && D) {
          const U = Number.isFinite(e.deformScale.val) ? e.deformScale.val : 1, P = U * (Number.isFinite(e.deformScaleZ.val) ? e.deformScaleZ.val : 1), A = Tt(L, H, D.get(k[0]), D.get(k[1]), U, P);
          for (let O = 0; O < A.length - 1; O++) C.push(...A[O], ...A[O + 1]), v && _ && ($.push(_.r, _.g, _.b), $.push(_.r, _.g, _.b));
          continue;
        }
      }
      for (const S of Et(k)) {
        const D = g[S[0]], L = g[S[1]];
        !D || !L || (C.push(...D, ...L), v && _ && ($.push(_.r, _.g, _.b), $.push(_.r, _.g, _.b)));
      }
    }
    ...
    for (let k = 0; k < y.length; k++) {
      ...
      if (w(_)) {
        if (_.length === 3) {
          const [S, D, L] = _;
          if (g[S] && g[D] && g[L]) {
            T.push(k), R.push(0), I.push(...g[S], ...g[D], ...g[L]);
            const H = v ? Ge : c;
          ...
          if (g[S] && g[D] && g[L] && g[H]) {
            let U;
            if (v) {
              const P = (g[S][2] + g[D][2] + g[L][2] + g[H][2]) / 4;
              U = $e(P) ? Ve : Ke;
            } else U = St(g[S], g[D], g[L], g[H]) ? h : o;
            I.push(...g[S], ...g[D], ...g[L]), I.push(...g[S], ...g[L], ...g[H]), T.push(k, k), R.push(0, 1);
  ...
  search(e, t) {
    ...
    if (arguments.length === 0 && c.length === 0 && (t = this.multiSearch ? (e = this.searchData, this.last.logic) : (e = this.last.field, this.last.search)), arguments.length === 0 && c.length !== 0) {
      ...
      for (let k = 0; k < this.searches.length; k++) {
        ...
        let _ = f.val(), S = m.val(), D = null, L = null;
        ...
        } else L = _.text || "", _ = _.id || "";
        if (_ !== "" && _ != null || S != null && S !== "") {
          var b = { field: d.field, type: d.type, operator: p };
          p == "between" ? u.extend(b, { value: [_, S] }) : p == "in" && typeof _ == "string" || p == "not in" && typeof _ == "string" ? u.extend(b, { value: _.split(",") }) : u.extend(b, { value: _ }), D && u.extend(b, { svalue: D }), L && u.extend(b, { text: L });
          try {
...
`)), b.push({ kind: p.type == "text/html" ? "html" : "text", data: v });
  ...
  resizeRecords() {
    ...
    for (let A = 0; A < this.columns.length; A++) {
      ...
      L.hidden || (L.min == null && (L.min = 20), parseInt(L.sizeCalculated) < parseInt(L.min) && (L.sizeCalculated = L.min + "px"), parseInt(L.sizeCalculated) > parseInt(L.max) && (L.sizeCalculated = L.max + "px"), D += parseInt(L.sizeCalculated));
    }
  ...
  scroll(e) {
    ...
    if (r != null && (r < 0 && (r = 0), l < 0 && (l = 0), r == l && (0 < r ? r-- : l++), r != this.last.colStart || l != this.last.colEnd)) {
      ...
      if (d < 5 && p < 5) {
        ...
        let L = c.find(`#grid_${this.name}_summary`);
        p.find("tbody").html(e[1]), C.html(w[0]), D.prepend(w[1]), d != null && L.html(d[1]), setTimeout(() => {
          D.find(":scope > table").filter(":not(table:first-child)").remove(), L[0] && (L[0].scrollLeft = this.last.scrollLeft);
        }, 1);
      }
      this.resizeRecords();
    }
...
1. Si piden una tipolog\xEDa est\xE1ndar (edificio, p\xF3rtico, galp\xF3n, zapata, losa, muro\u2026), busca con
   ...
   Plantillas por tipolog\xEDa (id):
     edificio de p\xF3rticos \u2192 edificio-aporticado (claves nPisos, nVanosX, nVanosY, spanX, spanY, hPiso)
     edificio con losas \u2192 edificio-hormigon \xB7 galp\xF3n a dos aguas \u2192 galpon
     galp\xF3n curvo \u2192 galpon-curvo \xB7 galp\xF3n a un agua \u2192 galpon-agua1
     puente de losa sobre vigas \u2192 puente-losa-vigas \xB7 puente reticular \u2192 puente
     estribo de puente (\xE1reas) \u2192 estribo-puente
     muro de contenci\xF3n con \xE1reas \u2192 muro-contencion-areas \xB7 con s\xF3lidos \u2192 muro-contencion-solido
     placa base (\xE1reas) \u2192 placa-base \xB7 zapata aislada \u2192 zapata-aislada
     zapatas con viga de amarre \u2192 zapata-viga-amarre \xB7 viga de cimentaci\xF3n \u2192 viga-cim-guerra-ej7
     losa de cimentaci\xF3n \u2192 guerra-ej8-losa-cimentacion
...
function je() {
  var _a, _b, _c, _d;
  return { ex: ((_b = (_a = N()).__hekatanExample) == null ? void 0 : _b.call(_a)) ?? null, params: { ...((_d = (_c = N()).__hekatanGetParams) == null ? void 0 : _d.call(_c)) ?? {} }, script: N().__hekatanCliScript ?? "" };
}
async function He(x) {
  var _a, _b, _c, _d, _e2, _f;
  ((_b = (_a = N()).__hekatanExample) == null ? void 0 : _b.call(_a)) === x ? (_d = (_c = N()).__hekatanRebuild) == null ? void 0 : _d.call(_c) : (_f = (_e2 = N()).__hekatanLoadExampleById) == null ? void 0 : _f.call(_e2, x), await Re(), await Oe(150);
}
async function lt(x) {
  var _a, _b, _c, _d;
  if (!x || !Object.keys(x).length) return [];
  const e = (_b = (_a = N()).__hekatanParams) == null ? void 0 : _b.call(_a);
  ...
  return (_d = (_c = N()).__hekatanRebuild) == null ? void 0 : _d.call(_c), await Re(), await Oe(150), t;
}
function Ae() {
  var _a, _b, _c, _d, _e2;
  const x = N().__hekatanStates;
  if (!x) return null;
...
function es() {
  var _a, _b, _c, _d, _e2, _f, _g, _h, _i, _j2;
  const x = (_b = (_a = N().__hekatanStates) == null ? void 0 : _a.deformOutputs) == null ? void 0 : _b.val;
  ...
  for (const [h, o] of x.deformations) for (let c = 0; c < 3; c++) Math.abs(o[c]) > Math.abs(e[c]) && (e[c] = o[c], t[c] = h);
  const s = [0, 0, 0];
  for (const [, h] of x.reactions ?? /* @__PURE__ */ new Map()) for (let o = 0; o < 3; o++) s[o] += h[o] || 0;
  const i = (h) => +(h * 1e3).toFixed(3);
  let a;
  const r = (_g = (_f = (_e2 = (_d = N()).__hekatanSettings) == null ? void 0 : _e2.call(_d)) == null ? void 0 : _f.shellResults) == null ? void 0 : _g.val, l = r && r !== "none" ? (_j2 = (_i = (_h = N().__hekatanStates) == null ? void 0 : _h.analyzeOutputs) == null ? void 0 : _i.val) == null ? void 0 : _j2[r] : null;
  if (l instanceof Map && l.size) {
    let h = 1 / 0, o = -1 / 0, c = -1, d = -1;
    for (const [p, f] of l) for (const m of Array.isArray(f) ? f : [f]) Number.isFinite(m) && (m < h && (h = m, c = p), m > o && (o = m, d = p));
    Number.isFinite(h) && (a = { campo: r, minimo: +h.toPrecision(5), elemento_min: c, maximo: +o.toPrecision(5), elemento_max: d, unidades: "kN, m (momentos kN\xB7m/m, fuerzas kN/m, tensiones kN/m\xB2)" });
  }
  return { ...a ? { mapa_de_colores: a } : {}, ux_max_mm: i(e[0]), indice_nudo_ux: t[0], uy_max_mm: i(e[1]), indice_nudo_uy: t[1], uz_max_mm: i(e[2]), indice_nudo_uz: t[2], suma_reacciones_kN: { Fx: +s[0].toFixed(2), Fy: +s[1].toFixed(2), Fz: +s[2].toFixed(2) } };
}
function nt() {
  var _a, _b, _c, _d;
  const x = ((_b = (_a = N()).__hekatanParamDefs) == null ? void 0 : _b.call(_a)) ?? {}, e = ((_d = (_c = N()).__hekatanGetParams) == null ? void 0 : _d.call(_c)) ?? {}, t = {};
...
async function We(x, e) {
  ...
  switch (x) {
    case "obtener_modelo": {
      const t = (_b = (_a = N()).__hekatanExample) == null ? void 0 : _b.call(_a), s = { plantilla: t, ...Ae() };
      return t === "cli-modeler" ? s.script = String(N().__hekatanCliScript ?? "").slice(0, 3e3) : t && (s.parametros = nt()), s;
    }
    case "listar_plantillas": {
      const t = N().__hekatanExamples ?? [], s = String((e == null ? void 0 : e.filtro) ?? "").toLowerCase().normalize("NFD").replace(/[̀-ͯ]/g, ""), i = t.filter((a) => !s || `${a.id} ${a.name} ${a.category}`.toLowerCase().normalize("NFD").replace(/[̀-ͯ]/g, "").includes(s));
    ...
    case "cargar_plantilla": {
      ...
      if (!(N().__hekatanExamples ?? []).some((i) => i.id === t)) return { error: `no existe la plantilla '${t}'. Usa listar_plantillas.` };
    ...
    case "cambiar_parametros": {
      ...
      return { ok: t.length === 0, avisos: t, ...Ae(), ...t.length ? { claves_validas: Object.keys(((_d = (_c = N()).__hekatanGetParams) == null ? void 0 : _d.call(_c)) ?? {}) } : {} };
    }
    case "modelar_heks": {
      let t = String((e == null ? void 0 : e.script) ?? "").replace(/^```[a-z]*\n?/i, "").replace(/\n?```\s*$/, "");
      if ((e == null ? void 0 : e.modo) === "agregar") {
        const a = (_f = (_e2 = N()).__hekatanExample) == null ? void 0 : _f.call(_e2);
        t = String(a === "cli-modeler" ? N().__hekatanCliScript ?? "" : ((_h = (_g = N()).__hekatanModeloAHeks) == null ? void 0 : _h.call(_g)) ?? "").replace(/^\s*solve\s*$/gim, "") + `
` + t;
      }
      /^\s*solve\s*$/im.test(t) || (t += `
solve`), Ee.push(je()), N().__hekatanCliStats = null, N().__hekatanCliScript = t, await He("cli-modeler");
      for (let a = 0; a < 20 && !N().__hekatanCliStats; a++) await Oe(100);
      const s = N().__hekatanCliStats ?? {}, i = N().__hekatanCliErrors ?? [];
    ...
    case "resultados":
      return es();
    case "analisis_modal": {
      const t = (_j2 = (_i = N()).__hekatanModalResults) == null ? void 0 : _j2.call(_i);
      if (typeof N().__hekatanRunModalAnimate != "function") return { error: "esta plantilla no tiene an\xE1lisis modal" };
      N().__hekatanRunModalAnimate();
      let s = null;
      for (let r = 0; r < 100; r++) {
        await Oe(150);
        const l = (_l = (_k = N()).__hekatanModalResults) == null ? void 0 : _l.call(_k);
    ...
    case "vista": {
      const t = (_p = (_o = N()).__hekatanSettings) == null ? void 0 : _p.call(_o);
      return (e == null ? void 0 : e.deformada) !== void 0 && (t == null ? void 0 : t.deformedShape) && (t.deformedShape.val = !!e.deformada), (e == null ? void 0 : e.campo_cascara) && (t == null ? void 0 : t.shellResults) && (t.shellResults.val = e.campo_cascara), (e == null ? void 0 : e.camara) && ((_r = (_q = N()).__hekatanSetView) == null ? void 0 : _r.call(_q, e.camara)), await Re(), { ok: true };
    }
    case "deshacer": {
      const t = Ee.pop();
      if (!(t == null ? void 0 : t.ex)) return { error: "no hay nada que deshacer" };
      if (t.ex === "cli-modeler" && (N().__hekatanCliScript = t.script), await He(t.ex), t.ex !== "cli-modeler") {
        const s = (_t2 = (_s = N()).__hekatanParams) == null ? void 0 : _t2.call(_s);
        s && (Object.assign(s, t.params), (_v = (_u = N()).__hekatanRebuild) == null ? void 0 : _v.call(_u), await Re());
      }
...
function mt(x, e) {
  ...
  switch (x) {
    ...
    case "resultados":
      return `Uz ${e.uz_max_mm} mm \xB7 Ux ${e.ux_max_mm} mm \xB7 \u03A3Fz ${(_c = e.suma_reacciones_kN) == null ? void 0 : _c.Fz} kN` + (e.mapa_de_colores ? ` \xB7 ${e.mapa_de_colores.campo} ${e.mapa_de_colores.minimo}\u2026${e.mapa_de_colores.maximo}` : "");
    case "analisis_modal":
...
typeof window < "u" && (N().__hekatanAgenteIA = Xe, N().__hekatanPedirAgente = rs, N().__hekatanAgenteTool = We);
export {
  q as A,
  qt as D,
  fs as H,
