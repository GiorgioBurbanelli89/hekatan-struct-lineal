...
import { a as G } from "./analyze-CWJH9Nzr.js";
import { d as E, __tla as __tla_0 } from "./didacticCpp-iMwzdM-v.js";
import { g as K, a as N, __tla as __tla_1 } from "./aiAgent-BbDbzZHq.js";
import { g as T } from "./getParameters-Dgz5Nzxm.js";
...
Promise.all([
  ...
  o.derive(() => {
    const c = Math.round(u.nFloors.value.val), k = u.H_floor.value.val, H = u.baseR.value.val, A = u.windFactor.value.val, r = [], s = [];
    for (let t = 0; t <= c; t++) {
      const e = t / c, i = t * k;
      let d = H * (1 - e * 0.7);
    ...
    let v = {}, I = {};
    try {
      v = E(r, s, g, f), I = G(r, s, f, v);
    } catch (t) {
      console.warn("Burj Khalifa deform/analyze:", (t == null ? void 0 : t.message) ?? t);
    }
    z.val = r, S.val = s, P.val = g, R.val = f, C.val = v, j.val = I;
  });
  document.body.append(T(u), K({
    mesh: {
      nodes: z,
      elements: S,
      nodeInputs: P,
