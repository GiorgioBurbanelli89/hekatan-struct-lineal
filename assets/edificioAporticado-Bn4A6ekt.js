...
import { m as os, d as ze, __tla as __tla_0 } from "./didacticCpp-DH-WISVI.js";
import { a as es } from "./cadSections-Dft7f7lL.js";
import { b as ss, a as oo } from "./cotas3D-DoMwrmzt.js";
import { S as ns, f as as, M as Zo, e as Wo, b as Kt, B as mo, V as X, d as $e, c as is, L as Co, E as cs, N as rs, D as ls } from "./theme-C-zoknmI.js";
let ws, Cs;
let __tla = Promise.all([
  ...
  function gs(t, n, D, y, O, g, b, I = {}) {
    ...
    for (let W = 0; W < n.length; W++) {
      ...
      gt.push({
        ...
        classification: Se(wt)
      }), gt.push({
        nodeIdx: f,
        elementIdx: W,
        end: "j",
        classification: Se(zt)
      });
    }
    return gt;
  }
  ...
  function Ae(t) {
    ...
    const j = g * te, J = Math.abs(y / n), at = Math.abs(D / n), ut = j * 0.95;
  ...
  ws = {
    ...
    build(t, n) {
      ...
      const z = [], rt = /* @__PURE__ */ new Set(), wt = /* @__PURE__ */ new Set(), zt = /* @__PURE__ */ new Set(), $ = /* @__PURE__ */ new Map(), tt = (o, s, e, r, a) => {
        if (e <= 1) {
          r.add(z.length), $.set(z.length, a), z.push([
            o,
            s
          ]);
          return;
      ...
      if (t.vSecOn >= 0.5 && t.nVSec >= 1) {
        const o = Math.round(t.nVSec), s = (r, a, M) => {
          for (let d = 0; d < u.length; d++) if (Math.abs(u[d][0] - r) < 1e-6 && Math.abs(u[d][1] - a) < 1e-6 && Math.abs(u[d][2] - M) < 1e-6) return d;
          const l = u.length;
          return u.push([
            r,
            a,
        ...
        }, e = (r, a) => t.vSecDir < 0.5 ? "x" : t.vSecDir < 1.5 ? "y" : p[r + 1] - p[r] <= f[a + 1] - f[a] ? "x" : "y";
        for (let r = 1; r < h.length; r++) for (let a = 0; a < p.length - 1; a++) for (let M = 0; M < f.length - 1; M++) {
          const l = p[a], d = p[a + 1], v = f[M], i = f[M + 1];
          for (let C = 1; C <= o; C++) {
        ...
        for (let r = 0; r < e; r++) {
          if (o) for (let a = 0; a < f.length; a++) {
            ...
            for (let l = 0; l < p.length - 1; l++) {
              if ($t === 1 && l !== M || S(l, a) || S(l + 1, a)) continue;
              const d = T[`${l},${a},${r}`], v = T[`${l + 1},${a},${r + 1}`], i = T[`${l + 1},${a},${r}`], C = T[`${l},${a},${r + 1}`];
          ...
          if (s) for (let a = 0; a < p.length; a++) {
            ...
            for (let l = 0; l < f.length - 1; l++) {
              if ($t === 1 && l !== M || S(a, l) || S(a, l + 1)) continue;
              const d = T[`${a},${l},${r}`], v = T[`${a},${l + 1},${r + 1}`], i = T[`${a},${l + 1},${r}`], C = T[`${a},${l},${r + 1}`];
              d !== void 0 && v !== void 0 && z.push([
                d,
                v
              ]), i !== void 0 && C !== void 0 && z.push([
      ...
      if (t.slabOn >= 0.5) for (let o = 1; o < h.length; o++) {
        const s = h[o];
        for (let e = 0; e < p.length - 1; e++) for (let r = 0; r < f.length - 1; r++) {
          const a = p[e], M = p[e + 1], l = f[r], d = f[r + 1], { n: v } = Ao(Math.abs(M - a), Rt), { n: i } = Ao(Math.abs(d - l), Rt), C = [];
          for (let Y = 0; Y <= i; Y++) {
            const B = [];
            for (let lt = 0; lt <= v; lt++) {
              const R = a + lt / v * (M - a), _t = l + Y / i * (d - l), Mt = yt(R, _t, s), St = Lt.get(Mt);
      ...
      if (Jt > 0) {
        ...
        }, a = t.Lvix > 0 ? 1 : 0, M = t.Lviy > 0 ? 1 : 0, l = p.length - 1 - (t.Lvdx > 0 ? 1 : 0), d = f.length - 1 - (t.Lvdy > 0 ? 1 : 0);
      ...
      const Vt = Math.round(t.loadCase ?? 0), Oe = Vt === 1 ? [
        ...
        1,
        1
      ], [Fe, Le, Ee, Pe] = Oe, Lo = /* @__PURE__ */ new Map(), ee = Fe * t.CM + Le * t.CV;
      if (ee !== 0) for (let o = 1; o < h.length; o++) for (let s = 0; s < f.length; s++) for (let e = 0; e < p.length; e++) {
        const r = `${e},${s},${o}`;
        T[r] !== void 0 && Lo.set(T[r], [
          0,
          0,
          ee,
          0,
      ...
      const Xo = [
        ...
        t.vigaH_7,
        t.vigaH_8
      ].map((o) => o > 0 ? o : t.vigaH), Eo = Math.round(t.matCol) === 2, ae = (o) => {
        const s = Xo[o] ?? t.colSize, e = Go[o] ?? t.colSize;
        if (Eo) {
          const r = Math.min(t.tCft, Math.min(s, e) / 2 - 1e-3), a = es(s, e, r, K, J, N, j);
          return {
            A: a.A,
            Iz: a.Iz,
            Iy: a.Iy,
      ...
      }, Te = t.matCol < 0.5 ? N : K, Be = t.matCol < 0.5 ? at : ut, De = t.matCol < 0.5 ? j : J, Ye = t.matCol < 0.5 ? eo : Ro, qe = t.matViga < 0.5 ? N : K, He = t.matViga < 0.5 ? at : ut, Re = t.matViga < 0.5 ? j : J, Ze = t.matViga < 0.5 ? eo : Ro, Mo = /* @__PURE__ */ new Map(), po = /* @__PURE__ */ new Map(), Po = /* @__PURE__ */ new Map(), Io = /* @__PURE__ */ new Map(), Vo = /* @__PURE__ */ new Map(), No = /* @__PURE__ */ new Map(), xo = /* @__PURE__ */ new Map(), zo = /* @__PURE__ */ new Map(), Ko = /* @__PURE__ */ new Map(), ie = /* @__PURE__ */ new Map(), ce = /* @__PURE__ */ new Map(), re = /* @__PURE__ */ new Map(), le = /* @__PURE__ */ new Map(), de = /* @__PURE__ */ new Map(), fe = /* @__PURE__ */ new Map(), he = Math.round(t.slabType), je = he === 2 ? 0 : 1, Xe = he === 1 ? 0 : 1, To = t.crackedSections > 0.5, me = t.matCol < 0.5 && To ? 0.7 : 1, ue = t.matViga < 0.5 && To ? 0.35 : 1, Ge = To ? 0.25 : 1, Ke = 1, Bo = t.massSource > 0.5, Je = t.qDead + 0.25 * t.qLive, Ue = Bo ? Je / oe / Math.max(t.slabT, 0.05) : eo, Jo = /* @__PURE__ */ new Map();
      for (const o of rt) for (const s of z[o]) Jo.set(s, $.get(o) ?? 0);
      const Qe = (o) => {
        if (Math.round(t.offsets ?? 1) !== 1) return 1;
        const [s, e] = z[o], r = Math.abs(u[e][0] - u[s][0]), a = Math.abs(u[e][1] - u[s][1]), M = Math.hypot(r, a, u[e][2] - u[s][2]), l = r >= a, d = (v) => {
          if (!Jo.has(v)) return 0;
          const i = ae(Math.min(Jo.get(v), 7));
          return (l ? i.b : i.h) / 2;
        };
      ...
      for (let o = 0; o < z.length; o++) {
        const s = $.get(o) ?? 0;
        if (zt.has(o)) Mo.set(o, N), po.set(o, at), zo.set(o, j), Ko.set(o, t.slabT), de.set(o, je * Ke), fe.set(o, Xe * Ge), le.set(o, Math.round(t.slabForm ?? 1)), xo.set(o, Ue);
        else if (uo.has(o)) Mo.set(o, N), po.set(o, at), zo.set(o, j), Ko.set(o, t.tMuro ?? 0.25), xo.set(o, Bo ? 0 : eo);
        else if (rt.has(o)) {
          const e = ae(Math.min(s, 7));
          Mo.set(o, Te), po.set(o, Be), zo.set(o, De), Po.set(o, e.A), Io.set(o, e.Iz * me), Vo.set(o, e.Iy * me), No.set(o, e.J), Eo && (ce.set(o, e.As2), ie.set(o, e.As3), re.set(o, {
            type: "CFT",
            b: e.b,
            h: e.h,
            tw: e.t,
          ...
          const r = Eo ? (Ro * (e.b * e.h - (e.b - 2 * e.t) * (e.h - 2 * e.t)) + eo * (e.b - 2 * e.t) * (e.h - 2 * e.t)) / e.A : Ye;
          xo.set(o, Bo ? 0 : r);
        } else {
          const e = Ne(Math.min(s, 7));
          Mo.set(o, qe), po.set(o, He), zo.set(o, Re), Po.set(o, e.A), Io.set(o, e.Iz * ue), Vo.set(o, e.Iy * ue), No.set(o, e.J), xo.set(o, Bo ? 0 : Ze * Qe(o));
        }
      }
      if (t.diafragmaRigido >= 0.5) {
        ...
        ms(s, {
          ...
          shearModuli: po,
          areas: Po,
          momentsOfInertiaY: Io,
          momentsOfInertiaZ: Vo,
          torsionalConstants: No,
          densities: xo
        }, e);
      }
      n.nodes.val = u, n.elements.val = z;
      const Do = /* @__PURE__ */ new Map(), ge = Math.round(t.diafragmaNudos ?? 1);
      if (t.slabOn >= 0.5 && ge === 1) for (let o = 1; o < h.length; o++) for (let s = 0; s < f.length; s++) for (let e = 0; e < p.length; e++) {
        const r = T[`${e},${s},${o}`];
        r !== void 0 && Do.set(r, o);
      }
      if (t.slabOn >= 0.5 && ge === 2) for (let o = 1; o < h.length; o++) {
        const s = h[o];
        u.forEach((e, r) => {
          Math.abs(e[2] - s) < 1e-6 && Do.set(r, o);
        });
      }
      n.nodeInputs.val = {
        supports: wo,
      ...
      const Me = ze(u, z, n.nodeInputs.val, n.elementInputs.val);
      n.deformOutputs.val = Me, n.analyzeOutputs.val = ts(u, z, n.elementInputs.val, Me);
      const Uo = ss(p, f, h);
      try {
        const o = gs(u, z, n.analyzeOutputs.rawVal, n.elementInputs.rawVal, Math.round(t.matCol), Math.round(t.matViga), rt);
        let s = 1 / 0, e = 1 / 0, r = 1 / 0, a = -1 / 0, M = -1 / 0, l = -1 / 0;
        for (const i of u) i[0] < s && (s = i[0]), i[0] > a && (a = i[0]), i[1] < e && (e = i[1]), i[1] > M && (M = i[1]), i[2] < r && (r = i[2]), i[2] > l && (l = i[2]);
        const d = Math.sqrt((a - s) ** 2 + (M - e) ** 2 + (l - r) ** 2) || 1, v = Ms(o, u, d, {
          showElastic: false,
          radiusFactor: 0.015
        });
        Uo.push(...v), n.__plasticHinges = ps(o);
      } catch (o) {
        ...
        if (o) {
          ...
          if (o.forEach((a, M) => {
            ...
            !l || Math.abs(l[2]) > 1e-6 || (s.push({
              ...
              Mx_kN: a[3],
              My_kN: a[4]
            }), l[0] > e && (e = l[0]), l[1] > r && (r = l[1]));
          }), s.length > 0) {
            const a = t.q_adm_zapata ?? 10, M = t.ks_zapata ?? 1030, l = Math.max(0, t.Hf_pedestal ?? 0.5), d = Math.max(0.1, t.t_zapata ?? 0.3), v = Math.max(2, Math.round(t.nSubZapata ?? 4)), i = Math.max(0, t.voladoExtra ?? 0.3), C = Math.round(t.tipoZapataOverride ?? 0) | 0, Y = Math.round(t.estiloZapata ?? 1), B = jo(s, e, r, a, M), lt = [
              "central",
              "lindero",
              "esquinera"
            ];
            ...
            const R = [], _t = (E) => new Wo({
              ...
              color: 1118481,
              linewidth: 2
            }), pe = Xo[0] ?? t.colSize, xe = Go[0] ?? t.colSize;
            for (const E of B) {
              const Z = E.Lz, st = E.Bz, Gt = E.t;
              let Zt = 0, jt = 0;
              E.tipo === "esquinera" ? (Zt = E.x < e / 2 ? -(Z / 2 - i) : Z / 2 - i, jt = E.y < r / 2 ? -(st / 2 - i) : st / 2 - i) : E.tipo === "lindero" && (Math.abs(E.x) < 1e-3 || Math.abs(E.x - e) < 1e-3 ? Zt = E.x < e / 2 ? -(Z / 2 - i) : Z / 2 - i : (Math.abs(E.y) < 1e-3 || Math.abs(E.y - r) < 1e-3) && (jt = E.y < r / 2 ? -(st / 2 - i) : st / 2 - i));
              const U = E.x - Zt, F = E.y - jt, V = -l, Nt = V - Gt / 2, qt = V - Gt, so = E.ratio;
              let no = 4906624;
              if (so > 1.5 ? no = 15680580 : so > 1 ? no = 16096779 : so > 0.8 && (no = 16498468), l > 1e-3) {
                ...
                R.push(new $e(xt, new Kt({
                  color: 6333946,
                  linewidth: 4
                }))), R.push(oo(`Df=${l.toFixed(2)}m`, E.x + 0.1, E.y + 0.1, -l / 2, "#60a5fa"));
              }
              if (Y === 0) {
                const xt = new is(Z, st, Gt), Ut = new Zo(xt, _t(no));
                Ut.position.set(U, F, Nt), R.push(Ut);
                const Qt = new Co(new cs(xt), Mt);
                Qt.position.copy(Ut.position), R.push(Qt);
              } else {
                const xt = new rs(Z, st), Ut = new Wo({
                  color: no,
                  transparent: true,
                  opacity: 0.45,
                  roughness: 0.6,
                ...
                const ao = new Zo(xt.clone(), Ut.clone());
                ao.position.set(U, F, qt), R.push(ao);
                const ye = Z / v, _e = st / v, Xt = [];
                ...
                for (let kt = 0; kt < 4; kt++) {
                  ...
                  lo.push(new X(U + bt, F + c, V), new X(U + k, F + x, V)), lo.push(new X(U + bt, F + c, qt), new X(U + k, F + x, qt)), lo.push(new X(U + bt, F + c, V), new X(U + bt, F + c, qt));
                }
                const _o = new mo().setFromPoints(lo);
                R.push(new Co(_o, Mt));
              }
              (t.mostrarLabelsZapatas ?? 1) >= 0.5 && R.push(oo(`${E.tipo[0].toUpperCase()} ${Z.toFixed(2)}\xD7${st.toFixed(2)}\xD7${Gt.toFixed(2)}m \u03C3/q=${E.ratio.toFixed(2)}`, U, F, qt - 0.2, so <= 1 ? "#4ade80" : so <= 1.5 ? "#f59e0b" : "#ef4444"));
            }
            if (Math.round(t.sistemaCimentacion ?? 0) === 1) {
              const E = Math.round(t.vigaAmarre_pos ?? 0), Z = E === 0 ? -l : -l / 2, st = t.vigaAmarre_b ?? 0.25, Gt = t.vigaAmarre_h ?? 0.4, Zt = /* @__PURE__ */ new Map(), jt = /* @__PURE__ */ new Map();
              for (const F of s) {
              ...
              U.length > 0 && (R.push(new Co(new mo().setFromPoints(U), new Kt({
                color: 2282478,
                linewidth: 3
              }))), R.push(oo(`Vigas amarre ${(st * 100).toFixed(0)}\xD7${(Gt * 100).toFixed(0)} cm @ ${E === 0 ? "zapatas" : "pedestales"}`, e / 2, r / 2, Z + 0.2, "#22d3ee")));
            }
            Uo.push(...R);
          }
        }
        ...
        if (s && s.size > 0) {
          ...
          if (s.forEach((M, l) => {
            ...
            !d || Math.abs(d[2]) > 1e-6 || (e.push({
              ...
              Mx_kN: M[3],
              My_kN: M[4]
            }), d[0] > r && (r = d[0]), d[1] > a && (a = d[1]));
          }), e.length > 0) {
            const M = t.q_adm_zapata ?? 10, l = t.ks_zapata ?? 1030, d = Math.max(0, t.Hf_pedestal ?? 0.5), v = Math.max(0.1, t.t_zapata ?? 0.3), i = Math.max(2, Math.round(t.nSubZapata ?? 4)), C = Math.max(0, t.voladoExtra ?? 0.3), Y = Math.round(t.tipoZapataOverride ?? 0) | 0, B = jo(e, r, a, M, l), lt = [
              "central",
              "lindero",
              "esquinera"
            ];
            for (const c of B) Y > 0 && (c.tipo = lt[Y - 1]), c.t = v;
            const R = Xo[0] ?? t.colSize, _t = Go[0] ?? t.colSize, Mt = R * _t, St = R * _t ** 3 / 12, At = _t * R ** 3 / 12, vo = 0.14 * Math.pow(Math.min(R, _t), 4), pe = t.matCol < 0.5 ? N : K, xe = t.matCol < 0.5 ? at : ut, ve = t.matCol < 0.5 ? j : J, E = [], Z = [], st = /* @__PURE__ */ new Map(), Gt = /* @__PURE__ */ new Map(), Zt = /* @__PURE__ */ new Map(), jt = /* @__PURE__ */ new Map(), U = /* @__PURE__ */ new Map(), F = /* @__PURE__ */ new Map(), V = /* @__PURE__ */ new Map(), Nt = /* @__PURE__ */ new Map(), qt = /* @__PURE__ */ new Map(), so = /* @__PURE__ */ new Map(), no = /* @__PURE__ */ new Map(), $o = [], xt = [], Ut = (c, k, x) => `${Math.round(c * 1e4)},${Math.round(k * 1e4)},${Math.round(x * 1e4)}`, Qt = /* @__PURE__ */ new Map(), ao = (c, k, x) => {
            ...
            for (const c of B) {
              ...
              let q = 0, nt = 0;
              c.tipo === "esquinera" ? (q = c.x < r / 2 ? -(k / 2 - C) : k / 2 - C, nt = c.y < a / 2 ? -(x / 2 - C) : x / 2 - C) : c.tipo === "lindero" && (Math.abs(c.x) < 1e-3 || Math.abs(c.x - r) < 1e-3 ? q = c.x < r / 2 ? -(k / 2 - C) : k / 2 - C : (Math.abs(c.y) < 1e-3 || Math.abs(c.y - a) < 1e-3) && (nt = c.y < a / 2 ? -(x / 2 - C) : x / 2 - C));
              ...
              for (let H = 0; H < i; H++) for (let ot = 0; ot < i; ot++) {
                ...
                Z.push([
                  ...
                  dt[H + 1][ot + 1],
                  dt[H + 1][ot]
                ]), qt.set(ht, L), st.set(ht, N), Nt.set(ht, j), Gt.set(ht, at), V.set(ht, eo);
              }
              const io = 0.5;
              for (let H = 0; H <= i; H++) for (let ot = 0; ot <= i; ot++) {
                const ht = Bt * to * (ot === 0 || ot === i ? 0.5 : 1) * (H === 0 || H === i ? 0.5 : 1), Yt = l * ht, Ct = Yt * io, A = dt[H][ot];
                $o.push({
                  node: A,
                  dof: 0,
                  k: Ct
              ...
              const co = c.ratio;
              let bo = 4906624;
              if (co > 1.5 ? bo = 15680580 : co > 1 ? bo = 16096779 : co > 0.8 && (bo = 16498468), d > 1e-3) {
                const H = new mo().setFromPoints([
                  new X(c.x, c.y, 0),
                  new X(c.x, c.y, -d)
                ]);
                xt.push(new $e(H, new Kt({
                  color: 6333946,
                  linewidth: 4
              ...
              if ((t.mostrarLabelsZapatas ?? 1) >= 0.5) {
                ...
                xt.push(oo(`P=${H.toFixed(2)} tonf`, c.x, c.y, 0.3, "#fbbf24")), xt.push(oo(`Mx=${ot.toFixed(2)}  My=${ht.toFixed(2)} tonf\xB7m`, c.x, c.y, 0.1, "#fbbf24")), xt.push(oo(`${c.tipo[0].toUpperCase()} ${k.toFixed(2)}\xD7${x.toFixed(2)}\xD7${L.toFixed(2)}m \u03C3/q=${co.toFixed(2)}`, Tt, Et, -d - L - 0.2, co <= 1 ? "#4ade80" : co <= 1.5 ? "#f59e0b" : "#ef4444"));
              }
            }
            ...
            if (Xt === 1) {
              ...
              for (const w of B) {
                let P;
                c === 0 ? P = -d : P = -d / 2;
                const _ = ao(w.x, w.y, P);
                if (Et.set(w.idx, _), c === 1 && d > 1e-3) {
                  const ft = ao(w.x, w.y, -d / 2), Ht = ao(w.x, w.y, 0), Ot = ao(w.x, w.y, -d);
                }
              }
              ...
              const to = (w, P) => {
                ...
                Z.push([
                  w,
                  P
                ]), st.set(_, pe), Gt.set(_, xe), Nt.set(_, ve), Zt.set(_, L), jt.set(_, nt), U.set(_, q), F.set(_, Tt), V.set(_, eo);
              };
              let dt = 0;
              ...
              xt.push(oo(`+${dt} vigas de amarre ${(x * 100).toFixed(0)}\xD7${(k * 100).toFixed(0)} cm @ ${c === 0 ? "zapatas" : "pedestales"}`, r / 2, a / 2, c === 1 ? -d / 2 + 0.3 : -d + 0.3, "#22d3ee")), console.log(`[Cimentaci\xF3n] Sistema 1 \u2014 ${dt} vigas de amarre ${(x * 100).toFixed(0)}\xD7${(k * 100).toFixed(0)} cm en posici\xF3n ${c === 0 ? "zapatas" : "pedestales"}`);
            ...
            ][Xt]}) a\xFAn no implementado completamente. Mostrando zapatas aisladas. Pr\xF3ximamente: malla shell continua + frames T-invertida.`), xt.push(oo(`Sistema ${Xt} (TODO) \u2014 usando zapatas aisladas`, r / 2, a / 2, 1.5, "#fbbf24")));
            const So = Math.round(t.sistemaCimentacion ?? 0), yo = 0.3, lo = Math.round(t.vigaAmarre_pos ?? 0), _o = /* @__PURE__ */ new Map();
            if (So === 1) {
              ...
              }), lo === 0 && console.log("   \u21B3 vigaAmarre_pos=0 (mismo nivel zapata) \u2192 en F2K se exportar\xE1 como cimentaci\xF3n corrida con ks\xB7b\xB7dL distribuido por nodo");
            }
            const kt = /* @__PURE__ */ new Map(), bt = /* @__PURE__ */ new Map();
            for (const c of B) {
              const k = e.find((A) => A.idx === c.idx), x = c.Lz, L = c.Bz, q = c.t;
              let nt = 0, Tt = 0;
              c.tipo === "esquinera" ? (nt = c.x < r / 2 ? -(x / 2 - C) : x / 2 - C, Tt = c.y < a / 2 ? -(L / 2 - C) : L / 2 - C) : c.tipo === "lindero" && (Math.abs(c.x) < 1e-3 || Math.abs(c.x - r) < 1e-3 ? nt = c.x < r / 2 ? -(x / 2 - C) : x / 2 - C : (Math.abs(c.y) < 1e-3 || Math.abs(c.y - a) < 1e-3) && (Tt = c.y < a / 2 ? -(L / 2 - C) : L / 2 - C));
              ...
              for (let A = 0; A <= i; A++) {
                ...
                for (let mt = 0; mt <= i; mt++) {
                  const Pt = -x / 2 + mt * io, Ft = -L / 2 + A * Dt;
                  et.push(Bt.length), Bt.push([
                    Pt,
                    Ft,
                    0
                  ]);
                  const Yo = Et + Pt, qo = Wt + Ft, Ho = Ut(Yo, qo, -d), fo = Qt.get(Ho);
                  fo !== void 0 ? P.push(fo) : P.push(-1);
                }
                w.push(et);
              }
              for (let A = 0; A < i; A++) for (let et = 0; et < i; et++) {
                ...
                to.push([
                  ...
                  w[A + 1][et + 1],
                  w[A + 1][et]
                ]), dt.thicknesses.set(mt, q), dt.elasticities.set(mt, N), dt.poissonsRatios.set(mt, j), dt.shearModuli.set(mt, at), dt.densities.set(mt, eo);
              }
              const _ = [], ft = 0.5;
              for (let A = 0; A <= i; A++) for (let et = 0; et <= i; et++) {
                const mt = io * Dt * (et === 0 || et === i ? 0.5 : 1) * (A === 0 || A === i ? 0.5 : 1), Pt = l * mt, Ft = w[A][et];
                _.push({
                  node: Ft,
                  dof: 0,
                  k: Pt * ft
              ...
              if (So === 1 && lo === 0) {
                const A = t.vigaAmarre_b ?? 0.25, et = c.idx, mt = e.filter((pt) => Math.abs(pt.y - c.y) < 1e-3 && pt.idx !== et).sort((pt, ko) => pt.x - ko.x), Pt = e.filter((pt) => Math.abs(pt.x - c.x) < 1e-3 && pt.idx !== et).sort((pt, ko) => pt.y - ko.y), Ft = mt.find((pt) => pt.x > c.x), Yo = [
                  ...mt
                ].reverse().find((pt) => pt.x < c.x), qo = Pt.find((pt) => pt.y > c.y), Ho = [
                  ...Pt
                ].reverse().find((pt) => pt.y < c.y), fo = (pt, ko) => {
                  const be = ko / 2;
                  for (let ro = 0; ro <= i; ro++) {
                    const We = ro === 0 || ro === i ? be / (2 * i) : be / i, Ce = l * A * We, we = Ce * ft;
                    let ho;
                    switch (pt) {
                      case "x+":
                        ho = w[ro][i];
                ...
                Ft && fo("x+", Ft.x - c.x), Yo && fo("x-", c.x - Yo.x), qo && fo("y+", qo.y - c.y), Ho && fo("y-", c.y - Ho.y);
              }
              const Ht = l * io * Dt * 1e-4;
              _.push({
                node: w[0][0],
                dof: 3,
                k: Ht
              ...
              let bo = 0, Qo = 0, H = 1 / 0;
              for (let A = 0; A <= i; A++) for (let et = 0; et <= i; et++) {
                const mt = -x / 2 + et * io, Pt = -L / 2 + A * Dt, Ft = (mt - Ot) ** 2 + (Pt - co) ** 2;
                Ft < H && (H = Ft, bo = A, Qo = et);
              }
              const ot = w[bo][Qo], ht = /* @__PURE__ */ new Map(), Yt = _o.get(c.idx) ?? 0, Ct = So === 1 ? Math.max(0.4, 1 - yo * Yt / 4) : 1;
              ht.set(ot, [
                0,
                0,
                -k.P_kN,
            ...
            }, n.objects3D.val = xt, console.log(`[Modo Cimentaci\xF3n] ${e.length} zapatas + pedestales (Hf=${d} m, t=${v} m, q_adm=${M} tonf/m\xB2, ks=${l} kN/m\xB3) \u2014 reemplaza superestructura`);
            try {
              const c = () => {
                var _a2;
