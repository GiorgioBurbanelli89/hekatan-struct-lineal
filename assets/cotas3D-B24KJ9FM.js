import { a as y, B as E, V as P, d as b, g as F, h as L, i as B, j as M } from "./theme-Dxpmbnyd.js";
...
function r(o, h, p = 58879) {
  const n = new y({ color: p, depthTest: false }), c = new E().setFromPoints([new P(...o), new P(...h)]), a = new b(c, n);
