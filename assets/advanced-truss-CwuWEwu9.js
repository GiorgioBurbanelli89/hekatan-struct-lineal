...
import { a as pe, __tla as __tla_0 } from "./analyze-Du843e5g.js";
import { d as re, __tla as __tla_1 } from "./didacticCpp-Czy7NlhT.js";
import { g as ue, __tla as __tla_2 } from "./getViewer-B5L64pyA.js";
import { g as me } from "./getParameters-BKCcIidf.js";
import { g as de } from "./aiAgent-VzHiuQev.js";
import { g as ce, __tla as __tla_3 } from "./getCad3d-wulwkUKJ.js";
...
Promise.all([
  ...
  a.derive(() => {
    ...
    if (t = l / Math.round(l / t), Math.abs(v - 0.5 * (g + c)) > 0.3 || Math.abs(n - 0.5 * (d + m)) > 0.3) {
      ...
      let U = u;
      u === 1 && (U = 2), u === 2 && (U = 1);
      const { nodes: z, elements: oe, topNodesIndices: ae, chordsIndices: ie, websIndices: he } = V(h ? l - 2 * t : l - t, t, U, v - Z * t, h ? c + Z * t : c, n - _ * t, h ? m + _ * t : m, l + t);
      if (b.push(...q(ie, s.length)), w.push(...q(he, s.length)), s.push(...fe(oe, p.length)), S.push(...q(ae, p.length)), p.push(...z), h) {
        p.push([
          0,
          0,
          f == 3 ? g + d : d
