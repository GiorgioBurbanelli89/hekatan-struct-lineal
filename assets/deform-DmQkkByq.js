...
let __tla = (async () => {
  Wn = async function(we = {}) {
    ...
    var Pe;
    function br() {
      return d.locateFile ? pr("deform.wasm") : new URL("/hekatan-struct-lineal/assets/deform-WA0t4dQX.wasm", import.meta.url).href;
    }
    function Tr(e) {
    ...
    var pe = (e) => sr(e), Xe = (e) => {
      ...
      u(v), u(m), u(ge(v) <= 16, `timezone name truncated to fit in TZNAME_MAX (${v})`), u(ge(m) <= 16, `timezone name truncated to fit in TZNAME_MAX (${m})`), l < c ? (ie(v, t, 17), ie(m, n, 17)) : (ie(v, n, 17), ie(m, t, 17));
...
`));
      ...
      try {
        var _ = t;
        typeof t == "string" && (_ = await dt(t)), _ = await vt(_, l), c == null ? void 0 : c(), a || ft(e, r, _, n, o, s);
      } finally {
        _t(f);
      }
      ...
      rename(e, r) {
        ...
        var f = i.lookupNode(c, o), _ = V.relative(e, n);
        if (_.charAt(0) !== ".") throw new i.ErrnoError(28);
        if (_ = V.relative(r, t), _.charAt(0) !== ".") throw new i.ErrnoError(55);
        var v;
        try {
          v = i.lookupNode(l, a);
        } catch {
        ...
        if (f !== v) {
          var m = i.isDir(f.mode), h = i.mayDelete(c, o, m);
          if (h) throw new i.ErrnoError(h);
          if (h = v ? i.mayDelete(l, a, m) : i.mayCreate(l, a), h) throw new i.ErrnoError(h);
        ...
        return i.registerDevice(s, {
          ...
          read(c, l, f, _, v) {
            for (var m = 0, h = 0; h < _; h++) {
              ...
              if (S === void 0 && m === 0) throw new i.ErrnoError(6);
              if (S == null) break;
              m++, l[f + h] = S;
            }
      ...
      createLazyFile(e, r, t, n, o) {
        class a {
          ...
          get(m) {
            if (!(m > this.length - 1 || m < 0)) {
              var h = m % this.chunkSize, S = m / this.chunkSize | 0;
          ...
          cacheLength() {
            ...
            m.open("HEAD", t, false), m.send(null), m.status >= 200 && m.status < 300 || m.status === 304 || T("Couldn't load " + t + ". Status: " + m.status);
            var h = Number(m.getResponseHeader("Content-length")), S, P = (S = m.getResponseHeader("Accept-Ranges")) && S === "bytes", N = (S = m.getResponseHeader("Content-Encoding")) && S === "gzip", R = 1024 * 1024;
            P || (R = h);
            var C = (L, X) => {
        ...
        var f = {};
        for (const [v, m] of Object.entries(l.stream_ops)) f[v] = (...h) => (i.forceLoadFile(l), m(...h));
        function _(v, m, h, S, P) {
          var N = v.node.contents;
          if (P >= N.length) return 0;
          var R = Math.min(N.length - P, S);
          if (u(R >= 0), N.slice) for (var C = 0; C < R; C++) m[h + C] = N[P + C];
          else for (var C = 0; C < R; C++) m[h + C] = N.get(P + C);
          return R;
        }
        return f.read = (v, m, h, S, P) => (i.forceLoadFile(l), _(v, m, h, S, P)), f.mmap = (v, m, h, S, P) => {
          i.forceLoadFile(l);
          var N = Qe();
    ...
    function Ut(e, r, t, n, o, a, s, c, l) {
      var f = E();
      try {
        return w(e)(r, t, n, o, a, s, c, l);
      } catch (_) {
        if (y(f), !(_ instanceof g)) throw _;
        p(1, 0);
      }
    }
    function Bt(e, r, t) {
    ...
    function Kt(e, r, t, n, o, a, s, c, l, f, _, v, m, h, S, P, N) {
      var R = E();
      try {
        w(e)(r, t, n, o, a, s, c, l, f, _, v, m, h, S, P, N);
      } catch (C) {
        if (y(R), !(C instanceof g)) throw C;
        p(1, 0);
      }
    }
    function Jt(e, r, t, n, o, a, s, c, l, f, _) {
      var v = E();
      try {
        w(e)(r, t, n, o, a, s, c, l, f, _);
      } catch (m) {
        if (y(v), !(m instanceof g)) throw m;
        p(1, 0);
      }
    }
    function Qt(e, r, t, n, o, a, s, c, l, f, _, v, m, h, S) {
      var P = E();
      try {
        return w(e)(r, t, n, o, a, s, c, l, f, _, v, m, h, S);
      } catch (N) {
    ...
    function on(e, r, t, n, o, a, s, c, l, f, _, v, m) {
      var h = E();
      try {
    ...
    function an(e, r, t, n, o, a, s, c, l, f, _, v) {
      var m = E();
      try {
        w(e)(r, t, n, o, a, s, c, l, f, _, v);
      } catch (h) {
        if (y(m), !(h instanceof g)) throw h;
        p(1, 0);
      }
    }
    ...
    function ln(e, r, t, n, o, a, s, c, l, f, _, v, m, h) {
      var S = E();
      try {
        w(e)(r, t, n, o, a, s, c, l, f, _, v, m, h);
      } catch (P) {
    ...
    function un(e, r, t, n, o, a, s, c, l, f, _, v, m) {
      var h = E();
      try {
        w(e)(r, t, n, o, a, s, c, l, f, _, v, m);
      } catch (S) {
    ...
    function pn(e, r, t, n, o, a, s, c, l, f, _, v, m, h, S, P, N, R) {
      var C = E();
      try {
        w(e)(r, t, n, o, a, s, c, l, f, _, v, m, h, S, P, N, R);
      } catch (W) {
        if (y(C), !(W instanceof g)) throw W;
        p(1, 0);
      }
    }
    function gn(e, r, t, n, o, a, s, c, l, f, _, v, m, h, S, P) {
      var N = E();
      try {
        w(e)(r, t, n, o, a, s, c, l, f, _, v, m, h, S, P);
      } catch (R) {
    ...
    function Sn(e, r, t, n, o, a, s, c, l, f, _, v, m, h, S, P) {
      var N = E();
      try {
        w(e)(r, t, n, o, a, s, c, l, f, _, v, m, h, S, P);
      } catch (R) {
    ...
    function Dn(e, r, t, n, o, a, s, c, l, f, _, v, m) {
      var h = E();
      try {
    ...
    function In(e, r, t, n, o, a, s, c, l, f, _, v) {
      var m = E();
      try {
    ...
    function xn(e, r, t, n, o, a, s, c, l, f, _, v, m, h, S, P) {
      var N = E();
      try {
        w(e)(r, t, n, o, a, s, c, l, f, _, v, m, h, S, P);
      } catch (R) {
