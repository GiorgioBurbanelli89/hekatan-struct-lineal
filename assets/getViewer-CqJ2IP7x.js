import { u as nn, a6 as Ao, q as Ka, v as re, a7 as Wa, D as Et, M as lt, B as Ae, F as Vt, a8 as Ga, z as ht, a9 as Ha, aa as Ja, h as Hs, ab as Js, r as $n, ac as $o, ad as Io, a4 as ca, _ as ct, b as dt, L as Jt, y as da, c as Qa, ae as Oa, f as pt, V as E, $ as Vn, af as ss, K as Ro, d as Ft, a as as, A as ua, t as To, J as ja, H as ao, I as ei, ag as Lo, w as is, o as ti, N as kn, a2 as no, E as Qs, S as Wn, m as ls, ah as oo, g as Os, i as js, j as ea, C as ta, W as ni, X as oi, Y as si, Z as ai, T as Fo, P as rs, U as ii } from "./theme-C-zoknmI.js";
import { T as $t, O as na } from "./Text-Cehu0nom.js";
import { P as fa } from "./tweakpane-BXg6ZhiP.js";
import { e as li } from "./styles-B5H5QzjE.js";
class pa {
  constructor(y, g = 32) {
...
function hi(t, y, g, b) {
  ...
  return re.derive(() => {
    ...
    (_b = (_a = t.nodeInputs) == null ? void 0 : _a.val.supports) == null ? void 0 : _b.forEach((we, O) => {
      ...
      let se;
      Z >= 3 && le >= 3 ? se = new lt(z, F) : Z >= 3 && le === 0 ? se = new lt(A, C) : se = new lt(A, L), se.position.set(U[0], U[1], U[2]);
      const oe = fe * te();
...
function bi(t, y, g, b) {
  ...
  return re.derive(() => {
    ...
    G.forEach((R, Q) => {
      ...
      if (W.type === "CFT") {
        const me = N(W.b, W.h, W.tw ?? W.b * 0.05), Ve = new lt(me.concFill, ce);
        Ve.position.set(..._e), Ve.rotation.setFromRotationMatrix(de), S.add(Ve);
        const ve = new lt(me.steelFillGeom, le);
        ve.position.set(..._e), ve.rotation.setFromRotationMatrix(de), S.add(ve);
    ...
    try {
      fe.forEach((Z, le) => {
        ...
        if (Z.length === 3 || Z.length === 4) {
          ...
          const Fe = new Ae();
          Fe.setAttribute("position", new Vt(Q, 3)), Fe.computeVertexNormals(), b.add(new lt(Fe, A));
        }
      });
    } catch (Z) {
...
class Eo extends ct {
  constructor(y, g, b, S, z, A, F) {
    ...
    this.mesh = new lt(B, te), this.mesh.position.set(...y), this.mesh.rotation.setFromRotationMatrix(S), F && this.mesh.rotateX(Math.PI / 2), this.add(this.mesh), this.text = new $t(`${z[1].toFixed(4)}`), this.normalizedResult = A, this.textPosition = io([y, g]), this.text.position.set(...this.textPosition), this.text.rotation.setFromRotationMatrix(S), this.add(this.text);
  }
  updateScale(y) {
...
class us extends ct {
  constructor(y, g, b, S, z, A, F) {
    ...
    if (this.text = new $t(`${z[0].toFixed(4)}`), this.text2 = new $t(`${(z[1] * -1).toFixed(4)}`), this.normalizedResult = A, this.textPosition = ps(y, g), this.text2Position = ps(g, y), this.text.position.set(...this.textPosition), this.text2.position.set(...this.text2Position), this.text.rotation.setFromRotationMatrix(S), this.text2.rotation.setFromRotationMatrix(S), this.add(this.text, this.text2), L) {
      ...
      this.mesh = new lt(ce, le), this.mesh2 = new lt(Z, se), this.mesh.position.set(...y), this.mesh2.position.set(...y), this.mesh.rotation.setFromRotationMatrix(S), this.mesh2.rotation.setFromRotationMatrix(S), F && this.mesh.rotateX(Math.PI / 2), F && this.mesh2.rotateX(Math.PI / 2), this.add(this.mesh, this.mesh2);
    } else {
...
function Ei({ drawingObj: t, gridObj: y, scene: g, getActiveCamera: b, controls: S, gridSize: z, derivedDisplayScale: A, rendererElm: F, viewerRender: C }) {
  ...
  }, te = new lt(new kn(1e4, 1e4), new pt({ side: Et, transparent: true, opacity: 0, depthWrite: false }));
  ...
  const oe = (e, o, s) => Math.round(e * 1e3) + "," + Math.round(o * 1e3) + "," + Math.round(s * 1e3), J = (e) => {
    ...
    const { S: o, adj: s } = e, n = (x, v) => new E(o[6 * x + 3 * v], o[6 * x + 3 * v + 1], o[6 * x + 3 * v + 2]), a = /* @__PURE__ */ new Set([e.s]), c = (x, v) => {
      ...
      for (let $ = 0; $ < 3e3; $++) {
        ...
        if (T.length !== 1) break;
        const I = T[0], Y = n(I, 0), ee = n(I, 1), pe = Y.distanceTo(P) < ee.distanceTo(P) ? ee : Y, be = P.clone().sub(k).normalize(), Qe = pe.clone().sub(P).normalize();
        if (be.dot(Qe) < Math.cos(35 * Math.PI / 180)) break;
        a.add(I), V.push(pe), k = P, P = pe;
      }
      return V;
    }, i = n(e.s, 0), l = n(e.s, 1), r = c(i, l), f = c(l, i), d = [...f.reverse(), i, l, ...r], w = f.length;
    ...
    }, l = [], r = a >= 0 ? e[0].getComponent(a) : 0, f = a >= 0 ? e[e.length - 1].getComponent(a) : 0, d = a >= 0 && Math.abs(f - r) > 1e-6 && e.every((w, p) => p === 0 || (w.getComponent(a) - e[p - 1].getComponent(a)) * (f - r) >= -1e-6);
    for (let w = 0; w <= s; w++) {
      const p = d ? i((h) => h.getComponent(a), r + (f - r) * w / s) : i((h, M) => c[M], c[c.length - 1] * w / s);
      l.push([p.x, p.y, p.z]);
    }
  ...
  const he = (e, o) => {
    ...
    for (c[o] = 1; l.length && i.length < 4e4; ) {
      ...
      for (let f = 0; f < 3; f++) {
        const d = e.vec[3 * r + f];
        if (d < 0 || c[d]) continue;
        const w = e.N[3 * r] * e.N[3 * d] + e.N[3 * r + 1] * e.N[3 * d + 1] + e.N[3 * r + 2] * e.N[3 * d + 2], p = a[0] * e.N[3 * d] + a[1] * e.N[3 * d + 1] + a[2] * e.N[3 * d + 2];
        w >= s && p >= n && (c[d] = 1, l.push(d));
      }
    }
    return i;
  }, ye = (e, o, s) => {
    ...
    R.geometry.dispose(), R.geometry = new Ae(), R.geometry.setAttribute("position", new ht(c, 3)), R.material.color.set(l ? 3718648 : 16096779), R.visible = true, Q = { m: e, t0: o, tris: a, normal: i, plana: l, punto: s.clone() };
  }, Me = (e, o) => {
    ...
    for (let d = 0; d < r.length; d++) {
      const w = r[(d + r.length - 1) % r.length], p = r[d], h = r[(d + 1) % r.length];
  ...
  const Fe = 1, me = (e, o, s) => Math.floor(e / Fe) + "," + Math.floor(o / Fe) + "," + Math.floor(s / Fe), Ve = (e) => {
    ...
    if (s) {
      ...
      for (let m = 0; m < s.count; m++) r.fromBufferAttribute(s, m).applyMatrix4(e.matrixWorld), l[3 * m] = r.x, l[3 * m + 1] = r.y, l[3 * m + 2] = r.z;
      const f = (m) => Math.round(l[3 * m] * 1e3) + "," + Math.round(l[3 * m + 1] * 1e3) + "," + Math.round(l[3 * m + 2] * 1e3), d = new Float64Array(i * 3), w = new E(), p = new E(), h = new E();
      for (let m = 0; m < i; m++) {
        const u = 3 * m, x = 3 * m + 1, v = 3 * m + 2;
        w.set(l[3 * x] - l[3 * u], l[3 * x + 1] - l[3 * u + 1], l[3 * x + 2] - l[3 * u + 2]), p.set(l[3 * v] - l[3 * u], l[3 * v + 1] - l[3 * u + 1], l[3 * v + 2] - l[3 * u + 2]), h.crossVectors(w, p).normalize(), d[3 * m] = h.x, d[3 * m + 1] = h.y, d[3 * m + 2] = h.z;
      }
  ...
  const Oe = (e, o) => {
    ...
    for (let m = -1; m <= 1; m++) for (let u = -1; u <= 1; u++) for (let x = -1; x <= 1; x++) {
      const v = n.celdas.get(c + m + "," + (i + u) + "," + (l + x));
      if (v) for (const V of v) {
        ...
        const Qe = Math.hypot(s.x - (P.x + be * Y), s.y - (P.y + be * ee));
        Qe < w && (w = Qe, p = M.clone().lerp(_, be), h = V);
      }
    }
  ...
  const ke = new E(), Ne = (e, o, s, n, a, c) => {
    ...
    if (Pe.style.left = w + "px", Pe.style.top = p + "px", Pe.style.display = "block", !Ge) {
  ...
  window.__hekatanTypeCoord = (e) => {
    ...
    if (e.key === "Enter") {
      ...
      const s = _t(Pe.value);
      if (!s) return;
      if (Ge = false, s.kind === "length") ot(s.L), ie(`\u270F DDE ${s.L}m aplicado en direcci\xF3n actual`);
      else {
        const n = Dt(s);
        if (!n) return;
        nt(n);
  ...
  const on = (e) => {
    ...
    for (const m of r) for (const u of n.get(m)) if (!(u < m)) {
      for (const x of n.get(u)) if (x !== m) for (const v of n.get(x)) {
        ...
        l.has(V) || (l.add(V), i.push([m, u, x, v]));
      }
    }
    for (const m of r) for (const u of n.get(m)) if (!(u < m)) for (const x of n.get(u)) {
      if (x === m || !c(x, m)) continue;
      const v = [m, u, x].slice().sort((V, k) => V - k).join("-");
      l.has(v) || (l.add(v), i.push([m, u, x]));
    }
  ...
  const Ma = (e, o, s, n) => {
    ...
    for (const i of Ue) {
      ...
      if (l === "pt") {
        ...
        const f = o[+r[0]], d = e[f == null ? void 0 : f[+r[1]]], w = e[f == null ? void 0 : f[+r[1] + 1]];
        if (!d || !w) continue;
  ...
  const Hn = (e, o, s, n, a, c, i, l, r) => {
    const f = i - n, d = l - a, w = r - c, p = f * f + d * d + w * w;
  ...
  Le.geometry.setAttribute("position", new Vt(t.points.rawVal.flat(), 3)), Le.geometry.computeBoundingSphere(), Le.frustumCulled = false, Be.frustumCulled = false, g.add(Be), te.position.set(0, 0, 0), te.rotateX(Math.PI / 2), te.geometry.rotateX(Math.PI / 2), te.updateMatrixWorld(), t.polylines && (t.polylines.val = [...t.polylines.rawVal, []]), window.__hekatanDrawAt = (e, o, s) => {
  ...
  const Cs = () => {
    ...
    for (const a of o) {
      ...
      const l = [0, 1, 2].map((d) => i.reduce((w, p) => w + p[d], 0) / i.length), r = i.map((d) => Math.hypot(d[0] - l[0], d[1] - l[1], d[2] - l[2])), f = r.reduce((d, w) => d + w, 0) / r.length;
  ...
  window.__hekatanDrawCircle = (e, o, s, n, a = window.__hekatanArcSegs ?? 12, c = "xy") => {
    ...
    for (let f = 0; f < i; f++) {
      ...
      let h;
      c === "xy" ? h = [e + w, o + p, s] : c === "xz" ? h = [e + w, o, s + p] : h = [e, o + w, s + p], r.push(h);
    }
    ...
    if (t.points.val = [...t.points.rawVal, ...r], t.polylines) {
      const f = [...r.map((w, p) => l + p), l], d = t.polylines.rawVal;
    ...
    var _a3;
    const a = Math.max(4, Math.round(n)), c = new E(...e), i = new E(...o), l = new E(...s), r = new E().subVectors(i, c), f = new E().subVectors(l, c), d = new E().crossVectors(r, f), w = 2 * d.lengthSq();
    let p;
    if (w < 1e-12) p = new E().addVectors(c, l).multiplyScalar(0.5);
    else {
    ...
    const n = Math.max(s - 1, Math.round(o)), a = (k) => Math.max(...e.map((P) => P[k])) - Math.min(...e.map((P) => P[k])), c = [a(0), a(1), a(2)], i = String(((_c = (_b = (_a3 = window.__hekatanCadState) == null ? void 0 : _a3.get) == null ? void 0 : _b.call(_a3)) == null ? void 0 : _c.workPlane) ?? ""), l = i === "xy" ? 2 : i === "xz" ? 1 : i === "yz" ? 0 : -1, r = l >= 0 && c[l] < 1e-6 ? l : c[2] <= c[0] && c[2] <= c[1] ? 2 : c[1] <= c[0] ? 1 : 0, f = r === 2 ? "xy" : r === 1 ? "xz" : "yz", d = [0, 1, 2].filter((k) => k !== r), [w, p] = c[d[0]] >= c[d[1]] ? d : [d[1], d[0]], h = e.map((k) => k[w]), M = e.map((k) => k[p]);
  ...
  const zs = () => {
    ...
    return [...Ue].forEach((f) => {
      ...
      if (!(w < 0 || !o[w] || s.has(w))) if (d[0] === "poly") {
        if (l.has(w)) return;
        l.add(w);
        for (let p = 0; p + 1 < o[w].length; p++) c.push([r(o[w][p]), r(o[w][p + 1])]);
      } else {
        const p = o[w][+d[2]], h = o[w][+d[2] + 1];
        p != null && h != null && !l.has(w) && c.push([r(p), r(h)]);
      }
    }), { segs: c, auxIds: i };
    ...
    for (let n = 0; n < e.length; n++) {
      ...
      for (; c; ) {
        ...
        for (let l = 0; l < e.length; l++) {
          if (o[l]) continue;
          const [r, f] = e[l], d = a[a.length - 1], w = a[0];
          Jn(r, d) ? (a.push(f), o[l] = true, c = true) : Jn(f, d) ? (a.push(r), o[l] = true, c = true) : Jn(f, w) ? (a.unshift(r), o[l] = true, c = true) : Jn(r, w) && (a.unshift(f), o[l] = true, c = true);
        }
      }
  ...
  window.__hekatanRevolveSelection = (e, o, s, n = 360) => {
    ...
    for (const [$, T] of r) {
      ...
      if (!(I.length === 1 && Y.length === 1)) {
        if (I.length === 1 || Y.length === 1) {
          ...
          for (let be = 0; be + 2 <= i; be += 2) k([ee, pe[be % l], pe[(be + 1) % l], pe[(be + 2) % l]]);
          continue;
        }
        for (let ee = 0; ee < i; ee++) k([I[ee], Y[ee], Y[(ee + 1) % l], I[(ee + 1) % l]]);
      }
    }
    ...
    var _a3, _b, _c;
    const { segs: s, auxIds: n } = zs(), a = ka(s), c = (Y) => Y.pts.every((ee) => Math.abs(ee[2] - Y.pts[0][2]) < 1e-6), i = a.find((Y) => Y.cerrada && c(Y)), l = a.find((Y) => !Y.cerrada && Y.pts.length >= 2 && !c(Y));
    ...
    let w = 0;
    for (let Y = 0; Y < f; Y++) {
      const ee = r[Y], pe = r[(Y + 1) % f];
      w += ee[0] * pe[1] - pe[0] * ee[1];
    }
    const p = w > 0 ? 1 : -1, h = (Y) => {
      const ee = r[(Y - 1 + f) % f], pe = r[Y], be = r[(Y + 1) % f], Qe = [pe[0] - ee[0], pe[1] - ee[1]], qe = [be[0] - pe[0], be[1] - pe[1]], je = Math.hypot(Qe[0], Qe[1]) || 1, Ee = Math.hypot(qe[0], qe[1]) || 1, He = [p * Qe[1] / je, -p * Qe[0] / je], De = [p * qe[1] / Ee, -p * qe[0] / Ee], ze = 1 + (He[0] * De[0] + He[1] * De[1]);
      return [(He[0] + De[0]) / Math.max(ze, 1e-6), (He[1] + De[1]) / Math.max(ze, 1e-6)];
    }, M = r.map((Y, ee) => h(ee)), _ = d[0];
    let m = [0, 0], u = 0;
    for (const Y of d) {
    ...
    const P = [...((_b = t.areas) == null ? void 0 : _b.rawVal) ?? []], $ = d.map((Y) => {
      ...
      return r.map((be, Qe) => Xo(V, [be[0] + M[Qe][0] * ee, be[1] + M[Qe][1] * ee, pe]));
    });
    let T = 0;
    ...
    const c = Math.min(e[0], o[0]), i = Math.max(e[0], o[0]), l = Math.min(e[1], o[1]), r = Math.max(e[1], o[1]), f = (e[2] + o[2]) / 2, d = i - c, w = r - l, p = Math.min(s, d / 2 - 0.01, w / 2 - 0.01);
    if (p <= 0) return;
    const h = t.points.rawVal.length, M = [], _ = [], m = (u, x) => {
      M.push([u, x, f]), _.push(h + M.length - 1);
    };
    for (let u = 0; u <= a; u++) m(c + p + (d - 2 * p) * u / a, l);
    for (let u = 1; u <= n; u++) {
      const x = -Math.PI / 2 + Math.PI / 2 * u / n;
      m(i - p + p * Math.cos(x), l + p + p * Math.sin(x));
    }
    for (let u = 1; u <= a; u++) m(i, l + p + (w - 2 * p) * u / a);
    for (let u = 1; u <= n; u++) {
      const x = 0 + Math.PI / 2 * u / n;
      m(i - p + p * Math.cos(x), r - p + p * Math.sin(x));
    }
    for (let u = 1; u <= a; u++) m(i - p - (d - 2 * p) * u / a, r);
    for (let u = 1; u <= n; u++) {
      const x = Math.PI / 2 + Math.PI / 2 * u / n;
      m(c + p + p * Math.cos(x), r - p + p * Math.sin(x));
    }
    for (let u = 1; u <= a; u++) m(c, r - p - (w - 2 * p) * u / a);
    for (let u = 1; u < n; u++) {
    ...
    let f;
    if (U && t.gridTarget) {
      const d = t.gridTarget.rawVal, w = new oo(...d.rotation), p = new E(1, 0, 0).applyEuler(w), h = new E(0, 1, 0).applyEuler(w), M = new E(...d.position), _ = new E(n, a, c), m = new E(i, l, r), u = _.clone().sub(M).dot(p), x = _.clone().sub(M).dot(h), v = m.clone().sub(M).dot(p), V = m.clone().sub(M).dot(h), k = (P, $) => M.clone().addScaledVector(p, P).addScaledVector(h, $).toArray();
    ...
    const c = e.map((m) => m.map((u) => n.get(u) ?? u)), i = /* @__PURE__ */ new Map(), l = (m, u) => {
      m !== u && ((i.get(m) ?? i.set(m, /* @__PURE__ */ new Set()).get(m)).add(u), (i.get(u) ?? i.set(u, /* @__PURE__ */ new Set()).get(u)).add(m));
    };
    for (const m of c) for (let u = 0; u + 1 < m.length; u++) l(m[u], m[u + 1]);
    const r = (m, u) => {
      var _a4;
    ...
    for (const m of w) for (const u of i.get(m)) if (!(u < m)) {
      for (const x of i.get(u)) if (x !== m) for (const v of i.get(x)) {
        if (v === m || v === u || !r(v, m) || r(m, x) || r(u, v)) continue;
        const V = [m, u, x, v].slice().sort((k, P) => k - P).join("-");
    ...
    l /= d, r /= d, f /= d;
    let w = a * f - c * r, p = c * l - n * f, h = n * r - a * l;
    const M = Math.hypot(w, p, h) || 1;
    w /= M, p /= M, h /= M;
    const _ = e[0], m = (ze) => [(ze[0] - _[0]) * l + (ze[1] - _[1]) * r + (ze[2] - _[2]) * f, (ze[0] - _[0]) * w + (ze[1] - _[1]) * p + (ze[2] - _[2]) * h], u = (ze, Xe) => [_[0] + ze * l + Xe * w, _[1] + ze * r + Xe * p, _[2] + ze * f + Xe * h], x = e.map(m);
    ...
    const Y = (ze, Xe) => {
      ...
      return Ke;
    }, ee = Math.max(1, Math.round($ / I)), pe = Math.max(1, Math.round(T / I)), be = $ / ee, Qe = T / pe, qe = /* @__PURE__ */ new Map(), je = [], Ee = t.points.rawVal.length, He = (ze, Xe) => {
  ...
  window.__hekatanFinalizePolyArea = go, window.__hekatanSetInclinedPlaneFrom3 = (e, o, s) => {
    ...
    Kt.geometry.dispose(), Kt.geometry = new kn(d, d), It.geometry.dispose(), It.geometry = new Qs(new kn(d, d)), ro(w, 1), Bt.position.copy(f), Bt.quaternion.copy(l), Bt.scale.set(1, 1, 1), Bt.visible = true;
    try {
      (_a3 = window.__hekatanRefreshStatus) == null ? void 0 : _a3.call(window);
    } catch {
    }
  ...
  jt.visible = false, g.add(jt), window.__hekatanShowAxes = (e, o, s = 12, n = 2) => {
    ...
    const a = Math.min(...o) - n, c = Math.max(...o) + n, i = Math.min(...e) - n, l = Math.max(...e) + n, r = "ABCDEFGHIJKLMNOPQRSTUVWXYZ", f = (d, w, p, h, M) => {
    ...
    e.forEach((d, w) => {
      const p = w < r.length ? r[w] : `X${w}`, h = new Ae().setFromPoints([new E(d, a, 0), new E(d, c, 0), new E(d, a, 0), new E(d, a, s)]), M = new no({ color: 6333946, dashSize: 0.3, gapSize: 0.15, transparent: true, opacity: 0.6 }), _ = new Jt(h, M);
      _.computeLineDistances(), jt.add(_), jt.add(f(p, d, a - 0.5, 0, "#60a5fa")), jt.add(f(p, d, c + 0.5, 0, "#60a5fa"));
    }), o.forEach((d, w) => {
      const p = `${w + 1}`, h = new Ae().setFromPoints([new E(i, d, 0), new E(l, d, 0), new E(i, d, 0), new E(i, d, s)]), M = new no({ color: 16478597, dashSize: 0.3, gapSize: 0.15, transparent: true, opacity: 0.6 }), _ = new Jt(h, M);
  ...
  window.__hekatanShowRefPlanes = (e = [0, 3, 6, 9, 12], o = 20, s = 0, n = 0) => {
    ...
    e.forEach((c, i) => {
      const l = a[i % a.length], r = o / 2, f = [new E(s - r, n - r, c), new E(s + r, n - r, c), new E(s + r, n + r, c), new E(s - r, n + r, c), new E(s - r, n - r, c)], d = new Ae().setFromPoints(f), w = new dt({ color: l, transparent: true, opacity: 0.55 });
      xn.add(new Ft(d, w));
      ...
      m.position.set(s - r - 1.5, n - r - 1.5, c), m.scale.set(2.5, 0.6, 1), xn.add(m);
  ...
  window.__hekatanUpdateSelectionPtScale = Es, S.addEventListener("change", () => {
    ...
    if ((!s.length || ((_c = (_b = (_a3 = window.__hekatanCadState) == null ? void 0 : _a3.get) == null ? void 0 : _b.call(_a3)) == null ? void 0 : _c.tool) !== "fillarea") && rt.visible && (rt.visible = false), s.length) {
      ...
      else if (ce && !a) c = true, _o(ce.tipo, n.x, n.y, n.z), So(ce.tipo, e.clientX, e.clientY), mt.position.copy(n), mt.visible = true;
      else {
        Ea(), ko();
      ...
      On(), G(Z && !l && (c || ce) ? H(Z) : null), Lt = { p: n.clone(), x: e.clientX, y: e.clientY };
  ...
  const Ko = (e, o, s, n, a) => {
    ...
    var _a3, _b, _c, _d;
    const c = Math.min(e, s), i = Math.max(e, s), l = Math.min(o, n), r = Math.max(o, n), f = s < e, d = F.getBoundingClientRect(), w = b();
    w.updateMatrixWorld();
    const p = (P) => {
  ...
  const zt = (e, o, s, n) => {
    ...
    const e = [...Ue], o = e.filter((w) => w.startsWith("pt:")), s = e.filter((w) => w.startsWith("seg:")), n = e.filter((w) => w.startsWith("poly:")), a = e.filter((w) => w.startsWith("aux:")), c = o.length > 0, i = s.length > 0, l = n.length > 0, r = !c && !i && !l, f = [];
    ...
    ut = new fa({ container: qt, title: d });
    {
      ...
      w.addBinding(wt, "dx", { label: "\u0394x (m)", step: 0.1 }), w.addBinding(wt, "dy", { label: "\u0394y (m)", step: 0.1 }), w.addBinding(wt, "dz", { label: "\u0394z (m)", step: 0.1 }), w.addBinding(wt, "copias", { label: "Copias", min: 1, max: 50, step: 1 }), w.addButton({ title: "\u29C9 Replicar selecci\xF3n" }).on("click", () => {
        var _a3;
        const _ = (_a3 = window.__hekatanReplicateSelection) == null ? void 0 : _a3.call(window, wt.dx, wt.dy, wt.dz, wt.copias);
        ie(_ ? `\u29C9 Replicado \xD7${_} (\u0394 ${wt.dx},${wt.dy},${wt.dz} m)` : "\u26A0 Nada que replicar \u2014 seleccion\xE1 nodos/frames/\xE1reas");
      }), w.addButton({ title: "\u21D7 Extruir: nudo \u2192 l\xEDnea, l\xEDnea \u2192 \xE1rea" }).on("click", () => {
        var _a3;
        const _ = (_a3 = window.__hekatanExtrudeSelection) == null ? void 0 : _a3.call(window, wt.dx, wt.dy, wt.dz, wt.copias);
        ie(_ && (_.lineas || _.areas) ? `\u21D7 Extruido: ${_.lineas} barra(s), ${_.areas} pa\xF1o(s) (\u0394 ${wt.dx},${wt.dy},${wt.dz} m \xD7 ${wt.copias})` : "\u26A0 Nada que extruir \u2014 design\xE1 nudos (\u2192 l\xEDneas) o barras (\u2192 \xE1reas)");
      });
      ...
      h.addBinding(p, "vuelo", { label: "vuelo (m)", min: 0.1, max: 6, step: 0.05 }), h.addBinding(p, "losa", { label: "con pa\xF1o de losa (si no, hueca)" }), h.addBinding(p, "borde", { label: "con viga de borde" }), h.addBinding(p, "ambos", { label: "a los dos lados" }), h.addButton({ title: "\u2310 Poner volado (VOL)" }).on("click", () => {
        ...
        var _a3;
        const _ = (_a3 = window.__hekatanReplicateSelection) == null ? void 0 : _a3.call(window, wt.dx, wt.dy, wt.dz, 1);
        ie(_ ? `\u2192 Copia desplazada \u0394 ${wt.dx},${wt.dy},${wt.dz} m` : "\u26A0 Nada seleccionado");
      });
  ...
  const Va = (e, o, s, n, a) => {
    ...
    if (c.int) {
      ...
      for (let x = 0; x < u.length; x++) for (let v = x + 1; v < u.length; v++) {
        const [V, k] = u[x], [P, $] = u[v], T = [k[0] - V[0], k[1] - V[1], k[2] - V[2]], I = [$[0] - P[0], $[1] - P[1], $[2] - P[2]], Y = [V[0] - P[0], V[1] - P[1], V[2] - P[2]], ee = T[0] * T[0] + T[1] * T[1] + T[2] * T[2], pe = T[0] * I[0] + T[1] * I[1] + T[2] * I[2], be = I[0] * I[0] + I[1] * I[1] + I[2] * I[2], Qe = T[0] * Y[0] + T[1] * Y[1] + T[2] * Y[2], qe = I[0] * Y[0] + I[1] * Y[1] + I[2] * Y[2], je = ee * be - pe * pe;
        if (je < 1e-12) continue;
        const Ee = (pe * qe - be * Qe) / je, He = (ee * qe - pe * Qe) / je;
    ...
    if (c.int || c.node) for (let u = 0; u < M.length; u++) for (let x = u + 1; x < M.length; x++) {
      ...
      const pe = v[0] - k[0], be = v[1] - k[1], Qe = (I * be - Y * pe) / ee, qe = ($ * be - T * pe) / ee;
      ...
      w("int", v[0] + Qe * $, v[1] + Qe * T, typeof je == "number" ? je : s);
    }
  ...
  const Oo = () => {
    Ze = [], Rt = null, Jo(), kt = null, vs(), Ye.visible = false, Xt.visible = false, yt(), ie("\u23F9 Dibujo finalizado \u2014 click para empezar otra serie"), C(), Gt();
  };
  ...
  const Ra = () => {
    ...
    const i = [o[0] - e[0], o[1] - e[1], o[2] - e[2]], l = [n[0] - s[0], n[1] - s[1], n[2] - s[2]], r = [e[0] - s[0], e[1] - s[1], e[2] - s[2]], f = i[0] * i[0] + i[1] * i[1] + i[2] * i[2], d = i[0] * l[0] + i[1] * l[1] + i[2] * l[2], w = l[0] * l[0] + l[1] * l[1] + l[2] * l[2], p = i[0] * r[0] + i[1] * r[1] + i[2] * r[2], h = l[0] * r[0] + l[1] * r[1] + l[2] * r[2], M = f * w - d * d;
    if (M < 1e-12) return null;
    const _ = (d * h - w * p) / M, m = (f * h - d * p) / M;
    if (!a && (_ < -1e-6 || _ > 1 + 1e-6) || !c && (m < -1e-6 || m > 1 + 1e-6)) return null;
    const u = [e[0] + _ * i[0], e[1] + _ * i[1], e[2] + _ * i[2]], x = [s[0] + m * l[0], s[1] + m * l[1], s[2] + m * l[2]];
    ...
    if (e === "offset") {
      ...
      for (let Ee = 0; Ee < m.length - 1; Ee++) {
        const He = n[m[Ee]], De = n[m[Ee + 1]], ze = [De[0] - He[0], De[1] - He[1], De[2] - He[2]], Xe = Math.hypot(ze[0], ze[1], ze[2]) || 1, Ke = ze[0] / Xe, ft = ze[1] / Xe, gt = ze[2] / Xe, At = [x[1] * gt - x[2] * ft, x[2] * Ke - x[0] * gt, x[0] * ft - x[1] * Ke], tn = Math.hypot(At[0], At[1], At[2]) || 1;
    ...
    const l = s[Rt.poly], r = n[l[Rt.seg]], f = n[l[Rt.seg + 1]], d = s[c], w = d[i], p = d[i + 1];
    if (!r || !f || w == null || p == null) {
  ...
  window.__hekatanSelectionSize = () => Ue.size, window.__hekatanSelectLast = () => {
    ...
    const c = [...Ue], i = t.points.rawVal, l = ((_a3 = t.polylines) == null ? void 0 : _a3.rawVal) ?? [], r = new Set(((_b = t.areas) == null ? void 0 : _b.rawVal) ?? []), f = /* @__PURE__ */ new Set(), d = /* @__PURE__ */ new Set(), w = [];
    if (c.forEach((m) => {
      if (m.startsWith("pt:")) {
        const u = +m.slice(3);
        i[u] && f.add(u);
        ...
        const u = m.split(":"), x = +u[1], v = +u[2], V = l[x] || [], k = V[v], P = V[v + 1];
    ...
    if ([...Ue].forEach((_) => {
      if (_.startsWith("seg:")) {
        const m = _.split(":"), u = +m[1], x = +m[2], v = l[u] || [], V = v[x], k = v[x + 1];
        V != null && k != null && r.push([V, k]);
      } else if (_.startsWith("poly:")) {
        const m = l[+_.slice(5)] || [];
        for (let u = 0; u + 1 < m.length; u++) r.push([m[u], m[u + 1]]);
      }
    }), !r.length) return 0;
    let f = 0, d = 0;
    ...
    for (const [_, m] of r) {
      ...
      for (const ee of Y) {
        const pe = P * s * ee, be = $ * s * ee, Qe = w.length;
        w.push([u[0] + pe, u[1] + be, u[2]]);
        const qe = w.length;
        w.push([x[0] + pe, x[1] + be, x[2]]), p.push([_, Qe]), p.push([m, qe]), a && p.push([Qe, qe]), n && (h.push(p.length), p.push([_, m, qe, Qe, _])), M++;
      }
    }
    if (!M) return 0;
    p.push([]), t.points.val = w, t.polylines && (t.polylines.val = p), t.areas && (t.areas.val = h);
    ...
    (e.ctrlKey || e.metaKey) && (a = new E(Math.round(n[0].point.x), Math.round(n[0].point.y), Math.round(n[0].point.z)));
    {
      ...
      if (i.length > 0) {
        ...
        if (r) {
          ...
          let d = kt;
          if (!d && f) {
            const w = Math.abs(a.x - r[0]), p = Math.abs(a.y - r[1]), h = Math.abs(a.z - r[2]);
            d = w >= p && w >= h ? "x" : p >= h ? "y" : "z";
          }
  ...
  const Zs = (e, o) => {
    ...
    if (s === "select" || s === "none" || !s) {
      if (pn) {
        ...
        Wt ? (Vs(Wt.x, Wt.y, l, r, i), Wt = null) : i || (Wt = { x: l, y: r }, ie("\u{1F5B1} Click 2 para cerrar el rect\xE1ngulo (\u2192 derecha=Window azul, \u2190izquierda=Crossing verde). Esc=cancelar."), Ko(l, r, l + 1, r + 1, false));
      }
      return;
    }
    if (s === "axis") {
      ...
      ie(`\u2713 Eje "${r}" creado. Click 1=nuevo eje, o cambia tool.`);
      return;
    }
    if (s === "move" || s === "copy") {
      Us(s, [e.x, e.y, e.z]);
    ...
    if (s === "delete") {
      if (Mn >= 0) {
        ...
        if (r >= 0 && r < l.length) {
          ...
          i && typeof i == "object" && "val" in i ? i.val = f : window.__hekatanDrawingAuxLines = f, ie(`\u{1F5D1} L\xEDnea auxiliar #${r + 1} borrada`), Mn = -1, Zt.visible = false;
          try {
            (_e2 = window.__hekatanRebuild) == null ? void 0 : _e2.call(window);
          } catch {
          }
        ...
        const i = ln, l = vn;
        ((_g = (_f = t.areas) == null ? void 0 : _f.rawVal) == null ? void 0 : _g.includes(i)) ?? false ? (mo(i), ie(`\u{1F5D1} \xC1rea #${i + 1} (shell Q4) borrada`)) : l >= 0 ? (ks(i, l), ie(`\u{1F5D1} Segmento ${l + 1} de polil\xEDnea #${i + 1} borrado`)) : (mo(i), ie(`\u{1F5D1} Polil\xEDnea #${i + 1} borrada`));
    ...
    if (s === "circle") {
      ...
      const [i, l] = Ze, r = Math.hypot(l[0] - i[0], l[1] - i[1], l[2] - i[2]), f = Math.abs(l[0] - i[0]), d = Math.abs(l[1] - i[1]), w = Math.abs(l[2] - i[2]), p = String(((_j = (_i2 = (_h = window.__hekatanCadState) == null ? void 0 : _h.get) == null ? void 0 : _i2.call(_h)) == null ? void 0 : _j.workPlane) ?? ""), M = (p === "xy" ? w < 1e-3 : p === "xz" ? d < 1e-3 : p === "yz" ? f < 1e-3 : false) ? p : w < 1e-3 ? "xy" : d < 1e-3 ? "xz" : "yz", _ = window.__hekatanArcSegs ?? 12;
      (_k = window.__hekatanDrawCircle) == null ? void 0 : _k.call(window, i[0], i[1], i[2], r, _, M), ie(`\u2713 C\xEDrculo dibujado en ${M.toUpperCase()} \u2014 r=${r.toFixed(2)}m, ${_} segmentos`), Ze = [];
      try {
    ...
    if (s === "ifcface") {
      ...
      const i = q(Q.m), l = Me(i, Q.tris);
      if (l.length < 3) {
        ie("\u25A6 No se pudo cerrar el contorno de la cara.");
        return;
      }
      const r = Q.normal.clone(), f = W(Q.m, Q.punto, r);
      ...
      ie(`\u25A6 \xC1rea desde la cara del IFC: ${l.length} v\xE9rtices, ${_} shell(s). Espesor medido ${f ? f.toFixed(2) + " m" : "no medido (0.20 m supuesto)"}; malla en ${x}; formulaci\xF3n ${u}, t = ${p.toFixed(2)} m.`), ye(null, -1, null);
      try {
    ...
    if (s === "ifcline") {
      ...
      for (const w of i) {
        let p = l.findIndex((h) => Math.abs(h[0] - w[0]) < 1e-3 && Math.abs(h[1] - w[1]) < 1e-3 && Math.abs(h[2] - w[2]) < 1e-3);
        p < 0 && (p = l.length + f.length, f.push(w)), r.push(p);
      }
    ...
    if (s === "arc") {
      ...
      (_r = window.__hekatanDrawArc) == null ? void 0 : _r.call(window, i, l, r, f), ie(`\u2713 Arco dibujado \u2014 ${f} segmentos`), Ze = [];
      try {
    ...
    if (s === "parabola" || s === "cubica") {
      ...
      if (Ze.push([e.x, e.y, e.z]), Ze.length < i) {
        ie(`\u223F ${l} \u2014 punto ${Ze.length}/${i} OK. Marc\xE1 el ${Ze.length + 1}\xBA.`);
        return;
      }
      ...
      if (!(f == null ? void 0 : f.ok)) {
        ie(`\u26A0 ${l}: ${(f == null ? void 0 : f.msg) ?? "no se pudo"}. Volv\xE9 a marcar los puntos.`), Ze = [];
        return;
      }
      const d = "xyz"[f.ia ?? 0], w = "xyz"[f.io ?? 2], p = (f.coef ?? []).map((h, M) => `${h >= 0 && M ? "+" : ""}${h.toFixed(3)}${M ? "\xB7" + d + (M > 1 ? "^" + M : "") : ""}`).join(" ");
      ie(`\u2713 ${l} dibujada en ${String(f.plano ?? "").toUpperCase()} \u2014 ${r} tramos a \u0394 igual de ${d} \xB7 ${w} = ${p}`), Ze = [];
      try {
    ...
    if (s === "revolve") {
      ...
      if (l == null ? void 0 : l.msg) {
        ie(`\u26A0 Revoluci\xF3n: ${l.msg}.`);
        return;
      }
      ie(`\u2713 Revoluci\xF3n: ${l.anillos} anillo(s) \xD7 ${i} sectores \u2192 ${l.areas} pa\xF1o(s) Q4${l.polo ? " (casquete cerrado con cometas en el polo)" : ""}. Eje Z por (${e.x.toFixed(2)}, ${e.y.toFixed(2)}).${l.guias ? ` ${l.guias} l\xEDnea(s) auxiliar(es) de gu\xEDa borrada(s).` : ""}`);
      try {
    ...
    if (s === "rect") {
      ...
      const [i, l] = Ze;
      (_z = window.__hekatanDrawRect) == null ? void 0 : _z.call(window, i, l), ie(`\u2713 Rect\xE1ngulo dibujado \u2014 (${i[0].toFixed(1)},${i[1].toFixed(1)}) \u2192 (${l[0].toFixed(1)},${l[1].toFixed(1)})`), Ze = [];
      try {
    ...
    if (s === "medir") {
      ...
      if (!l) return;
      if (xt.length >= 2 && (xt = []), xt.push(l), xt.length === 1) it.visible = false, Ct(), ie("\u{1F4CF} Regla \u2014 1er punto puesto. Marca el 2\xBA.");
      else {
        const [r, f] = xt;
        it.geometry.setFromPoints([new E(r[0], r[1], r[2]), new E(f[0], f[1], f[2])]), it.visible = true;
        const d = Math.hypot(f[0] - r[0], f[1] - r[1], f[2] - r[2]), w = Math.hypot(f[0] - r[0], f[1] - r[1]);
        Je.textContent = `${d.toFixed(3)} m`, Ct(), ie(`\u{1F4CF} Distancia ${d.toFixed(3)} m  \xB7  \u0394x ${(f[0] - r[0]).toFixed(3)}  \u0394y ${(f[1] - r[1]).toFixed(3)}  \u0394z ${(f[2] - r[2]).toFixed(3)}  \xB7  en planta ${w.toFixed(3)} m`);
      }
      C();
      return;
    }
    if (s === "fillarea") {
      ...
      }, w = /* @__PURE__ */ new Set(), p = [], h = [...r.keys()];
      for (const T of h) for (const I of r.get(T)) if (!(I < T)) {
        for (const Y of r.get(I)) if (Y !== T) for (const ee of r.get(Y)) {
          if (ee === T || ee === I || !d(ee, T) || d(T, Y) || d(I, ee)) continue;
          const pe = [T, I, Y, ee].slice().sort((be, Qe) => be - Qe).join("-");
      ...
      const M = ((_E = (_D = (_C = window.__hekatanCadState) == null ? void 0 : _C.get) == null ? void 0 : _D.call(_C)) == null ? void 0 : _E.workPlane) ?? "xy", _ = (T) => M === "xy" ? [T[0], T[1]] : M === "xz" ? [T[0], T[2]] : [T[1], T[2]], m = _([e.x, e.y, e.z]), u = (T, I) => {
        ...
        for (let ee = 0, pe = I.length - 1; ee < I.length; pe = ee++) {
          const be = I[ee][0], Qe = I[ee][1], qe = I[pe][0], je = I[pe][1];
      ...
      t.polylines.val = [...l, [...v, v[0]]], t.areas.val = [...P, l.length], ie(`\u2713 \xC1rea creada por relleno (${v.length} lados).`);
      try {
    ...
    if (s === "rectarea") {
      ...
      const [i, l] = Ze;
      (_H = window.__hekatanDrawRectArea) == null ? void 0 : _H.call(window, i, l), ie(`\u2713 \xC1rea rectangular (shell Q4) creada \u2014 (${i[0].toFixed(1)},${i[1].toFixed(1)}) \u2192 (${l[0].toFixed(1)},${l[1].toFixed(1)})`), Ze = [];
      return;
    }
    if (s === "polyarea") {
    ...
    if (s === "col") {
      ...
      t.polylines.val = [...r.slice(0, -1), ...r[r.length - 1].length > 0 ? [r[r.length - 1]] : [], [f - 2, f - 1], []], St = 0, ie(`\u258C Columna creada \u2014 h=${l.toFixed(2)}m. Tipe\xE1 altura + Enter para custom.`);
      try {
    ...
    if (s === "wall") {
      ...
      ie(`\u25A5 Pared Q4 creada \u2014 h=${r.toFixed(2)}m. Tipe\xE1 altura + Enter para custom.`), Ze = [], St = 0;
      try {
    ...
    if (s === "extp") {
      ...
      const r = t.polylines.rawVal, f = t.points.rawVal.length;
      t.polylines.val = [...r.slice(0, -1), ...r[r.length - 1].length > 0 ? [r[r.length - 1]] : [], [f - 2, f - 1], []], St = 0, ie(`\u2B06 Extrusi\xF3n punto\u2192l\xEDnea \u2014 h=${i.toFixed(2)}m`);
      try {
        (_L = window.__hekatanRebuild) == null ? void 0 : _L.call(window);
      } catch {
      }
    ...
    if (s === "extl") {
      ...
      const r = t.polylines.rawVal, f = t.points.rawVal, d = r[l.polyIdx], w = f[d[l.segIdx]], p = f[d[l.segIdx + 1]];
      if (!w || !p) {
    ...
    if (s === "aux") {
      ...
      const f = l[0] - i[0], d = l[1] - i[1], w = l[2] - i[2], p = Math.sqrt(f * f + d * d + w * w);
    ...
    if (s === "chaflan") {
      ...
      ie(`\u2713 Losa con chaflanes dibujada \u2014 ${d}\xD7${w}m, r=${r}m, ${f} seg/chafl\xE1n`), Ze = [];
      try {
    ...
    if (t.polylines) {
      ...
      if (s === "line" && r.length >= 2) {
        ie(`\uFF0F L\xEDnea \u2014 ${r.length - 1} tramo${r.length === 2 ? "" : "s"}. Segu\xED marcando puntos; Esc o clic derecho para terminar.`);
        try {
          (_P = window.__hekatanRebuild) == null ? void 0 : _P.call(window);
        } catch {
        }
      ...
      if (s === "area" && r.length === 4) {
        t.polylines.val = [...i.slice(0, -1), [...r, r[0]], []], t.areas && (t.areas.val = [...t.areas.rawVal, l]), ie("\u25A6 \xC1rea (shell Q4) creada \u2014 4 v\xE9rtices marcados.");
        try {
          (_Q = window.__hekatanRebuild) == null ? void 0 : _Q.call(window);
        } catch {
        }
  ...
  F.addEventListener("click", () => Gt()), F.addEventListener("contextmenu", (e) => {
    ...
    if (n.length && a.length) {
      ...
      r.transformDirection(te.matrixWorld), Math.abs(l.dot(r)) < 1e-4 && (s = true);
    }
    Be.visible = !s;
  });
  let es = false, ts;
  F.addEventListener("pointermove", (e) => {
    ...
    if (n.length && a.length) {
      ...
      f.transformDirection(te.matrixWorld), Math.abs(r.dot(f)) < 1e-4 && (s = true);
    }
...
function Ki(t) {
  ...
  const N = new Ae(), B = new pt({ color: Zi, transparent: true, opacity: 0.45, side: Et, depthTest: false }), te = new lt(N, B);
...
Mz \u2248 ${Pt(Ut * Ne)} ${Ge.forceUnit}\xB7m`);
  ...
  function K(xe, D, ne) {
    ...
    if (xe.type === "node") {
      ...
      const ge = j[xe.idx], Le = G(ge[0]), Be = G(ge[1]);
      if (Le && Be) {
      ...
      const ge = j[xe.idx], Le = [], Be = [];
      for (const tt of ge) {
        const Pe = G(tt);
        if (!Pe) return;
        Le.push(Pe.x, Pe.y, Pe.z);
      }
      ge.length === 4 ? Be.push(0, 1, 2, 0, 2, 3) : ge.length === 3 && Be.push(0, 1, 2), N.setAttribute("position", new Vt(Le, 3)), N.setIndex(Be), N.computeVertexNormals(), te.visible = true;
    } else if (xe.type === "solid" && j) {
      const ge = j[xe.idx], Le = [[0, 1], [1, 2], [2, 3], [3, 0], [4, 5], [5, 6], [6, 7], [7, 4], [0, 4], [1, 5], [2, 6], [3, 7]], Be = [];
      for (const [tt, Pe] of Le) {
        const Te = G(ge[tt]), at = G(ge[Pe]);
        Te && at && Be.push(Te.x, Te.y, Te.z, at.x, at.y, at.z);
      }
      fe.setAttribute("position", new Vt(Be, 3)), O.visible = true;
    }
  ...
  function We(xe, D) {
    ...
    if (xe.type === "node") {
      ...
      if (!ae || !Ce) return;
      const Se = ae.clone().add(Ce).multiplyScalar(0.5), ge = Ce.clone().sub(ae), Le = ge.length(), Be = Math.max(1e-4, 4 * ve(Se)), tt = new lt(Z, ce);
      tt.position.copy(Se);
      ...
      for (const [Le, Be] of ae) {
        const tt = G(j[Le]), Pe = G(j[Be]);
...
function Oi(t, y) {
  ...
  function C() {
    ...
    for (const ke of W) for (const Ne of [ke.a, ke.b]) _e = Math.min(_e, Ne.u), de = Math.max(de, Ne.u), Fe = Math.min(Fe, Ne.v), me = Math.max(me, Ne.v);
    const Ve = de - _e || 1, ve = me - Fe || 1, We = 0.12 * Math.max(Ve, ve), Oe = 46, vt = Math.min((ye - 2 * Oe) / (Ve + 2 * We), (Me - 2 * Oe) / (ve + 2 * We)), Mt = (ye - Ve * vt) / 2, xe = (Me - ve * vt) / 2, D = (ke) => Mt + (ke - _e) * vt, ne = (ke) => Me - (xe + (ke - Fe) * vt), j = "http://www.w3.org/2000/svg", ae = (ke, Ne, yt) => {
      const ot = document.createElementNS(j, ke);
      for (const _t in Ne) ot.setAttribute(_t, String(Ne[_t]));
      return yt != null && (ot.textContent = yt), le.appendChild(ot), ot;
    }, Ce = /* @__PURE__ */ new Map();
    for (const ke of W) {
      const Ne = ((_h = (_g = (_f = (_e2 = t.elementInputs) == null ? void 0 : _e2.rawVal) == null ? void 0 : _f.localAngles) == null ? void 0 : _g.get) == null ? void 0 : _h.call(_g, ke.i)) ?? 0, yt = so(xa(q ?? "normals", ya(R[Q[ke.i][0]], R[Q[ke.i][1]], Ne)), b.plano), ot = Math.hypot(yt.u, yt.v);
    ...
    for (const ke of W) {
      const Ne = D(ke.a.u), yt = ne(ke.a.v), ot = D(ke.b.u), _t = ne(ke.b.v), Dt = Ce.get(ke.i), [nt, Ie] = Dt ?? [0, 0], Re = he && Dt ? he instanceof Map ? he.get(ke.i) : he[ke.i] : null, [Ye, $e] = Re ? hs(q, Re) : [0, 0];
      if (Re && Be > 0) {
        const Je = [Ne + nt * Ye * Be * 1, yt + Ie * Ye * Be * 1], st = [ot + nt * $e * Be * 1, _t + Ie * $e * Be * 1], on = Ye + $e >= 0 ? "#3fa7d6" : "#d9534f";
        ae("polygon", { points: `${Ne},${yt} ${Je[0]},${Je[1]} ${st[0]},${st[1]} ${ot},${_t}`, fill: on, "fill-opacity": 0.38, stroke: on, "stroke-width": 1.2 }), Te.push({ x: Je[0] + nt * 12, y: Je[1] + Ie * 12, t: Pe(Ye), peso: Math.abs(Ye) }), Te.push({ x: st[0] + nt * 12, y: st[1] + Ie * 12, t: Pe($e), peso: Math.abs($e) });
      }
      ae("line", { x1: Ne, y1: yt, x2: ot, y2: _t, stroke: "#e6ecf5", "stroke-width": 2.2, "stroke-linecap": "round" }), Z.has(ke.i) && ae("line", { x1: Ne, y1: yt, x2: ot, y2: _t, stroke: "#e6c463", "stroke-width": 5, "stroke-linecap": "round" });
      const et = ae("line", { x1: Ne, y1: yt, x2: ot, y2: _t, stroke: "transparent", "stroke-width": 14, style: "cursor:pointer;pointer-events:stroke" });
      et.addEventListener("click", () => O(ke.i));
      const it = document.createElementNS(j, "title");
      it.textContent = "Clic: gr\xE1fico de esta barra (axil, cortante, momento)", et.appendChild(it);
    }
    for (const ke of W) for (const Ne of [ke.a, ke.b]) b.plano !== "XY" && Math.abs(Ne.v - Fe) < Sn && ae("rect", { x: D(Ne.u) - 6, y: ne(Ne.v), width: 12, height: 7, fill: "#b03a3a" });
    const at = [];
    Te.sort((ke, Ne) => Ne.peso - ke.peso);
    for (const ke of Te) ke.peso < 0.02 * ge || at.some((Ne) => Math.hypot(Ne.x - ke.x, Ne.y - ke.y) < 34) || (at.push(ke), ae("text", { x: ke.x, y: ke.y + 4, "text-anchor": "middle", fill: "#f2f5fa", "font-size": 12, "font-weight": 600, "paint-order": "stroke", stroke: "#0b0e14", "stroke-width": 3 }, ke.t));
    const Ge = q ? Hi[q] ?? q : "sin resultado";
    se.textContent = `${Ge} \xB7 ${b.plano === "XY" ? "planta" : "alzado"} ${b.plano} en ${X} = ${b.en.toFixed(2)} m`, oe.textContent = q ? `${W.length} barras en el plano \xB7 m\xE1ximo ${Pe(ge)} ${Ji[q] ?? ""}` + (tt ? " \xB7 el momento va del lado de la tracci\xF3n" : "") + (Se ? ` \xB7 ${Se} barra(s) con este resultado en otro plano (sin dibujar)` : "") + " \xB7 clic en una barra: su gr\xE1fico" : "Eleg\xED un resultado en \xABFrame results\xBB (Axial, Cortante, Momento) para ver su diagrama aqu\xED.";
  }
  const L = () => {
    try {
      C();
...
function ul({ mesh: t, settingsObj: y, drawingObj: g, objects3D: b, solids: S }) {
  ...
  if (t) {
    ...
    ge.id = "frame-legend", z.appendChild(ge), re.derive(() => {
      var _a;
      const Le = U.shellResults.val != "none", Be = (((_a = U.solidResults) == null ? void 0 : _a.val) ?? "none") !== "none", tt = Le || Be, Pe = U.frameResults.val.startsWith("contour:"), Te = ne.val.some((at) => Number.isFinite(at));
...
function il(t, y) {
  ...
  return ((S) => {
    ...
    const O = /* @__PURE__ */ new Map(), U = /* @__PURE__ */ new Map(), ce = /* @__PURE__ */ new Map(), Z = /* @__PURE__ */ new Map(), le = /* @__PURE__ */ new Map(), se = (D, ne, j, ae, Ce) => {
      D.forEach((Se, ge) => {
        var _a2, _b2;
        const Le = Se[0] ?? 0, Be = ((_a2 = ne.get(ge)) == null ? void 0 : _a2[0]) ?? 0, tt = ((_b2 = j.get(ge)) == null ? void 0 : _b2[0]) ?? 0, Pe = (Le + Be) / 2, Te = Math.hypot((Le - Be) / 2, tt);
