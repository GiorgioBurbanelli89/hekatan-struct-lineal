import { N as Ut, a6 as Rn, q as bs, v as q, a7 as _s, D as Pt, M as Oe, B as be, F as bt, a8 as Ss, x as pt, a9 as ks, aa as Ps, h as Lo, ab as Ro, r as an, ac as Xn, ad as Nn, a4 as Jo, _ as tt, a as ut, L as qt, w as Oo, b as Cs, ae as zs, f as st, V as S, $ as sn, af as ao, H as mo, d as zt, c as io, Y as Qo, Z as Un, G as Fs, z as kn, A as As, ag as Yn, t as Es, o as Ts, I as Qt, a2 as _n, E as Io, S as hn, m as lo, ah as Sn, g as Do, i as Bo, j as Xo, C as No, K as Vs, U as $s, W as Ls, X as Rs, T as In, P as ro, O as Is } from "./theme-U-6D_qyI.js";
...
function Os(e, l, u, h) {
  ...
  return w.setAttribute("color", new bt([...v, ...v, ...Z, ...Z, ...ye, ...ye], 3)), q.derive(() => {
    ...
    l.deformedShape.val, l.orientations.val && (d.clear(), (_a2 = e.elements) == null ? void 0 : _a2.val.forEach((le) => {
      ...
      if (le.length === 2 && (te.position.set(...fo(z, ne)), te.rotation.setFromRotationMatrix(qn(z, ne))), le.length === 3) {
...
function sa(e, l, u, h) {
  const d = new tt(), w = { normals: Dn, shearsY: Dn, shearsZ: Dn, torsions: Dn, bendingsY: qo, bendingsZ: qo };
  return q.derive(() => {
    var _a2, _b;
...
function ra({ drawingObj: e, gridObj: l, scene: u, getActiveCamera: h, controls: d, gridSize: w, derivedDisplayScale: p, rendererElm: x, viewerRender: g }) {
  ...
  }, W = new Xn(new be(), new Nn()), ve = new Xn(new be(), new Nn({ color: "gray", sizeAttenuation: false, size: 6 })), ge = new Xn(new be(), new Nn({ color: "orange", sizeAttenuation: false, size: 7 }));
  u.add(ge);
  ...
  const vt = new tt(), is = new Oe(new hn(0.01, 12, 12), new st({ color: 16724804, transparent: true, opacity: 0.95 })), ls = new Oe(new hn(0.015, 12, 12), new st({ color: 16498468, transparent: true, opacity: 0.2, depthWrite: false }));
  vt.add(is, ls);
  ...
  const rs = 5, go = (n) => {
    ...
    const n = rs * go(vt.position) / 0.015;
    vt.scale.setScalar(Math.max(0.02, Math.min(60, n)));
  };
  window.__hekatanUpdateSnapScale = An, window.__hekatanSnapMarker = vt, window.__hekatanMetrosPorPixel = go;
  const vo = () => {
  ...
  window.__hekatanUpdateSelectionPtScale = vo, d.addEventListener("change", () => {
    ...
    vt.position.set(n, o, a), vt.visible = true, An(), g();
    ...
    if (a.length) {
      ...
      if (i) So(i.type, i.x, i.y, i.z), vt.position.set(i.x, i.y, i.z), vt.visible = true, t.set(i.x, i.y, i.z);
      else {
        Vn();
  ...
  window.__hekatanOsnapCompute = us, window.__hekatanOsnapShow = So, window.__hekatanOsnapHide = Vn;
  ...
  const un = [], $n = [], Qn = () => {
    ...
    un.push(Qn()), un.length > 100 && un.shift(), $n.length = 0;
  }, Ln = () => {
    const n = un.pop();
    if (!n) {
    ...
    $n.push(Qn()), ko(n), ee(`\u21B6 Deshacer \u2014 quedan ${un.length}`);
  }, Po = () => {
    const n = $n.pop();
    if (!n) {
    ...
    un.push(Qn()), ko(n), ee(`\u21B7 Rehacer \u2014 quedan ${$n.length}`);
  };
  window.__hekatanPushUndo = Rt, window.__hekatanUndo = Ln, window.__hekatanRedo = Po, document.addEventListener("keydown", (n) => {
    var _a2;
    const o = n.key.toLowerCase();
...
const va = 16755200, Ko = 56831, Ma = 56831, ba = 56831, Bn = 65382;
function _a(e) {
  const l = new tt();
  ...
  const z = new st({ color: Bn, transparent: true, opacity: 0.95, depthTest: false }), ne = new st({ color: Bn, transparent: true, opacity: 0.85, depthTest: false }), W = new No(1, 1, 1, 12), ve = new st({ color: Bn, transparent: true, opacity: 0.55, side: Pt, depthTest: false }), ge = new ut({ color: Bn, linewidth: 4, transparent: true, opacity: 1, depthTest: false }), B = [];
      ...
      if (Zt === "frame" && ((_m = e.mesh) == null ? void 0 : _m.deformOutputs) && e.mesh.elementInputs) {
        ...
        if (xt && Ne.length === 2) {
          ...
          if (we && Xe && nt && gt) {
            ...
            if (lt > 1e-9) {
              const jt = Kt / lt, It = _t / lt, Jt = Et / lt, en = (Xe[0] - we[0]) * jt + (Xe[1] - we[1]) * It + (Xe[2] - we[2]) * Jt, tn = ((_n2 = He.elasticities) == null ? void 0 : _n2.get(dt)) ?? 0, Kn = ((_o = He.areas) == null ? void 0 : _o.get(dt)) ?? 0, Gn = ((_p = He.momentsOfInertiaY) == null ? void 0 : _p.get(dt)) ?? 0, ln = ((_q = He.momentsOfInertiaZ) == null ? void 0 : _q.get(dt)) ?? 0, zn = ((_r = He.torsionalConstants) == null ? void 0 : _r.get(dt)) ?? 0, rn = ((_s2 = He.shearModuli) == null ? void 0 : _s2.get(dt)) ?? tn / 2.6, mn = tn * Kn * (en / lt), Fn = (Xe[3] - we[3]) * jt + (Xe[4] - we[4]) * It + (Xe[5] - we[5]) * Jt, wn = rn * zn * (Fn / lt), yn = Xe[4] - we[4], Vt = Xe[5] - we[5], Xt = tn * Gn * yn / lt, Gt = tn * ln * Vt / lt;
              ze += `
\u2500\u2500\u2500\u2500 frame \u2500\u2500\u2500\u2500`, ze += `
L = ${yt(lt, 3)} m`, ze += `
...
function Da({ mesh: e, settingsObj: l, drawingObj: u, objects3D: h, solids: d }) {
  ...
  function he(F, K) {
    ...
    if (g.left = -pe * fe, g.right = pe * fe, g.updateProjectionMatrix(), F && j) {
      if (R ? (R.object = j, R.update()) : (R = new Yo(j, C.domElement), R.enableDamping = true, R.dampingFactor = 0.1, R.screenSpacePanning = true, R.zoomSpeed = 0.8, R.panSpeed = 1.2, R.rotateSpeed = 0.9, R.touches = { ONE: In.ROTATE, TWO: In.DOLLY_PAN }, R.target.copy(v.target), R.addEventListener("change", G), R.enabled = false), !ce) {
        const ke = (Fe) => {
          if (!se || !R) return;
