...
import { v as l, e as at, D as vt, M as y, c as S, C as ae } from "./Text-Br8EG2up.js";
import { P as se } from "./tweakpane-BXg6ZhiP.js";
import { a as oe } from "./analyze-C-HJ03ae.js";
import { d as ne, __tla as __tla_0 } from "./didacticCpp-iMwzdM-v.js";
import { g as le, f as bt, h as ht, a as ie, __tla as __tla_1 } from "./aiAgent-q2vEmLHi.js";
import { e as ce } from "./makeDraggable-zx2br6Yh.js";
import { g as me } from "./getParameters-DkcoDfMj.js";
...
Promise.all([
  ...
  l.derive(() => {
    var _a, _b;
    const a = r.L.value.val, v = r.W.value.val, d = r.t_s.value.val, B = r.s_b.value.val, p = r.bf.value.val, n = r.tf.value.val, c = r.hw.value.val, b = r.tw.value.val, I = Math.round(r.modo.value.val), lt = r.q.value.val, f = Math.round(r.nx.value.val), x = Math.round(r.ny.value.val), C = 2 * p * n + c * b, Ot = 2 * n + c, it = 2 * (p * n * Math.pow(c / 2 + n / 2, 2)) + b * Math.pow(c, 3) / 12, Ft = (p * Math.pow(n, 3) + p * Math.pow(n, 3) + c * Math.pow(b, 3)) / 3, ct = p * n + c * b, mt = (p * n * (n / 2) + c * b * (n + c / 2)) / ct, Wt = p * Math.pow(n, 3) / 12 + p * n * Math.pow(mt - n / 2, 2), Ct = b * Math.pow(c, 3) / 12 + c * b * Math.pow(n + c / 2 - mt, 2), Lt = Wt + Ct, Pt = (p * Math.pow(n, 3) + c * Math.pow(b, 3)) / 3, Rt = I === 1 ? ct : C, Dt = I === 1 ? Lt : it, Tt = I === 1 ? Pt : Ft, k = [], _ = [], L = /* @__PURE__ */ new Map(), P = /* @__PURE__ */ new Map(), R = /* @__PURE__ */ new Map(), D = /* @__PURE__ */ new Map(), T = /* @__PURE__ */ new Map(), V = /* @__PURE__ */ new Map(), q = /* @__PURE__ */ new Map(), G = /* @__PURE__ */ new Map(), J = /* @__PURE__ */ new Map();
    function Vt(t, e, s) {
      return k.push([
        t,
        e,
    ...
    function Gt(t, e, s, i, m) {
      ...
      const o = _.length - 1;
      P.set(o, xt), R.set(o, gt), D.set(o, fe), T.set(o, pe), V.set(o, s), G.set(o, i), q.set(o, i), J.set(o, m), L.set(o, 0);
    }
    const U = [
      v / 2 - B,
      v / 2,
    ...
    for (let t = 0; t <= x; t++) for (let e = 0; e <= f; e++) {
      const s = t === 0 || t === x ? Z / 2 : Z, m = (e === 0 || e === f ? Y / 2 : Y) * s, o = -lt * m, w = u[t][e];
      rt.set(w, [
        0,
        0,
        o,
    ...
    if (g === 0) {
      ...
      for (let s = 0; s < f; s++) {
        const i = Q[pt + s], m = t == null ? void 0 : t.get(i), o = e == null ? void 0 : e.get(i);
