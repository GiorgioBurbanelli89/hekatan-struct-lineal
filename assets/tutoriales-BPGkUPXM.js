const S = "https://giorgioburbanelli89.github.io/hekatan-lisp/", v = "hk_tutorial_ultimo", p = () => "./tutoriales/", a = (o) => o.replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(/"/g, "&quot;"), C = `
...
async function q() {
  ...
  let y = 0;
  const w = "./workspace/", A = (t) => w + "?heks=" + encodeURIComponent(new URL(p() + t, location.href).href);
