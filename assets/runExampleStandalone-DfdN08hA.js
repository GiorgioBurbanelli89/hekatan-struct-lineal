const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-Cc-h6Vk6.js","assets/analyze-BFwM3Jvn.js","assets/pureFunctionsAny.generated-DeJSBP3k.js","assets/didacticCpp-DaEmtxPu.js","assets/deform-ZnZ8PQ4z.js","assets/preload-helper-V2P8TQsQ.js","assets/planeQ4-DsCzHfbV.js","assets/layeredQ4-DuXBBCkf.js","assets/mitc3-2FJr2z_r.js","assets/fiberSectionCft-CvKVMF85.js","assets/menegottoPinto-9Id4uJ7l.js"])))=>i.map(i=>d[i]);
import { _ as ot } from "./preload-helper-V2P8TQsQ.js";
import { o as bt, t as wt, V as B, u as xt, B as ut, a as ht, d as _t, w as $t, v as K } from "./theme-U-6D_qyI.js";
import { P as Mt } from "./tweakpane-BXg6ZhiP.js";
import { c as Lt, d as Et, g as zt } from "./getViewer-DAJVUjb_.js";
import { g as Pt } from "./styles-SbI03m7S.js";
import { c as Tt } from "./renderModalTable-BJWFR1R0.js";
import { f as nt, d as it, e as Ft, g as It, h as St, i as st, j as Dt, s as lt, k as ct, l as dt, m as pt, n as Nt, o as Ct, p as At, q as Bt, t as Ot, r as jt } from "./units-C7eDg0Ff.js";
let Kt;
let __tla = (async () => {
  ...
  Kt = function(w) {
    const C = K.state([]), Y = K.state([]), X = K.state({}), P = K.state({}), R = K.state({}), U = K.state({}), W = K.state([]), Q = {
      nodes: C,
      elements: Y,
      nodeInputs: X,
      elementInputs: P,
      ...
      if (l == null ? void 0 : l.addFolder) {
        ...
        y.on("click", async () => {
          ...
          try {
            ...
            n("\u23F3 calculando\u2026");
            const t = new Worker(new URL("/hekatan-struct-lineal/assets/modal.worker-Bn457TtB.js", import.meta.url), {
              type: "module"
            }), i = (D) => {
              const N = {};
              ...
              if (!c) {
                ...
                try {
                  const { modalAnalysis: N } = await ot(async () => {
                    const { modalAnalysis: I } = await import("./index-Cc-h6Vk6.js").then(async (m2) => {
                      await m2.__tla;
                      return m2;
                    });
                    return {
