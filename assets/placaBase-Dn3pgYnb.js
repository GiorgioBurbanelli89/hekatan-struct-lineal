...
import { d as Me, __tla as __tla_0 } from "./didacticCpp-CzlDWovh.js";
import { s as ge, __tla as __tla_1 } from "./secantPlasticity-BIK1jocI.js";
import { c as se } from "./colorMapPercentile-OnF3uP-w.js";
import { c as ie, e as Z, M as S, L as ye, E as ve, b as Pe, C as Q, R as $e, f as ce, D as re } from "./Text-Br8EG2up.js";
let Be;
let __tla = Promise.all([
  ...
  Be = {
    ...
    build(e, c) {
      const i = [], f = [], Y = /* @__PURE__ */ new Map(), G = /* @__PURE__ */ new Map(), p = /* @__PURE__ */ new Map(), C = /* @__PURE__ */ new Map(), z = /* @__PURE__ */ new Map(), A = /* @__PURE__ */ new Map(), N = /* @__PURE__ */ new Map(), k = /* @__PURE__ */ new Map(), H = /* @__PURE__ */ new Map(), E = e.E_steel / 2.6, q = 77, x = (t, a, n) => (i.push([
        t,
        a,
        n
      ...
      for (let t = 0; t < r; t++) for (let a = 0; a < W; a++) M(B[t][a], B[t][a + 1], B[t + 1][a + 1], B[t + 1][a], e.tw_col);
      ...
      for (const [t, a] of $) {
        const n = e.d_bolt * 1, o = e.L_bolt + e.t_plate + n + 0.015, l = new Q(e.d_bolt / 2, e.d_bolt / 2, o, 16), s = new S(l, me);
        s.rotation.x = Math.PI / 2;
        const u = -e.L_bolt + o / 2;
        s.position.set(t, a, u), y.push(s);
        const h = new Q(e.d_bolt * 0.9, e.d_bolt * 0.9, n, 6), m = new S(h, ue);
