const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/calcPanel-BMHpLRh_.js","assets/getMesh-_M9lDnOs.js","assets/__vite-browser-external-D7Ct-6yo.js","assets/pureFunctionsAny.generated-DeJSBP3k.js","assets/analyze-C-HJ03ae.js","assets/didacticCpp-CzlDWovh.js","assets/deform-DmQkkByq.js","assets/preload-helper-V2P8TQsQ.js","assets/cyclicPushoverCpp-DYzXjugK.js"])))=>i.map(i=>d[i]);
import { _ as sa } from "./preload-helper-V2P8TQsQ.js";
import { H as nn, U as el, e as aa, D as la, B as Dt, q as yn, u as tl, l as ol, M as ha, v as jo, V as Me, N as ho, n as ra, m as ia, X as Bo, L as Ho, c as nl, S as sl, f as al, F as Eo, b as Do, d as ko, o as ll, Y as rl, K as il, I as un, Z as Zn, j as fn, i as mn, g as cl, h as dl, _ as pl, $ as ul } from "./Text-Br8EG2up.js";
import { P as tn } from "./tweakpane-BXg6ZhiP.js";
import { a as ca } from "./exampleVersion-D1A_5i59.js";
import { g as $n, b as wn, a as so } from "./analyze-C-HJ03ae.js";
import { d as pt, p as Qn, m as fl, s as ml, __tla as __tla_0 } from "./didacticCpp-CzlDWovh.js";
...
` + p;
  ...
  `, document.head.appendChild(qs), pl() === "light" && document.documentElement.classList.add("hk-light"), ul((t) => {
...
`);
    ...
    function qn() {
      ...
      if (!(t.length === 0 || o.length === 0) && !(!n.supports || n.supports.size === 0) && !(!l.densities || l.densities.size === 0)) try {
        ...
        if (s <= 0) return;
        const f = fl(t, o, n, l, Math.min(s, 12));
...
`);
      ...
      y && (y.value = N, y.addEventListener("change", (h) => {
        ...
        h.stopPropagation(), sa(async () => {
          const { openCalcPanel: S } = await import("./calcPanel-BMHpLRh_.js").then(async (m2) => {
            await m2.__tla;
            return m2;
          });
          return {
...
`);
    ...
    function st(t = false) {
      ...
      const f = rl(), a = new il(l, 20, f.grid, f.grid);
...
${r.join(", ")}`);
    ...
    function Hs(t) {
      ...
      if (yt && (o.scene.remove(yt), yt.geometry.dispose(), yt.material.dispose(), yt = null), t.worldPos) {
        const l = t.snapType === "node" ? 16776960 : t.snapType === "mid" ? 16711935 : t.snapType === "grid" ? 65535 : 8947848, s = t.snapType === "node" ? 0.08 : 0.06, f = t.snapType === "mid" ? new nl(s * 2, s * 2, s * 2) : new sl(s, 12, 12), a = new al({
          color: l,
          transparent: true,
          opacity: 0.8,
          depthTest: false
    ...
    function Vn(t) {
      ...
      for (let m = 0; m < a.length; m++) {
        const w = a[m];
        if (w.length === 2) {
          const M = new Me(...f[w[0]]), y = new Me(...f[w[1]]), p = new ll(M, y), b = new Me(), I = new Me();
    ...
    `, document.body.appendChild(t), (_b = t.querySelector("#pushover-close")) == null ? void 0 : _b.addEventListener("click", () => t.remove()), (_c = t.querySelector("#pushover-run")) == null ? void 0 : _c.addEventListener("click", async () => {
        ...
        try {
          const { cyclicPushover: b } = await sa(async () => {
            const { cyclicPushover: k } = await import("./cyclicPushoverCpp-DYzXjugK.js");
            return {
              cyclicPushover: k
            };
