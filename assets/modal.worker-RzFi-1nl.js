(async ()=>{
    ...
    async function Le(L = {}) {
        ...
        var Me;
        function ar() {
            return d.locateFile ? ne("deform.wasm") : new URL("/hekatan-struct-lineal/assets/deform-kau_CDPE.wasm", import.meta.url).href;
        }
        function $e(e) {
        ...
        var ce = (e)=>Lr(e), ke = (e)=>{
            ...
            var m = (g)=>{
                var S = g >= 0 ? "-" : "+", N = Math.abs(g), C = String(Math.floor(N / 60)).padStart(2, "0"), O = String(N % 60).padStart(2, "0");
                return `UTC${S}${C}${O}`;
            }, v = m(c), _ = m(l);
...
`));
            ...
            createLazyFile (e, r, t, n, o) {
                class a {
                    ...
                    cacheLength() {
                        ...
                        }), (C || !g) && (O = g = 1, g = this.getter(0).length, O = g, ue("LazyFiles on gzip forces download of the whole file when length is accessed")), this._length = g, this._chunkSize = O, this.lengthKnown = !0;
                    }
                    get length() {
                ...
                function m(v, _, g, S, N) {
                    ...
                    if (u(O >= 0), C.slice) for(var W = 0; W < O; W++)_[g + W] = C[N + W];
                    else for(var W = 0; W < O; W++)_[g + W] = C.get(N + W);
                    return O;
                }
        ...
        function wn(e, r, t, n, o, a, s, c, l, f, m, v, _, g, S, N, C, O) {
            var W = y();
            try {
                w(e)(r, t, n, o, a, s, c, l, f, m, v, _, g, S, N, C, O);
            } catch (de) {
        ...
        function On(e, r, t, n, o, a, s, c, l, f, m) {
            var v = y();
            try {
