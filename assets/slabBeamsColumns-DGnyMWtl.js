...
import { d as K, __tla as __tla_0 } from "./didacticCpp-CzlDWovh.js";
let Q;
let __tla = Promise.all([
  ...
  Q = {
    ...
    build(n, a) {
      ...
      for (let e = 0; e < c; e++) N.set(e, n.t), f.set(e, n.E), h.set(e, n.nu), x.set(e, 24), k.set(e, 2);
      const B = n.bW * n.bH, j = n.bW * n.bH ** 3 / 12, C = n.bH * n.bW ** 3 / 12, F = j + C;
      for (let e = 0; e < u; e++) {
        const s = c + e;
        f.set(s, n.E), h.set(s, n.nu), x.set(s, 24), v.set(s, B), _.set(s, j), y.set(s, C), S.set(s, F), I.set(s, O), E.set(s, [
          n.bH,
          n.bW
        ]), H.set(s, [
          0,
      ...
      for (let e = 0; e < g; e++) {
        const s = c + u + e;
        f.set(s, n.E), h.set(s, n.nu), x.set(s, 24), v.set(s, T), _.set(s, R), y.set(s, R), S.set(s, Z), I.set(s, O), E.set(s, [
          n.cS,
          n.cS
        ]);
      }
