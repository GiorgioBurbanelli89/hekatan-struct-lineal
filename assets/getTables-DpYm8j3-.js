import { w as g, f as h, __tla as __tla_0 } from "./aiAgent-BAR3xtkA.js";
...
let __tla = Promise.all([
  ...
  function E({ fields: o, data: l }) {
    const r = document.createElement("div"), e = new g({
  ...
  function w(o) {
    return f.split("").map((r) => ({
      field: r,
      text: '<div style="text-align: center">' + r + "</div>",
      size: "90px",
      resizable: true,
      sortable: true,
      editable: {
  ...
  function b(o, l) {
    const r = Array.isArray(o) ? o : s(o, l), e = Array(50).fill(0).map((t, n) => ({
      recid: n
    })), i = f.split("");
    ...
    function s(t, n) {
      ...
      return n.forEach((u) => d.set(u.field, u)), Object.keys(t).map((u) => [
        d.get(u).text,
        t[u]
      ]);
    }
  ...
  function m(o, l) {
    ...
    function i(s, t) {
      return Object.fromEntries(t.map(({ field: n }, d) => [
        n,
        s[d].B
      ]));
    }
