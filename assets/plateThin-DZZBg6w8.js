import { m as g, p as L, __tla as __tla_0 } from "./didacticCpp-CzlDWovh.js";
let Y;
  ...
  Y = {
    ...
    build(n, s) {
      ...
      i.forEach((e, a) => {
        ...
        const f = (Math.abs(e[0]) < 1e-6 || Math.abs(e[0] - n.Lx) < 1e-6) && (Math.abs(e[1]) < 1e-6 || Math.abs(e[1] - n.Ly) < 1e-6) ? 0.25 : b ? 0.5 : 1, v = -n.q * y * f;
        m.set(a, [
          0,
          0,
          v,
    ...
    runModal(n, s, t) {
      ...
      if (!(!i.length || !l.length || !((_a = o.supports) == null ? void 0 : _a.size) || !((_b = r.densities) == null ? void 0 : _b.size))) try {
        const m = g(i, l, o, r, 12);
        t.render(m, {
          title: `Plate Thin ${n.Lx}\xD7${n.Ly}m t=${n.t}m`,
          properties: [
