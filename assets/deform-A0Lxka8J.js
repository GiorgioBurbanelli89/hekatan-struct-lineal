...
import { _ as xn } from "./preload-helper-V2P8TQsQ.js";
let Un;
let __tla = (async () => {
  Un = async function(we = {}) {
    ...
    if (z) {
      const { createRequire: e } = await xn(() => import("./__vite-browser-external-D7Ct-6yo.js").then((r) => r._), []);
    ...
    var je, He, x, Q, ve, F, I, ee = false;
    function $e() {
      var e = Ee.buffer;
      x = new Int8Array(e), d.HEAPU8 = Q = new Uint8Array(e), ve = new Int32Array(e), d.HEAPU32 = F = new Uint32Array(e), d.HEAPF64 = new Float64Array(e), I = new BigInt64Array(e), new BigUint64Array(e);
    }
    ...
    var Pe;
    function br() {
      return d.locateFile ? pr("deform.wasm") : new URL("/hekatan-struct-lineal/assets/deform-Dnm5xNkJ.wasm", import.meta.url).href;
    }
    function Tr(e) {
    ...
    async function Pr(e, r) {
      try {
        ...
        M(`failed to asynchronously prepare wasm: ${o}`), Z(e) && M(`warning: Loading from a file URI (${e}) is not supported in most browsers. See https://emscripten.org/docs/getting_started/FAQ.html#how-do-i-run-a-local-webserver-for-testing-why-does-my-program-stall-in-downloading-or-preparing`), T(o);
      }
    }
    ...
    var Ge = (e) => {
      ...
      return a;
    }, j = (e, r, t) => (u(typeof e == "number", `UTF8ToString expects a number (got ${typeof e})`), e ? G(Q, e, r) : ""), Ir = (e, r, t, n) => T(`Assertion failed: ${j(e)}, at: ` + [
    ...
    var pe = (e) => sr(e), Xe = (e) => {
      ...
      return r[t] = 0, t - o;
    }, ie = (e, r, t) => (u(typeof t == "number", "stringToUTF8(str, outPtr, maxBytesToWrite) is missing the third parameter that specifies the length of the output buffer!"), Ke(e, Q, r, t)), ge = (e) => {
    ...
    var Qr = () => 2147483648, et = (e, r) => (u(r, "alignment argument is required"), Math.ceil(e / r) * r), rt = (e) => {
...
`));
      ...
      stream_ops: {
        ...
        mmap(e, r, t, n, o) {
          ...
          if (!(o & 2) && c && c.buffer === x.buffer) s = false, a = c.byteOffset;
            ...
            if (s = true, a = Ze(), !a) throw new i.ErrnoError(48);
    ...
    var vr = {
      ...
      invoke_iiiiiiii: rn,
      invoke_iiiiiiiii: en,
      invoke_iiiiiiiiii: Qt,
      invoke_iiiiiiiiiii: An,
      invoke_iiiiiiiiiiii: On,
      invoke_iiiiiiiiiiiii: Rn,
      invoke_iiiiiiiiiiiiiii: Zt,
      invoke_j: bn,
      invoke_jiiii: Pn,
      invoke_v: Mt,
      invoke_vddiiii: un,
      ...
      invoke_viiidd: Sn,
      invoke_viiidddd: kn,
      invoke_viiidddddd: Fn,
      invoke_viiidddidiiddiii: wn,
      invoke_viiii: It,
      invoke_viiiii: Ct,
      invoke_viiiiid: dn,
      ...
      invoke_viiiiiiiiiiiddddii: hn,
      invoke_viiiiiiiiiiii: fn,
      invoke_viiiiiiiiiiiiiii: Cn,
    ...
    function Zt(e, r, t, n, o, a, s, c, l, f, m, v, _, h, S) {
      var P = E();
      try {
    ...
    function hn(e, r, t, n, o, a, s, c, l, f, m, v, _, h, S, P, N, R) {
      var C = E();
      try {
    ...
    function pn(e, r, t, n, o, a, s, c, l, f, m, v, _, h, S, P) {
      var N = E();
      try {
    ...
    function wn(e, r, t, n, o, a, s, c, l, f, m, v, _, h, S, P) {
      var N = E();
      try {
        w(e)(r, t, n, o, a, s, c, l, f, m, v, _, h, S, P);
      } catch (R) {
    ...
    function An(e, r, t, n, o, a, s, c, l, f, m) {
      var v = E();
      try {
    ...
    function Rn(e, r, t, n, o, a, s, c, l, f, m, v, _) {
      var h = E();
      try {
    ...
    function Cn(e, r, t, n, o, a, s, c, l, f, m, v, _, h, S, P) {
      var N = E();
      try {
        w(e)(r, t, n, o, a, s, c, l, f, m, v, _, h, S, P);
      } catch (R) {
