...
import { a as U, __tla as __tla_0 } from "./analyze-Du843e5g.js";
import { d as j, __tla as __tla_1 } from "./didacticCpp-Czy7NlhT.js";
import { g as Q, __tla as __tla_2 } from "./getViewer-B5L64pyA.js";
import { g as q } from "./getParameters-BKCcIidf.js";
import { g as V } from "./aiAgent-VzHiuQev.js";
...
Promise.all([
  ...
  a.derive(() => {
    const n = s.W.value.val, d = s.H.value.val, f = s.t.value.val, l = Math.round(s.nx.value.val), p = Math.round(s.ny.value.val), E = s.E.value.val, S = s.nu.value.val, k = s.P.value.val, H = E / (2 * (1 + S)), C = n / l, F = d / p, i = [], o = [];
  ...
  a.derive(() => {
    const n = N.val, d = Math.max(n.errOS, n.errSAP, n.errETABS), f = d < 0.5 ? '<span style="color:#7eff7e">\u2713 TODOS PASAN</span>' : d < 5 ? '<span style="color:#ffcc00">\u26A0 ERROR ACEPTABLE (0.5-5%)</span>' : '<span style="color:#ff5555">\u2717 ALGUNO FALLA</span>';
    y.innerHTML = `
