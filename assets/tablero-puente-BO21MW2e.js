...
import { v as l, e as at, D as vt, M as y, c as S, C as ae } from "./theme-C-zoknmI.js";
import { P as se } from "./tweakpane-BXg6ZhiP.js";
import { a as oe, __tla as __tla_0 } from "./analyze-h3F5Phoi.js";
import { d as ne, __tla as __tla_1 } from "./didacticCpp-Czy7NlhT.js";
import { g as le, f as bt, h as ht, __tla as __tla_2 } from "./getViewer-BwuXkQzt.js";
import { e as ie } from "./makeDraggable-zx2br6Yh.js";
import { g as me } from "./getParameters-COJmAxBJ.js";
import { g as ce } from "./aiAgent-DN1k8d69.js";
...
Promise.all([
  ...
  l.derive(() => {
    var _a, _b;
    const a = r.L.value.val, v = r.W.value.val, d = r.t_s.value.val, B = r.s_b.value.val, f = r.bf.value.val, n = r.tf.value.val, m = r.hw.value.val, b = r.tw.value.val, I = Math.round(r.modo.value.val), lt = r.q.value.val, p = Math.round(r.nx.value.val), x = Math.round(r.ny.value.val), C = 2 * f * n + m * b, Ot = 2 * n + m, it = 2 * (f * n * Math.pow(m / 2 + n / 2, 2)) + b * Math.pow(m, 3) / 12, Ft = (f * Math.pow(n, 3) + f * Math.pow(n, 3) + m * Math.pow(b, 3)) / 3, mt = f * n + m * b, ct = (f * n * (n / 2) + m * b * (n + m / 2)) / mt, Wt = f * Math.pow(n, 3) / 12 + f * n * Math.pow(ct - n / 2, 2), Ct = b * Math.pow(m, 3) / 12 + m * b * Math.pow(n + m / 2 - ct, 2), Lt = Wt + Ct, Pt = (f * Math.pow(n, 3) + m * Math.pow(b, 3)) / 3, Rt = I === 1 ? mt : C, Dt = I === 1 ? Lt : it, Tt = I === 1 ? Pt : Ft, k = [], _ = [], L = /* @__PURE__ */ new Map(), P = /* @__PURE__ */ new Map(), R = /* @__PURE__ */ new Map(), D = /* @__PURE__ */ new Map(), T = /* @__PURE__ */ new Map(), V = /* @__PURE__ */ new Map(), q = /* @__PURE__ */ new Map(), G = /* @__PURE__ */ new Map(), J = /* @__PURE__ */ new Map();
    function Vt(t, e, s) {
      return k.push([
        t,
        e,
    ...
    function Gt(t, e, s, i, c) {
      ...
      const o = _.length - 1;
      P.set(o, xt), R.set(o, gt), D.set(o, pe), T.set(o, fe), V.set(o, s), G.set(o, i), q.set(o, i), J.set(o, c), L.set(o, 0);
    }
    const U = [
      v / 2 - B,
      v / 2,
    ...
    for (let t = 0; t <= x; t++) for (let e = 0; e <= p; e++) {
      const s = t === 0 || t === x ? Z / 2 : Z, c = (e === 0 || e === p ? Y / 2 : Y) * s, o = -lt * c, w = u[t][e];
      rt.set(w, [
        0,
        0,
        o,
    ...
    if (g === 0) {
      ...
      for (let s = 0; s < p; s++) {
        const i = Q[ft + s], c = t == null ? void 0 : t.get(i), o = e == null ? void 0 : e.get(i);
