(async ()=>{
    ...
    async function Ie(I = {}) {
        ...
        var d = I, k = !!globalThis.window, K = !!globalThis.WorkerGlobalScope, q = globalThis.process?.versions?.node && globalThis.process?.type != "renderer", X = !k && !q && !K;
        if (q) {
        ...
        var Me;
        function ar() {
            return d.locateFile ? ne("deform.wasm") : new URL("/hekatan-struct-lineal/assets/deform-CLV4yhVK.wasm", import.meta.url).href;
        }
        function $e(e) {
...
`));
            ...
            createLazyFile (e, r, t, n, o) {
                class a {
                    ...
                    cacheLength() {
                        ...
                        N || (D = g);
                        var W = (Z, Le)=>{
                            Z > Le && R("invalid range (" + Z + ", " + Le + ") or no bytes requested!"), Le > g - 1 && R("only " + g + " bytes available! programmer error!");
                        ...
                        de.setDataGetter((Z)=>{
                            ...
                            return H = Math.min(H, g - 1), typeof de.chunks[Z] > "u" && (de.chunks[Z] = W(Le, H)), typeof de.chunks[Z] > "u" && R("doXHR failed!"), de.chunks[Z];
    ...
    await Ie();
    const b = await Ie();
    function $n(I, B, d, k, K = 10, q = 0, X = 0, Q = 1, te, Pe) {
        ...
        A.push(Xe), b._modal(ne, I.length, ie, fe.length, ue, B.length, me, u, L.length, ze.keysPtr, ze.valuesPtr, ze.size, ve.keysPtr, ve.valuesPtr, ve.size, h.keysPtr, h.valuesPtr, h.size, he.keysPtr, he.valuesPtr, he.size, oe.keysPtr, oe.valuesPtr, oe.size, T.keysPtr, T.valuesPtr, T.size, He.keysPtr, He.valuesPtr, He.size, We.keysPtr, We.valuesPtr, We.size, je.keysPtr, je.valuesPtr, je.size, Ae.keysPtr, Ae.valuesPtr, Ae.size, Te.keysPtr, Te.valuesPtr, Te.size, ge, F, $.length, ir, or, ae.length, Me, ar, R.length, $e.keysPtr, $e.valuesPtr, $e.size, Ge.keysPtr, Ge.valuesPtr, Ge.size, Ve.keysPtr, Ve.valuesPtr, Ve.size, cr, qe, sr.length, Ne.keysPtr, Ne.valuesPtr, Ne.size, Q, Ke.keysPtr, Ke.valuesPtr, Ke.size, se, Ee ? Ee.length : 0, k.etabsWallJoint === !1 ? 0 : 1, K, q, X, p, y, ee, Oe, Ye, J, Y, Xe);
    ...
    function j(I, B, d) {
        const k = new B(I), K = b._malloc(k.length * k.BYTES_PER_ELEMENT);
    ...
    self.onmessage = async (I)=>{
        const { nodes: B, elements: d, nodeInputs: k, elementInputs: K, nModes: q } = I.data ?? {};
        try {
            const X = {};
