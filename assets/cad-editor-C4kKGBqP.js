...
import { v as y, V as b, O as q, x as K, l as Q, y as ee, z as oe, W as ne, G as se, A as ie, k as te, H as G, I as N, J as C, K as ae, B as z, b as F, d as E, S as re, f as le, M as de, F as ce, L as pe, N as me } from "./Text-Br8EG2up.js";
...
function Ae(e, l) {
  ...
  for (const c of a.x.axes) for (const t of a.y.axes) {
    const s = Z(e, c.position, t.position, n.elevation), i = Z(e, c.position, t.position, d.elevation);
    f.push(x(e, s, i));
  }
  return f;
}
...
function Ce() {
  ...
  new ResizeObserver(($) => {
    for (const A of $) {
      ...
      const I = S / X, O = o.top;
      o.left = -O * I, o.right = O * I, o.updateProjectionMatrix(), n.setSize(S, X), M();
    }
...
const L = ue(), { element: B, ctx: U } = Ce(), _ = Pe(L, U);
Fe(L, U);
