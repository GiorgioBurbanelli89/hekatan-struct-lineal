...
import { l as $t, a0 as xi, a1 as ql, v as we, a2 as Wl, D as Pt, M as pt, B as Ie, F as Mt, a3 as Zl, q as bt, a4 as Kl, a5 as Gl, a6 as ya, h as wa, a7 as xa, Y as Hs, a8 as Ai, a9 as Ti, $ as qn, H as ft, L as is, b as mt, f as gt, p as Qa, c as Jl, aa as Ql, V as te, I as on, J as Bt, ab as ho, u as Hi, d as Vt, a as uo, A as el, k as Ri, t as er, s as Xn, P as tr, ac as zi, n as po, m as sr, w as Ns, X as Pn, E as ba, S as bn, ad as fo, ae as Rn, g as va, i as _a, j as ka, C as Ca, x as nr, y as ir, z as or, W as ar, G as Sa, af as bi, N as mo, O as lr, ag as rr, _ as cr } from "./Text-Br8EG2up.js";
...
let __tla = (async () => {
  ...
  function mr(l, e, t) {
    const s = Hs(), n = new Ai(new Ie(), new Ti({
      color: s.nodePoint
    }));
    return qn((i, o) => {
  ...
  function Ia(l, e, t, s, n, i, o = 8) {
    ...
    }, U = H(t), G = H(s), W = P(U, _), V = P(G, _), q = P(U, A), D = P(G, A), R = d ? P(d, A) * n : 0, X = p ? P(p, A) * n : 0, Q = d ? P(d, _) * n : 0, re = p ? P(p, _) * n : 0, ue = P(U, f), be = P(G, f), le = [];
    for (let ie = 0; ie <= o; ie++) {
      const ae = ie / o, he = 1 - 3 * ae * ae + 2 * ae * ae * ae, pe = x * (ae - 2 * ae * ae + ae * ae * ae), Ce = 3 * ae * ae - 2 * ae * ae * ae, ve = x * (-ae * ae + ae * ae * ae), Ae = he * W + pe * R + Ce * V + ve * X, Ve = he * q - pe * Q + Ce * D - ve * re, ot = ue + (be - ue) * ae, yt = [
        l[0] + f[0] * (ae * x + ot),
        l[1] + f[1] * (ae * x + ot),
        l[2] + f[2] * (ae * x + ot)
      ];
  ...
  function xr(l, e, t) {
    const s = Hs(), n = new ft(), i = new is(new Ie(), new mt({
      color: s.elementLine,
      vertexColors: false,
      depthTest: false,
      transparent: true,
    ...
    return qn((p, f) => {
      ...
      for (const D of A) {
        ...
        if (D.length === 2 && e.deformedShape.val) {
          ...
          if (ue && be && re) {
            const le = Number.isFinite(e.deformScale.val) ? e.deformScale.val : 1, ie = le * (Number.isFinite(e.deformScaleZ.val) ? e.deformScaleZ.val : 1), ae = Ia(ue, be, re.get(D[0]), re.get(D[1]), le, ie);
            for (let he = 0; he < ae.length - 1; he++) H.push(...ae[he], ...ae[he + 1]), _ && R && (U.push(R.r, R.g, R.b), U.push(R.r, R.g, R.b));
            continue;
          }
        }
        ...
        if (D.length === 2 && !e.deformedShape.val && X && X.orig.length === S.length) {
          ...
          if (Q && re) {
            const ue = X.shape.slice(D[0] * 6, D[0] * 6 + 6), be = X.shape.slice(D[1] * 6, D[1] * 6 + 6), le = Ia(Q, re, ue, be, X.amp, X.amp);
        ...
        if (P(R)) {
          if (R.length === 3) {
            ...
            if (S[X] && S[Q] && S[re] && S[ue]) {
              let be;
              if (_) {
                const le = (S[X][2] + S[Q][2] + S[re][2] + S[ue][2]) / 4;
                be = vi(le) ? Ea : Aa;
              } else be = wr(S[X], S[Q], S[re], S[ue]) ? r : c;
      ...
      a.userData.faceToElem = V, a.userData.faceLocal = q, G.length > 0 ? (a.geometry.dispose(), a.geometry = new Ie(), a.geometry.setAttribute("position", new Mt(G, 3)), a.geometry.setAttribute("color", new Mt(W, 3)), a.geometry.computeVertexNormals(), a.visible = e.faces ? e.faces.rawVal : true) : a.visible = false;
    }), we.derive(() => {
  ...
  function _r(l, e, t, s) {
    ...
    we.derive(() => {
      ...
      if (d.length > c) {
        ...
        for (const X of d) {
          const Q = A - S < 1e-9 ? 0 : (a[X][0] - S) / (A - S), re = H - P < 1e-9 ? 0 : (a[X][1] - P) / (H - P), ue = Math.min(D - 1, Math.floor(Q * D)), be = Math.min(D - 1, Math.floor(re * D)), le = `${ue},${be},${W(a[X][2])}`, ie = Math.hypot(Q * D - (ue + 0.5), re * D - (be + 0.5)), ae = R.get(le);
          (!ae || ie < ae.d) && R.set(le, {
            i: X,
            d: ie
          });
  ...
  function $r(l, e, t, s) {
    const n = new ft(), i = new Ie(), o = new mt({
      vertexColors: true
    }), a = [
      0,
      0,
  ...
  function Ar(l, e, t, s) {
    ...
    function r(G, W, V, q) {
      ...
      function le(pe, Ce, ve, Ae) {
        be.push(0, pe, Ce, 0, ve, Ce, 0, ve, Ae, 0, pe, Ce, 0, ve, Ae, 0, pe, Ae);
      }
      le(-X, -Q, X, -re), le(-ue, -re, ue, re), le(-X, re, X, Q);
      const ie = new Ie();
      ...
      return he.setAttribute("position", new bt(ae, 3)), {
        fill: ie,
        outline: he
      };
    }
    function c(G, W, V) {
      ...
      function re(ie, ae, he, pe) {
        Q.push(0, ie, ae, 0, he, ae, 0, he, pe, 0, ie, ae, 0, he, pe, 0, ie, pe);
      }
    ...
    function d(G, W, V) {
      const q = G / 2, D = W / 2, R = q - V, X = D - V, Q = new Ie(), re = new Float32Array([
        0,
        -R,
        -X,
        0,
      ...
      const ue = [];
      function be(he, pe, Ce, ve) {
        ue.push(0, he, pe, 0, Ce, pe, 0, Ce, ve, 0, he, pe, 0, Ce, ve, 0, he, ve);
      }
      be(-q, -D, q, -X), be(-q, X, q, D), be(-q, -X, -R, X), be(R, -X, q, X);
      const le = new Ie();
      le.setAttribute("position", new bt(new Float32Array(ue), 3));
    ...
    function _(G, W, V = 24) {
      ...
      for (let ue = 0; ue < V; ue++) {
        const be = ue / V * Math.PI * 2, le = (ue + 1) / V * Math.PI * 2, ie = Math.cos(be), ae = Math.sin(be), he = Math.cos(le), pe = Math.sin(le);
        R.push(0, q * ie, q * ae, 0, q * he, q * pe, 0, D * he, D * pe), R.push(0, q * ie, q * ae, 0, D * he, D * pe, 0, D * ie, D * ae);
      }
      const X = new Ie();
      X.setAttribute("position", new bt(new Float32Array(R), 3));
      const Q = [];
      for (let ue = 0; ue < V; ue++) {
        const be = ue / V * Math.PI * 2, le = (ue + 1) / V * Math.PI * 2;
    ...
    return we.derive(() => {
      ...
      V.forEach((X, Q) => {
        ...
        if (be && !G || !be && !W) return;
        if (R >= 0) {
          const Ce = Math.min(re[1], ue[1]);
          Math.max(re[1], ue[1]);
          const ve = e.gridSize.rawVal || 3;
          if (Math.floor(Ce / ve + 0.01) !== R) return;
        }
        ...
        const ie = [
          ...
          (re[1] + ue[1]) / 2,
          (re[2] + ue[2]) / 2
        ], ae = Di(re, ue), he = (Ce) => (Ce.userData.secElem = X, Ce);
        if (le.type === "CFT") {
          const Ce = d(le.b, le.h, le.tw ?? le.b * 0.05), ve = new pt(Ce.concFill, S);
          ve.position.set(...ie), he(ve), ve.rotation.setFromRotationMatrix(ae), n.add(ve);
          const Ae = new pt(Ce.steelFillGeom, P);
          Ae.position.set(...ie), he(Ae), Ae.rotation.setFromRotationMatrix(ae), n.add(Ae);
          const Ve = new Vt(Ce.outline, H);
          Ve.position.set(...ie), he(Ve), Ve.rotation.setFromRotationMatrix(ae), n.add(Ve);
        } else {
          let Ce, ve, Ae;
          switch (le.type) {
            case "rect":
              Ce = o(le.b, le.h), ve = S, Ae = A;
              break;
            case "circ":
              Ce = a(le.d), ve = S, Ae = A;
              break;
            case "I":
              Ce = r(le.b, le.h, le.tf, le.tw), ve = P, Ae = H;
              break;
            case "HSS":
              Ce = c(le.b, le.h, le.tw ?? le.b * 0.05), ve = P, Ae = H;
              break;
            case "CFT":
              Ce = d(le.b, le.h, le.tw ?? le.b * 0.05), ve = P, Ae = H;
              break;
            case "L":
              Ce = p(le.b ?? le.h, le.h, le.t ?? le.tw ?? 3e-3), ve = P, Ae = H;
              break;
            case "2L":
              Ce = f(le.b ?? le.h, le.h, le.t ?? le.tw ?? 3e-3, le.dis ?? 0.01), ve = P, Ae = H;
              break;
            case "C":
            case "coldC":
              Ce = x(le.b, le.h, le.tf ?? le.t ?? 3e-3, le.tw ?? le.t ?? 3e-3), ve = P, Ae = H;
              break;
            case "2C":
              Ce = b(le.b, le.h, le.tf ?? 5e-3, le.tw ?? 5e-3, le.dis ?? 0.01), ve = P, Ae = H;
              break;
            case "T":
              Ce = C(le.b, le.h, le.tf ?? 0.01, le.tw ?? 6e-3), ve = P, Ae = H;
              break;
            case "pipe":
              Ce = _(le.d, le.tw ?? le.d * 0.05), ve = P, Ae = H;
              break;
            default:
              return;
          }
          const Ve = new pt(Ce.fill, ve);
          Ve.position.set(...ie), he(Ve), Ve.rotation.setFromRotationMatrix(ae), n.add(Ve);
          const ot = new Vt(Ce.outline, Ae);
          ot.position.set(...ie), he(ot), ot.rotation.setFromRotationMatrix(ae), n.add(ot);
        }
        const pe = Er(le);
        if (pe) {
          const ve = [
            ...
            "pipe",
            "coldC"
          ].includes(le.type) ? "#ff9900" : "#00ccff", Ae = new Bt(pe, ve, "transparent");
        ...
        x.forEach((A, P) => {
          ...
          if (A.length === 3 || A.length === 4) {
            ...
            const X = [
              ...
              Ce[1] + X[1] * pe,
              Ce[2] + X[2] * pe
            ]), ue = Math.abs(X[2]) > 0.5, be = X[2] > 0 ? -1 : 1, le = re(ue ? 0 : +H / 2), ie = re(ue ? be * H : -H / 2), ae = (pe, Ce, ve) => Q.push(...pe, ...Ce, ...ve);
            for (const pe of [
              le,
              ie
            ]) ae(pe[0], pe[1], pe[2]), pe.length === 4 && ae(pe[0], pe[2], pe[3]);
            for (let pe = 0; pe < U.length; pe++) {
              const Ce = (pe + 1) % U.length;
              ae(le[pe], ie[pe], ie[Ce]), ae(le[pe], ie[Ce], le[Ce]);
            }
            const he = new Ie();
  ...
  class _i extends ft {
    constructor(e, t, s, n, i, o, a) {
      super();
      const r = new Xn().moveTo(0, 0).lineTo(0, o[1]).lineTo(s, o[1]).lineTo(s, 0).lineTo(0, 0), c = r.getPoints(), d = new Ie().setFromPoints(c);
  ...
  class wo extends ft {
    constructor(e, t, s, n, i, o, a) {
      ...
      if (this.text = new Bt(`${i[0].toFixed(4)}`), this.text2 = new Bt(`${(i[1] * -1).toFixed(4)}`), this.normalizedResult = o, this.textPosition = Mo(e, t), this.text2Position = Mo(t, e), this.text.position.set(...this.textPosition), this.text2.position.set(...this.text2Position), this.text.rotation.setFromRotationMatrix(n), this.text2.rotation.setFromRotationMatrix(n), this.add(this.text, this.text2), c) {
        const d = new Xn().moveTo(0, 0).lineTo(0, o[0]).lineTo(r, 0).lineTo(0, 0), p = new Xn().moveTo(r, 0).lineTo(s, -o[1]).lineTo(s, 0).lineTo(r, 0), f = d.getPoints(), x = p.getPoints(), b = new Ie().setFromPoints(f), C = new Ie().setFromPoints(x), _ = new mt({
          color: Hs().resultOutline
        });
        ...
        const d = new Xn().moveTo(0, 0).lineTo(0, o[0]).lineTo(s, -o[1]).lineTo(s, 0).lineTo(0, 0), p = d.getPoints(), f = new Ie().setFromPoints(p);
  ...
  function Nr({ drawingObj: l, gridObj: e, scene: t, getActiveCamera: s, controls: n, gridSize: i, derivedDisplayScale: o, rendererElm: a, viewerRender: r }) {
    ...
    const U = (u, g, w) => Math.round(u * 1e3) + "," + Math.round(g * 1e3) + "," + Math.round(w * 1e3), G = (u) => {
      ...
      H.geometry.dispose(), H.geometry = new Ie().setFromPoints(u), H.visible = true;
    }, q = (u) => {
      let g = 0;
    ...
    const re = (u, g) => {
      ...
      X.geometry.dispose(), X.geometry = new Ie(), X.geometry.setAttribute("position", new bt(E, 3)), X.material.color.set(M ? 3718648 : 16096779), X.visible = true, Q = {
        m: u,
        t0: g,
        tris: v,
        normal: k,
    ...
    const ie = /* @__PURE__ */ new Map(), ae = new is(new Ie(), new mt({
      color: 16498468,
      transparent: true,
      opacity: 0.35,
      depthTest: true
    ...
    const he = 1, pe = (u, g, w) => Math.floor(u / he) + "," + Math.floor(g / he) + "," + Math.floor(w / he), Ce = (u) => {
      const g = ie.get(u.id);
      if (g) return g;
    ...
    const Ae = (u) => {
      ...
      if (g === ve) return;
      ve = g;
      const w = u.map((k) => Ce(k).segs);
      let m = 0;
      for (const k of w) m += k.length;
      const v = new Float32Array(m);
      let E = 0;
      for (const k of w) v.set(k, E), E += k.length;
      ae.geometry.dispose(), ae.geometry = new Ie(), ae.geometry.setAttribute("position", new bt(v, 3)), ae.visible = m > 0 && window.__hekatanRefIfcBordes !== false;
    };
    ...
    const Ve = (u, g) => {
      ...
      if (!w) return null;
      const m = Ce(u), v = m.segs, E = Math.floor(g.x / he), k = Math.floor(g.y / he), M = Math.floor(g.z / he), $ = /* @__PURE__ */ new Set();
    ...
    let yt = "", Se = new Float32Array(0);
    const ce = new is(new Ie(), new mt({
      color: 16096779,
      transparent: true,
      opacity: 0.95,
      depthTest: false
    ...
    const _e = () => {
      ...
      if (!u || window.__hekatanRefIfcSnap === false) return ce.visible = false, Se = new Float32Array(0);
      const g = [];
      u.enableX && g.push([
        0,
        +u.posX
      ...
      return Se = new Float32Array(v), ce.geometry.dispose(), ce.geometry = new Ie(), ce.geometry.setAttribute("position", new bt(Se, 3)), ce.visible = Se.length > 0, Se;
    };
    let ge = null, xe = null;
    const Ne = (u, g) => {
      const w = _e();
    ...
    }, Fe = new Ai(new Ie(), new Ti()), Oe = new Ai(new Ie(), new Ti({
      color: "gray",
      sizeAttenuation: false,
      size: 6
    })), Ge = new Ai(new Ie(), new Ti({
      color: "orange",
      sizeAttenuation: false,
      size: 5
    }));
  ...
  @5<45<30  \u2192 esf\xE9rica 3D: 5m, azimuth 45\xB0, elevaci\xF3n 30\xB0`, Ee.style.cssText = [
    ...
    const De = new Vt(new Ie().setFromPoints([
      new te(0, 0, 0),
      new te(0, 0, 0)
    ]), new Pn({
      color: 2282478,
    ...
    const Ms = (u) => {
      ...
      Xs.geometry.dispose(), Xs.geometry = new Ie(), Xs.geometry.setAttribute("position", new Mt(w, 3));
    };
    Lt.add(Ht, $s, Xs), Lt.visible = false, Lt.frustumCulled = false, t.add(Lt);
    const Zt = new ft();
    Zt.frustumCulled = false, Zt.visible = false, t.add(Zt);
    const Es = (u) => {
      const g = new Ie().setFromPoints([
        new te(0, 0, 0),
        new te(0, 0, 0)
      ]), w = new Pn({
        color: u,
    ...
    const Qt = new Vt(new Ie().setFromPoints([
      new te(0, 0, 0),
      new te(0, 0, 0)
    ]), new mt({
      color: 16724804,
    ...
    const bs = new Vt(new Ie().setFromPoints([
      new te(),
      new te()
    ]), new mt({
      color: 16766720,
    ...
    const kl = (u, g, w, m) => {
      ...
      for (const k of je) {
        ...
        if (M === "pt") {
          ...
          const N = new Ie().setFromPoints(T), F = new Vt(N, new mt({
            color: ii,
            transparent: true,
            opacity: 0.95,
            depthTest: false
    ...
    Fe.geometry.setAttribute("position", new Mt(l.points.rawVal.flat(), 3)), Fe.geometry.computeBoundingSphere(), Fe.frustumCulled = false, Oe.frustumCulled = false, t.add(Oe), f.position.set(0, 0, 0), f.rotateX(Math.PI / 2), f.geometry.rotateX(Math.PI / 2), f.updateMatrixWorld(), l.polylines && (l.polylines.val = [
      ...l.polylines.rawVal,
      []
    ...
    window.__hekatanDrawCircle = (u, g, w, m, v = window.__hekatanArcSegs ?? 12, E = "xy") => {
      ...
      if (de >= 0) {
        ...
        let qe = Math.abs(Te - ke) > 1e-9, et = ke;
        for (let Le = 1; Le <= it && qe; Le++) {
          const Je = oe(K * Le / it).getComponent(de);
          (Je - et) * (Te - ke) < -1e-9 && (qe = false), et = Je;
        }
        if (qe) {
          me = true;
      ...
      if (l.points.val = [
        ...
        const ke = se.map((it, qe) => J + qe), Te = l.polylines.rawVal;
        l.polylines.val = [
          ...Te.slice(0, -1),
          ke,
          []
    ...
    window.__hekatanRevolveSelection = (u, g, w, m = 360) => {
      ...
      const F = N > 0 ? 1 : -1, L = (de) => {
        const me = $[(de - 1 + I) % I], ke = $[de], Te = $[(de + 1) % I], it = [
          ...
          Te[0] - ke[0],
          Te[1] - ke[1]
        ], et = Math.hypot(it[0], it[1]) || 1, Le = Math.hypot(qe[0], qe[1]) || 1, Je = [
          F * it[1] / et,
          -F * it[0] / et
        ], He = [
          F * qe[1] / Le,
      ...
      const de = (Re, Xe) => {
        ...
        for (let xt = 0, St = B.length - 1; xt < B.length; St = xt++) {
          ...
          fs > Xe != Js > Xe && Re < (wn - Ot) * (Xe - fs) / (Js - fs) + Ot && (We = !We);
        }
        return We;
      }, me = Math.max(1, Math.round(se / ne)), ke = Math.max(1, Math.round(oe / ne)), Te = se / me, it = oe / ke, qe = /* @__PURE__ */ new Map(), et = [], Le = l.points.rawVal.length, Je = (Re, Xe) => {
        const We = Re + "," + Xe, xt = qe.get(We);
        if (xt !== void 0) return xt;
        const St = Le + et.length;
        return et.push(z(Y + Re * Te, K + Xe * it)), qe.set(We, St), St;
      }, He = [];
      ...
      if (window.__hekatanPushUndo && window.__hekatanPushUndo(), l.points.val = [
        ...
        const Xe = [];
        for (const We of He) Xe.push(Re.length), Re.push([
          We[0],
          We[1],
          We[2],
          We[3],
    ...
    us.visible = false, t.add(us), window.__hekatanShowAxes = (u, g, w = 12, m = 2) => {
      ...
      u.forEach((T, N) => {
        const F = N < $.length ? $[N] : `X${N}`, L = new Ie().setFromPoints([
          new te(T, v, 0),
          new te(T, E, 0),
          new te(T, v, 0),
          new te(T, v, w)
        ...
        const F = `${N + 1}`, L = new Ie().setFromPoints([
          new te(k, T, 0),
          new te(M, T, 0),
          new te(k, T, 0),
          new te(k, T, w)
    ...
    window.__hekatanShowRefPlanes = (u = [
      ...
      u.forEach((E, k) => {
        const M = v[k % v.length], $ = g / 2, I = [
          ...
          new te(w - $, m + $, E),
          new te(w - $, m - $, E)
        ], T = new Ie().setFromPoints(I), N = new mt({
          color: M,
          transparent: true,
          opacity: 0.55
        });
    ...
    window.__hekatanUpdateSelectionPtScale = Qo, n.addEventListener("change", () => {
      ...
      if ((!w.length || ((_c2 = (_b = (_a3 = window.__hekatanCadState) == null ? void 0 : _a3.get) == null ? void 0 : _b.call(_a3)) == null ? void 0 : _c2.tool) !== "fillarea") && _t.visible && (_t.visible = false), w.length) {
        ...
        if ($ === "select" || !$) {
          const F = (window.__hekatanSnap2D ?? 0.5) * 1.5, L = kl(m.x, m.y, m.z, F), j = Ui(m.x, m.y, m.z, F), Z = Yo(m.x, m.y, m.z, F);
          if (L >= 0) {
        ...
        if ($ === "delete" || $ === "trim" || $ === "extend" || $ === "offset") {
          const F = (window.__hekatanSnap2D ?? 0.5) * 1.5, L = Ui(m.x, m.y, m.z, F), j = Yo(m.x, m.y, m.z, F);
          let Z = false;
          if (j >= 0) if (!L) Z = true;
          else {
          ...
          Z ? (Ps = j, ws = -1, Fs = -1, Cl(j)) : L ? (ws = L.polyIdx, Fs = L.segIdx, Ps = -1, Sl(L.polyIdx, L.segIdx)) : (ws = -1, Fs = -1, Ps = -1, Qt.visible = false), De.visible = false, Zt.visible = false, Kt.visible = false, at(), Pe.style.left = u.clientX + "px", Pe.style.top = u.clientY + "px", Pe.style.display = "block";
        ...
        if (T.length > 0 && N[T[T.length - 1]]) {
          ...
          if (!j && !Z && window.__hekatanAxisSnap !== false) {
            const qe = a.getBoundingClientRect(), et = u.clientX, Le = u.clientY, Je = ((_q = settings.gridSize) == null ? void 0 : _q.rawVal) ?? 10, He = new te(L[0], L[1], L[2]), Re = [
              [
                "x",
                new te(1, 0, 0)
              ],
            ...
            for (const [xt, St] of Re) {
              const Ot = Xe(He.clone().addScaledVector(St, -Je)), fs = Xe(He.clone().addScaledVector(St, Je)), wn = fs.x - Ot.x, Js = fs.y - Ot.y, Hl = et - Ot.x, Xl = Le - Ot.y, Yl = wn * wn + Js * Js || 1;
              let wi = (Hl * wn + Xl * Js) / Yl;
              wi = Math.max(0, Math.min(1, wi));
              const pa = Math.hypot(et - (Ot.x + wi * wn), Le - (Ot.y + wi * Js));
              if (We === null || pa < We.dpx) {
                const ro = c.ray, fa = He.clone().sub(ro.origin), co = St.dot(ro.direction), ma = St.dot(fa), jl = ro.direction.dot(fa), ga = 1 - co * co, Ul = Math.abs(ga) < 1e-6 ? -ma : (co * jl - ma) / ga;
                We = {
                  axis: xt,
                  dpx: pa,
                  pt: He.clone().addScaledVector(St, Ul)
                };
              }
            }
          ...
          if (!j && !Z && O) {
            const qe = Math.abs(m.x - L[0]), et = Math.abs(m.y - L[1]), Le = Math.abs(m.z - L[2]), Je = (_r2 = w[0]) == null ? void 0 : _r2.object;
            let He = null;
            Je === cs ? He = "xy" : Je === gs ? He = "xz" : Je === ys && (He = "yz"), He === "xy" ? j = qe >= et ? "x" : "y" : He === "xz" ? j = qe >= Le ? "x" : "z" : He === "yz" ? j = et >= Le ? "y" : "z" : j = qe >= et && qe >= Le ? "x" : et >= Le ? "y" : "z";
          }
          const z = window.__hekatanPolarTrack !== false;
          if (!j && !Z && z) {
            const qe = m.x - L[0], et = m.y - L[1], Le = m.z - L[2], Je = Math.hypot(qe, et, Le);
            if (Je > 1e-3) {
              const Re = Math.tan(6 * Math.PI / 180) * Je, Xe = Math.hypot(et, Le), We = Math.hypot(qe, Le), xt = Math.hypot(qe, et), St = [
                [
                  "x",
                  Xe
                ],
          ...
          if (j) {
            const qe = L[0], et = L[1], Le = L[2];
            j === "x" ? m.set(m.x, et, Le) : j === "y" ? m.set(qe, m.y, Le) : m.set(qe, et, m.z);
            const Je = !!zt, Re = {
              x: "#ff3344",
              y: "#34d399",
              z: "#60a5fa"
          ...
          if (!v && !Z && window.__hekatanTrack !== false && window.__hekatanOsnapOn !== false) {
            ...
            let Je = 1 / 0;
            for (const He of qe) if (!(Math.abs(He[0] - L[0]) < 1e-9 && Math.abs(He[1] - L[1]) < 1e-9 && Math.abs(He[2] - L[2]) < 1e-9)) for (const Re of et) {
              const Xe = new te(Re === "x" ? He[0] : m.x, Re === "y" ? He[1] : m.y, Re === "z" ? He[2] : m.z), We = Ks(Xe.x, Xe.y, Xe.z);
              if (!We) continue;
              const xt = Math.hypot(We.x - Le.x, We.y - Le.y);
              xt < Rs && xt < Je && (Je = xt, B = {
                q: He,
                eje: Re
              });
      ...
      Fe.geometry.setAttribute("position", new Mt(l.points.val.flat(), 3)), Fe.geometry.computeBoundingSphere();
    }), we.derive(() => {
    ...
    window.__hekatanDeleteSelected = Qi, window.addEventListener("keydown", (u) => {
      ...
      g && (g.tagName === "INPUT" || g.tagName === "TEXTAREA" || g.isContentEditable) && !w || je.size !== 0 && (u.preventDefault(), Qi());
    });
    ...
    const sa = {
      ...
      const v = sa[u] ?? 16777215, E = new Ie().setFromPoints([
        new te(-1, -1, 0),
        new te(1, -1, 0),
        new te(1, -1, 0),
        new te(1, 1, 0),
    ...
    const Fl = (u, g, w, m, v) => {
      ...
      if (E.int) {
        ...
        for (let B = 0; B < z.length; B++) for (let Y = B + 1; Y < z.length; Y++) {
          const [ee, K] = z[B], [J, se] = z[Y], oe = [
            ...
            ee[1] - J[1],
            ee[2] - J[2]
          ], me = oe[0] * oe[0] + oe[1] * oe[1] + oe[2] * oe[2], ke = oe[0] * ne[0] + oe[1] * ne[1] + oe[2] * ne[2], Te = ne[0] * ne[0] + ne[1] * ne[1] + ne[2] * ne[2], it = oe[0] * de[0] + oe[1] * de[1] + oe[2] * de[2], qe = ne[0] * de[0] + ne[1] * de[1] + ne[2] * de[2], et = me * Te - ke * ke;
          if (et < 1e-12) continue;
          const Le = (ke * qe - Te * it) / et, Je = (me * qe - ke * it) / et;
          ...
          [
            ...
            J,
            se
          ].some((We) => Math.hypot(We[0] - He[0], We[1] - He[1], We[2] - He[2]) < 1e-6) || N("int", He[0], He[1], He[2]);
        }
      }
      ...
      if (E.int || E.node) for (let z = 0; z < j.length; z++) for (let B = z + 1; B < j.length; B++) {
        ...
        const ke = Y[0] - K[0], Te = Y[1] - K[1], it = (ne * Te - de * ke) / me, qe = (se * Te - oe * ke) / me;
    ...
    window.__hekatanDestello = (u) => {
      ...
      for (const v of u || []) {
        ...
        const M = new Ie().setFromPoints(k.map((I) => new te(I[0], I[1], I[2]))), $ = new Vt(M, na);
    ...
    window.__hekatanCadRefreshPrompt = ss, window.__hekatanRefreshStatus = () => {
      ...
      Ue = [], rt = [], ht.visible = false, so(), jt = null, r(), ye("\u{1F6E0} Tool cambiado \u2014 clicks pendientes limpiados"), ss();
    };
    function so() {
      if (!l.polylines) return;
    ...
    const yn = [], gi = [], Ll = () => {
      ...
      Ue = [], De.visible = false, Zt.visible = false, at();
      try {
        (_a3 = window.__hekatanRebuild) == null ? void 0 : _a3.call(window);
      } catch {
      }
      ...
      yn.push(no()), yn.length > 100 && yn.shift(), gi.length = 0;
    }, yi = () => {
      const u = yn.pop();
      if (!u) {
      ...
      gi.push(no()), aa(u), ye(`\u21B6 Deshacer \u2014 quedan ${yn.length}`);
    }, la = () => {
      const u = gi.pop();
      if (!u) {
      ...
      yn.push(no()), aa(u), ye(`\u21B7 Rehacer \u2014 quedan ${gi.length}`);
    };
    ...
    const io = () => {
      Ue = [], jt = null, so(), zt = null, Bo(), De.visible = false, Zt.visible = false, at(), ye("\u23F9 Dibujo finalizado \u2014 click para empezar otra serie"), r(), ss();
    };
    window.__hekatanFinalizeDraw = io;
    const ra = () => {
      var _a3, _b, _c2;
      Ue = [], rt = [], ht.visible = false;
      let u = false;
      je.size && (je.clear(), hs(), u = true), io();
      try {
      ...
      if (u === "offset") {
        ...
        for (let Le = 0; Le < O.length - 1; Le++) {
          const Je = m[O[Le]], He = m[O[Le + 1]], Re = [
            ...
            He[1] - Je[1],
            He[2] - Je[2]
          ], Xe = Math.hypot(Re[0], Re[1], Re[2]) || 1, We = Re[0] / Xe, xt = Re[1] / Xe, St = Re[2] / Xe, Ot = [
            B[1] * St - B[2] * xt,
            B[2] * We - B[0] * St,
            B[0] * xt - B[1] * We
      ...
      if (w === "fillarea") {
        ...
        const j = ((_E = (_D = (_C = window.__hekatanCadState) == null ? void 0 : _C.get) == null ? void 0 : _D.call(_C)) == null ? void 0 : _E.workPlane) ?? "xy", Z = (oe) => j === "xy" ? [
          ...
          for (let me = 0, ke = ne.length - 1; me < ne.length; ke = me++) {
            const Te = ne[me][0], it = ne[me][1], qe = ne[ke][0], et = ne[ke][1];
            it > oe[1] != et > oe[1] && oe[0] < (qe - Te) * (oe[1] - it) / (et - it) + Te && (de = !de);
          }
          return de;
        }, B = (oe) => {
          let ne = 0;
    ...
    a.addEventListener("click", () => ss()), a.addEventListener("contextmenu", (u) => {
      ...
      c.setFromCamera(d, g);
      let w = false;
      const m = c.intersectObject(Fe), v = Me();
  ...
  function jr(l, e, t, s) {
    ...
    return we.derive(() => {
      ...
      for (const { idx: X, vals: Q } of b) {
        ...
        if (!ue || !be) continue;
        const le = new te(be[0] - ue[0], be[1] - ue[1], be[2] - ue[2]), ie = le.length();
        if (ie < 1e-10) continue;
        le.normalize();
        const ae = Math.abs(le.y) < 0.99 ? new te(0, 1, 0) : new te(1, 0, 0), he = new te().crossVectors(le, ae).normalize(), pe = new te().crossVectors(le, he).normalize(), Ce = xo + 1, ve = Br;
        for (let Ae = 0; Ae < Ce; Ae++) {
          const Ve = Ae / xo, ot = ue[0] + le.x * ie * Ve, yt = ue[1] + le.y * ie * Ve, Se = ue[2] + le.z * ie * Ve, ce = Q[0] + (Q[1] - Q[0]) * Ve, _e = i.getColor(ce) ?? new $t(0, 0, 0);
          o.copy(_e).convertSRGBToLinear();
          for (let ge = 0; ge < ve; ge++) {
            const xe = ge / ve * Math.PI * 2, Ne = Math.cos(xe), ze = Math.sin(xe);
            U.push(ot + (he.x * Ne + pe.x * ze) * H, yt + (he.y * Ne + pe.y * ze) * H, Se + (he.z * Ne + pe.z * ze) * H), G.push(o.r, o.g, o.b);
          }
        }
        for (let Ae = 0; Ae < xo; Ae++) for (let Ve = 0; Ve < ve; Ve++) {
          const ot = (Ve + 1) % ve, yt = V + Ae * ve + Ve, Se = V + Ae * ve + ot, ce = V + (Ae + 1) * ve + Ve, _e = V + (Ae + 1) * ve + ot;
          W.push(yt, Se, _e), W.push(yt, _e, ce);
        }
        V += Ce * ve;
      }
  ...
  function Qr(l) {
    ...
    function V(Se) {
      ...
      return !ce || Se < 0 || Se >= ce.length ? null : new te(ce[Se][0], ce[Se][1], ce[Se][2]);
    }
    function q(Se, ce) {
      var _a2, _b, _c2, _d2, _e2, _f, _g, _h, _i2, _j, _k, _l, _m, _n2, _o2, _p, _q, _r2, _s;
      const _e = l.getActiveCamera();
      if (!_e || !l.mesh) return null;
      const ge = l.rendererElm.getBoundingClientRect(), xe = Se - ge.left, Ne = ce - ge.top, ze = l.derivedNodes.rawVal, Me = (_a2 = l.mesh.elements) == null ? void 0 : _a2.rawVal;
      if (!ze || !Me) return null;
      const Fe = /* @__PURE__ */ new Map(), Oe = (lt) => {
        if (Fe.has(lt)) return Fe.get(lt);
        const Qe = V(lt);
        if (!Qe) return Fe.set(lt, null), null;
        const Pe = Qe.clone().project(_e), st = (Pe.x * 0.5 + 0.5) * ge.width, De = (-Pe.y * 0.5 + 0.5) * ge.height, ht = {
          x: st,
          y: De,
          z: Pe.z
        };
        return Fe.set(lt, ht), ht;
      }, Ge = /* @__PURE__ */ new Set();
      for (const lt of Me) if (lt) for (const Qe of lt) Ge.add(Qe);
      const Ee = 8;
      let tt = -1, Ye = Ee;
      for (let lt = 0; lt < ze.length; lt++) {
        if (!Ge.has(lt)) continue;
        const Qe = Oe(lt);
        if (!Qe || Qe.z < -1 || Qe.z > 1) continue;
        const Pe = Qe.x - xe, st = Qe.y - Ne, De = Math.sqrt(Pe * Pe + st * st);
        De < Ye && (Ye = De, tt = lt);
      }
      const Ze = Ur(), $e = Wr[Ze.dispUnit] ?? 1e3, Be = qr[Ze.forceUnit] ?? 1;
      if (tt >= 0) {
        const lt = ze[tt];
        let Qe = `Nodo ${tt}
(${lt[0].toFixed(3)}, ${lt[1].toFixed(3)}, ${lt[2].toFixed(3)})`;
        ...
        if (Pe == null ? void 0 : Pe.deformations) {
          const st = Pe.deformations.get(tt);
          if (st && (Qe += `
\u2500\u2500\u2500\u2500 \u0394 desplaz. \u2500\u2500\u2500\u2500`, Qe += `
...
Rz = ${Ft(st[5] * 1e3, 3)} mrad`)), Pe.reactions) {
            const De = Pe.reactions.get(tt);
            De && (Math.abs(De[0]) > 1e-9 || Math.abs(De[1]) > 1e-9 || Math.abs(De[2]) > 1e-9 || Math.abs(De[3]) > 1e-6 || Math.abs(De[4]) > 1e-6 || Math.abs(De[5]) > 1e-6) && (Qe += `
\u2500\u2500\u2500\u2500 R reacciones \u2500\u2500\u2500\u2500`, Qe += `
Fx = ${Ft(De[0] * Be)} ${Ze.forceUnit}`, Qe += `
Fy = ${Ft(De[1] * Be)} ${Ze.forceUnit}`, Qe += `
Fz = ${Ft(De[2] * Be)} ${Ze.forceUnit}`, (Math.abs(De[3]) > 1e-6 || Math.abs(De[4]) > 1e-6 || Math.abs(De[5]) > 1e-6) && (Qe += `
Mx = ${Ft(De[3] * Be)} ${Ze.forceUnit}\xB7m`, Qe += `
My = ${Ft(De[4] * Be)} ${Ze.forceUnit}\xB7m`, Qe += `
Mz = ${Ft(De[5] * Be)} ${Ze.forceUnit}\xB7m`));
          }
        }
        return {
          type: "node",
      ...
      for (let lt = 0; lt < Me.length; lt++) {
        ...
        if (!(!Qe || Qe.length < 2)) {
          if (Qe.length === 2) {
            const Pe = Oe(Qe[0]), st = Oe(Qe[1]);
            if (!Pe || !st || Pe.z < -1 || Pe.z > 1 || st.z < -1 || st.z > 1) continue;
            const De = ec(xe, Ne, Pe.x, Pe.y, st.x, st.y);
            ...
            if (!st) continue;
            const De = Math.min(...Pe.map((Ke) => Ke.x)), ht = Math.max(...Pe.map((Ke) => Ke.x)), rt = Math.min(...Pe.map((Ke) => Ke.y)), Tt = Math.max(...Pe.map((Ke) => Ke.y));
  ...
  Shape: ${De.shape}`);
          const ht = /concrete|hormig|rect.*sólida/i.test(De.shape || ""), rt = ht ? 100 : 1e3, Tt = ht ? "cm" : "mm", Ke = (Wt) => {
            const Dt = Wt * rt;
            return Math.abs(Dt - Math.round(Dt)) < 0.05 ? `${Math.round(Dt)}` : `${Dt.toFixed(1)}`;
          }, nt = [];
          if (De.D != null && nt.push(`D=${Ke(De.D)}`), De.B != null && nt.push(`B=${Ke(De.B)}`), De.TF != null && nt.push(`TF=${Ke(De.TF)}`), De.TW != null && nt.push(`TW=${Ke(De.TW)}`), De.t != null && nt.push(`t=${Ke(De.t)}`), nt.length && (Pe += `
  ...
  Material: ${rt}`);
        ...
        if (Pe += `
nodos: [${lt.join(", ")}]`, qt === "shell" && ((_l = l.mesh) == null ? void 0 : _l.analyzeOutputs)) {
          const ht = l.mesh.analyzeOutputs.rawVal, rt = Zr[Ze.stressUnit] ?? 1, Tt = [
            [
              "bendingXX",
              "Mxx",
              Be,
...
`));
        ...
        if (qt === "frame" && ((_m = l.mesh) == null ? void 0 : _m.deformOutputs) && l.mesh.elementInputs) {
          ...
          if (Tt && lt.length === 2) {
            const Ke = Tt.get(lt[0]), nt = Tt.get(lt[1]), Wt = ze[lt[0]], Dt = ze[lt[1]];
            if (Ke && nt && Wt && Dt) {
              const _t = Dt[0] - Wt[0], Ms = Dt[1] - Wt[1], Lt = Dt[2] - Wt[2], Ht = Math.sqrt(_t * _t + Ms * Ms + Lt * Lt);
              if (Ht > 1e-9) {
                const $s = _t / Ht, Xs = Ms / Ht, Qn = Lt / Ht, Zt = (nt[0] - Ke[0]) * $s + (nt[1] - Ke[1]) * Xs + (nt[2] - Ke[2]) * Qn, Es = ((_n2 = rt.elasticities) == null ? void 0 : _n2.get(at)) ?? 0, Ys = ((_o2 = rt.areas) == null ? void 0 : _o2.get(at)) ?? 0, js = ((_p = rt.momentsOfInertiaY) == null ? void 0 : _p.get(at)) ?? 0, Us = ((_q = rt.momentsOfInertiaZ) == null ? void 0 : _q.get(at)) ?? 0, Sn = ((_r2 = rt.torsionalConstants) == null ? void 0 : _r2.get(at)) ?? 0, ji = ((_s = rt.shearModuli) == null ? void 0 : _s.get(at)) ?? Es / 2.6, Kt = Es * Ys * (Zt / Ht), Mn = (nt[3] - Ke[3]) * $s + (nt[4] - Ke[4]) * Xs + (nt[5] - Ke[5]) * Qn, qs = ji * Sn * (Mn / Ht), cn = nt[4] - Ke[4], dn = nt[5] - Ke[5], ms = Es * js * cn / Ht, hn = Es * Us * dn / Ht;
                Pe += `
\u2500\u2500\u2500\u2500 frame \u2500\u2500\u2500\u2500`, Pe += `
L = ${Ft(Ht, 3)} m`, Pe += `
\u0394L = ${Ft(Zt * $e, 3)} ${Ze.dispUnit}`, Pe += `
\u03B5 = ${Ft(Zt / Ht, 6)}`, Math.abs(Kt) > 1e-6 && (Pe += `
N \u2248 ${Ft(Kt * Be)} ${Ze.forceUnit}`), Math.abs(qs) > 1e-6 && (Pe += `
T \u2248 ${Ft(qs * Be)} ${Ze.forceUnit}\xB7m`), Math.abs(ms) > 1e-6 && (Pe += `
My \u2248 ${Ft(ms * Be)} ${Ze.forceUnit}\xB7m`), Math.abs(hn) > 1e-6 && (Pe += `
Mz \u2248 ${Ft(hn * Be)} ${Ze.forceUnit}\xB7m`);
              }
            }
          }
        }
    ...
    function D(Se, ce, _e) {
      var _a2, _b, _c2;
      if (n.visible = false, a.visible = false, c.visible = false, f.visible = false, C.visible = false, !Se || !l.mesh) {
      ...
      if (Se.type === "node") {
        const Me = V(Se.idx);
        if (Me) {
          const Fe = l.derivedNodes.rawVal ?? [];
          let Oe = 1;
          if (Fe.length >= 2) {
            let tt = [
              1 / 0,
            ...
            for (const Ze of Fe) for (let $e = 0; $e < 3; $e++) Ze[$e] < tt[$e] && (tt[$e] = Ze[$e]), Ze[$e] > Ye[$e] && (Ye[$e] = Ze[$e]);
            Oe = Math.max(Ye[0] - tt[0], Ye[1] - tt[1], Ye[2] - tt[2], 0.1);
          }
          const Ge = ((_b = l.derivedDisplayScale) == null ? void 0 : _b.rawVal) ?? 1, Ee = 0.021 * Oe * Ge;
          n.position.copy(Me), n.scale.setScalar(Ee), n.visible = true;
        }
      } else if (Se.type === "frame" && ge) {
        const Me = ge[Se.idx], Fe = V(Me[0]), Oe = V(Me[1]);
        if (Fe && Oe) {
          const Ge = Fe.clone().add(Oe).multiplyScalar(0.5), Ee = Oe.clone().sub(Fe), tt = Ee.length(), Ye = Math.max(1e-4, 3.5 * ve(Ge));
          c.position.copy(Ge);
          const Ze = new te(0, 1, 0), $e = Ze.clone().cross(Ee).normalize(), Be = Ze.angleTo(Ee);
          c.quaternion.setFromAxisAngle($e, Be), c.scale.set(Ye, tt, Ye), c.visible = true;
        }
      } else if (Se.type === "shell" && ge) {
        const Me = ge[Se.idx], Fe = [], Oe = [];
        for (const Ge of Me) {
          const Ee = V(Ge);
          if (!Ee) return;
          Fe.push(Ee.x, Ee.y, Ee.z);
        }
        Me.length === 4 ? Oe.push(0, 1, 2, 0, 2, 3) : Me.length === 3 && Oe.push(0, 1, 2), d.setAttribute("position", new Mt(Fe, 3)), d.setIndex(Oe), d.computeVertexNormals(), f.visible = true;
      } else if (Se.type === "solid" && ge) {
        const Me = ge[Se.idx], Fe = [
          [
            0,
            1
          ],
        ...
        for (const [Ge, Ee] of Fe) {
          const tt = V(Me[Ge]), Ye = V(Me[Ee]);
          tt && Ye && Oe.push(tt.x, tt.y, tt.z, Ye.x, Ye.y, Ye.z);
        }
      ...
      W.textContent = Se.info, W.style.whiteSpace = "pre-line", W.style.display = "block";
    ...
    let R = "", X = 0, Q = 0;
    const re = window.__hekatanHoverDebug ?? false, ue = (Se) => {
      X && cancelAnimationFrame(X), X = requestAnimationFrame(() => {
        var _a2, _b, _c2;
        const ce = q(Se.clientX, Se.clientY);
        if (re && Q < 5) {
          const ge = l.derivedNodes.rawVal, xe = (_b = (_a2 = l.mesh) == null ? void 0 : _a2.elements) == null ? void 0 : _b.rawVal;
          console.log(`[hover] pointer (${Se.clientX}, ${Se.clientY}) nodes=${(ge == null ? void 0 : ge.length) ?? 0} elems=${(xe == null ? void 0 : xe.length) ?? 0} hover=`, ce), Q++;
        }
        const _e = ce ? `${ce.type}:${ce.idx}` : "";
        if (_e !== R) R = _e, D(ce, Se.clientX, Se.clientY);
        else if (ce) {
          const ge = ((_c2 = l.rendererElm.parentElement) == null ? void 0 : _c2.getBoundingClientRect()) ?? l.rendererElm.getBoundingClientRect();
          W.style.left = `${Se.clientX - ge.left}px`, W.style.top = `${Se.clientY - ge.top}px`;
        }
      });
    };
    let be = null;
    const le = () => {
      ...
      const ce = l.rendererElm.getBoundingClientRect(), _e = Se.clientX - ce.left, ge = Se.clientY - ce.top;
      (_e < -2 || ge < -2 || _e > ce.width + 2 || ge > ce.height + 2) && (be && clearTimeout(be), be = window.setTimeout(le, 200));
    }, ae = () => {
      be && (clearTimeout(be), be = null);
    };
    l.rendererElm.addEventListener("pointermove", ue), l.rendererElm.addEventListener("pointerleave", ie), l.rendererElm.addEventListener("pointerenter", ae);
    function he() {
      var _a2, _b, _c2;
      const Se = ((_c2 = (_b = (_a2 = window.__hekatanCadState) == null ? void 0 : _a2.get) == null ? void 0 : _b.call(_a2)) == null ? void 0 : _c2.tool) ?? "select";
      return Se === "select" || Se === "none" || !Se;
    }
    let pe = null;
    l.rendererElm.addEventListener("pointerdown", (Se) => {
      Se.button === 0 && (pe = {
        x: Se.clientX,
        y: Se.clientY
      });
    }), l.rendererElm.addEventListener("pointerup", (Se) => {
      if (Se.button !== 0 || !pe) return;
      const ce = Se.clientX - pe.x, _e = Se.clientY - pe.y;
      if (pe = null, ce * ce + _e * _e > 9 || !he()) return;
      const ge = q(Se.clientX, Se.clientY);
      ge ? (ot({
        type: ge.type,
        idx: ge.idx
      }, Se.shiftKey), Ve()) : yt();
    }), window.addEventListener("keydown", (Se) => {
      if (Se.key !== "Escape" || !U.length) return;
    ...
    function Ce() {
      for (const Se of G.children.slice()) {
        G.remove(Se);
        const ce = Se.geometry;
    ...
    const ve = (Se) => {
      ...
      return ce.isOrthographicCamera ? (ce.top - ce.bottom) / (ce.zoom || 1) / _e : 2 * ce.position.distanceTo(Se) * Math.tan((ce.fov || 50) * Math.PI / 180 / 2) / _e;
    };
    function Ae(Se, ce) {
      var _a2, _b;
      ...
      if (Se.type === "node") {
      ...
      } else if (Se.type === "frame" && _e) {
        const ge = _e[Se.idx], xe = V(ge[0]), Ne = V(ge[1]);
        if (!xe || !Ne) return;
        const ze = xe.clone().add(Ne).multiplyScalar(0.5), Me = Ne.clone().sub(xe), Fe = Me.length(), Oe = Math.max(1e-4, 4 * ve(ze)), Ge = new pt(A, S);
        Ge.position.copy(ze);
        const Ee = new te(0, 1, 0);
        Ge.quaternion.setFromAxisAngle(Ee.clone().cross(Me).normalize(), Ee.angleTo(Me)), Ge.scale.set(Oe, Fe, Oe), Ge.renderOrder = 101, G.add(Ge);
      } else if (Se.type === "shell" && _e) {
        const ge = _e[Se.idx], xe = [], Ne = [];
        for (const Fe of ge) {
          const Oe = V(Fe);
          if (!Oe) return;
      ...
      } else if (Se.type === "solid" && _e) {
        const ge = _e[Se.idx], xe = [
          [
            0,
            1
          ],
        ...
        for (const [Fe, Oe] of xe) {
          const Ge = V(ge[Fe]), Ee = V(ge[Oe]);
          Ge && Ee && Ne.push(Ge.x, Ge.y, Ge.z, Ee.x, Ee.y, Ee.z);
        }
        const ze = new Ie();
    ...
    function Ve() {
      if (Ce(), !U.length || !l.mesh) {
        l.render();
        return;
      }
      const Se = l.derivedNodes.rawVal ?? [];
      if (Se.length >= 2) {
        const ce = [
          1 / 0,
          1 / 0,
        ...
        for (const ge of Se) for (let xe = 0; xe < 3; xe++) ge[xe] < ce[xe] && (ce[xe] = ge[xe]), ge[xe] > _e[xe] && (_e[xe] = ge[xe]);
    ...
    function ot(Se, ce) {
      const _e = U.findIndex((ge) => ge.type === Se.type && ge.idx === Se.idx);
      _e >= 0 ? U.splice(_e, 1) : ce || U.push(Se), U.length && U[U.length - 1];
    }
    function yt() {
      U.length = 0, Ve();
    }
  ...
  function oc(l, e) {
    ...
    function r() {
      ...
      W.innerHTML = V.map(($e, Be) => `<option value="${$e}" ${Math.abs($e - s.en) < Os ? "selected" : ""}>${D} ${Be + 1} \xB7 ${q} = ${$e.toFixed(2)} m</option>`).join("");
      ...
      P.innerHTML = "";
      const ue = P.clientWidth || 880, be = P.clientHeight || 480, le = [];
      if (Q.forEach(($e, Be) => {
        if ($e.length !== 2) return;
        const Rt = X[$e[0]], at = X[$e[1]];
        if (!Rt || !at) return;
      ...
      let ie = 1 / 0, ae = -1 / 0, he = 1 / 0, pe = -1 / 0;
      for (const $e of le) for (const Be of [
        $e.a,
        $e.b
      ]) ie = Math.min(ie, Be.u), ae = Math.max(ae, Be.u), he = Math.min(he, Be.v), pe = Math.max(pe, Be.v);
      const Ce = ae - ie || 1, ve = pe - he || 1, Ae = 0.12 * Math.max(Ce, ve), Ve = 46, ot = Math.min((ue - 2 * Ve) / (Ce + 2 * Ae), (be - 2 * Ve) / (ve + 2 * Ae)), yt = (ue - Ce * ot) / 2, Se = (be - ve * ot) / 2, ce = ($e) => yt + ($e - ie) * ot, _e = ($e) => be - (Se + ($e - he) * ot), ge = "http://www.w3.org/2000/svg", xe = ($e, Be, Rt) => {
        const at = document.createElementNS(ge, $e);
        for (const At in Be) at.setAttribute(At, String(Be[At]));
        return Rt != null && (at.textContent = Rt), P.appendChild(at), at;
      }, Ne = /* @__PURE__ */ new Map();
      for (const $e of le) {
        const Be = ((_h = (_g = (_f = (_e2 = l.elementInputs) == null ? void 0 : _e2.rawVal) == null ? void 0 : _f.localAngles) == null ? void 0 : _g.get) == null ? void 0 : _h.call(_g, $e.i)) ?? 0, Rt = Dn(ll(R ?? "normals", al(X[Q[$e.i][0]], X[Q[$e.i][1]], Be)), s.plano), at = Math.hypot(Rt.u, Rt.v);
        Ne.set($e.i, at > 0.3 ? [
          Rt.u / at,
          -Rt.v / at
        ] : null);
      }
      const ze = le.filter(($e) => !Ne.get($e.i)).length;
      let Me = 0;
      if (re) for (const $e of le) {
        if (!Ne.get($e.i)) continue;
        const Be = re instanceof Map ? re.get($e.i) : re[$e.i];
        Be && (Me = Math.max(Me, Math.abs(Be[0] ?? 0), Math.abs(Be[1] ?? 0)));
      }
      const Fe = 0.12 * Math.max(Ce, ve) * ot, Oe = Me > 0 ? Fe / Me : 0, Ge = R === "bendingsY" || R === "bendingsZ", Ee = ($e) => Math.abs($e) >= 100 ? $e.toFixed(1) : Math.abs($e) >= 10 ? $e.toFixed(2) : $e.toFixed(3), tt = [];
      for (const $e of le) {
        const Be = ce($e.a.u), Rt = _e($e.a.v), at = ce($e.b.u), At = _e($e.b.v), qt = Ne.get($e.i), [lt, Qe] = qt ?? [
          0,
          0
        ], Pe = re && qt ? re instanceof Map ? re.get($e.i) : re[$e.i] : null, [st, De] = Pe ? $o(R, Pe) : [
          0,
          0
        ];
        if (Pe && Oe > 0) {
          ...
          xe("polygon", {
            points: `${Be},${Rt} ${Ke[0]},${Ke[1]} ${nt[0]},${nt[1]} ${at},${At}`,
            fill: _t,
            "fill-opacity": 0.38,
            stroke: _t,
            "stroke-width": 1.2
      ...
      const Ye = [];
      tt.sort(($e, Be) => Be.peso - $e.peso);
      for (const $e of tt) $e.peso < 0.02 * Me || Ye.some((Be) => Math.hypot(Be.x - $e.x, Be.y - $e.y) < 34) || (Ye.push($e), xe("text", {
        x: $e.x,
        y: $e.y + 4,
        "text-anchor": "middle",
        fill: "#f2f5fa",
      ...
      H.textContent = `${Ze} \xB7 ${s.plano === "XY" ? "planta" : "alzado"} ${s.plano} en ${q} = ${s.en.toFixed(2)} m`, U.textContent = R ? `${le.length} barras en el plano \xB7 m\xE1ximo ${Ee(Me)} ${nc[R] ?? ""}` + (Ge ? " \xB7 el momento va del lado de la tracci\xF3n" : "") + (ze ? ` \xB7 ${ze} barra(s) con este resultado en otro plano (sin dibujar)` : "") + " \xB7 clic en una barra: su gr\xE1fico" : "Eleg\xED un resultado en \xABFrame results\xBB (Axial, Cortante, Momento) para ver su diagrama aqu\xED.";
    }
    const c = () => {
      try {
        r();
    ...
    function S() {
      ...
      let W = 0, V = -1;
      U.forEach((ae, he) => {
        const [pe, Ce] = P[ae], ve = he === 0 ? U.length > 1 && P[U[1]].includes(pe) : pe !== V, Ae = ve ? Ce : pe, Ve = ve ? pe : Ce, ot = Math.hypot(A[Ve][0] - A[Ae][0], A[Ve][1] - A[Ae][1], A[Ve][2] - A[Ae][2]);
        G.push({
          x: W,
          e: ae,
          fin: ve ? 1 : 0
      ...
      const q = W, D = (ae, he) => {
        const pe = H[ae], Ce = pe ? pe instanceof Map ? pe.get(he.e) : pe[he.e] : null;
        return Ce ? $o(ae, Ce)[he.fin] : 0;
      ...
      re.innerHTML = "";
      const ue = Math.max(300, re.clientWidth), be = 124, le = 46, ie = (be - 14) / 2;
      for (const [ae, he, pe, Ce] of Q) {
        const ve = G.map((Me) => D(ae, Me)), Ae = Math.max(...ve), Ve = Math.min(...ve), ot = Math.max(Math.abs(Ae), Math.abs(Ve)) || 1, yt = (Me) => le + Me / (q || 1) * (ue - 2 * le), Se = (Me) => ie + (Ce ? 1 : -1) * (Me / ot) * (ie - 16), ce = (Me) => Math.abs(Me) >= 100 ? Me.toFixed(1) : Math.abs(Me) >= 10 ? Me.toFixed(2) : Me.toFixed(3);
        let _e = yt(0) + "," + ie + " ";
        G.forEach((Me, Fe) => {
          _e += yt(Me.x) + "," + Se(ve[Fe]) + " ";
        }), _e += yt(q) + "," + ie;
        const ge = ve.indexOf(Ae), xe = ve.indexOf(Ve), Ne = (Me, Fe) => {
          const Oe = Se(ve[Me]) + (Se(ve[Me]) < ie ? -5 : 13);
          return '<text x="' + yt(G[Me].x) + '" y="' + Oe + '" text-anchor="middle" fill="' + Fe + '" font-size="11" font-weight="700" paint-order="stroke" stroke="#0b0e14" stroke-width="3">' + ce(ve[Me]) + "</text>";
        }, ze = Ce ? "#d9534f" : "#3fa7d6";
        re.insertAdjacentHTML("beforeend", '<div style="display:flex;justify-content:space-between;margin-top:4px"><b style="color:#dbe6f5">' + he + ' <span style="color:#6f7d90;font-weight:400">(' + pe + ')</span></b><span style="color:#9fb0c6">m\xE1x ' + ce(Ae) + " \xB7 m\xEDn " + ce(Ve) + (Ce ? " \xB7 positivo hacia abajo" : "") + '</span></div><svg width="' + ue + '" height="' + be + '" style="display:block;background:#0e131c;border-radius:4px"><line x1="' + le + '" y1="' + ie + '" x2="' + (ue - le) + '" y2="' + ie + '" stroke="#e6ecf5" stroke-width="2"/><polygon points="' + _e + '" fill="' + ze + '" fill-opacity=".35" stroke="' + ze + '" stroke-width="1.4"/>' + Ne(0, "#f2f5fa") + Ne(G.length - 1, "#f2f5fa") + (ge > 0 && ge < G.length - 1 ? Ne(ge, "#8fd3ff") : "") + (xe > 0 && xe < G.length - 1 && xe !== ge ? Ne(xe, "#ff9f9a") : "") + '<text x="' + le + '" y="' + (be - 3) + '" fill="#6f7d90" font-size="10" text-anchor="middle">0</text><text x="' + (ue - le) + '" y="' + (be - 3) + '" fill="#6f7d90" font-size="10" text-anchor="middle">' + q.toFixed(2) + " m</text></svg>");
      }
    }
  ...
  yd = function({ mesh: l, settingsObj: e, drawingObj: t, objects3D: s, solids: n }) {
    ...
    const _ = fr(e), S = we.derive(() => Math.pow(10, _.displayScale.val / 10)), A = lc(l, _), P = () => {
      const ce = [];
    ...
    we.derive(() => {
      ...
      (((_b = l == null ? void 0 : l.nodes) == null ? void 0 : _b.rawVal) ?? ((_c2 = l == null ? void 0 : l.nodes) == null ? void 0 : _c2.val) ?? []).length > 0 || (xe ? a.position.set(0, 0, ge) : a.position.set(0.5 * ce, -ge, 0.5 * ce), p.target.set(0, 0, 0)), p.minDistance = Math.max(0.05, ce * 0.01), p.maxDistance = Math.max(50, ce * 50), p.update(), ae();
      ...
      for (const _e of ce) {
        ...
        if (r.left = -Me * ze, r.right = Me * ze, r.updateProjectionMatrix(), be && be.isPerspectiveCamera) be.aspect = ze, be.updateProjectionMatrix();
          ...
          const Fe = be, Oe = Fe.top;
          Fe.left = -Oe * ze, Fe.right = Oe * ze, Fe.updateProjectionMatrix();
        }
        d.setSize(ge, xe), ae();
      }
    }).observe(i), p.addEventListener("change", ae), we.derive(() => {
      var _a2, _b, _c2, _d2, _e, _f, _g, _h, _i2;
    ...
    let ue = false, be = null, le = null, ie = false;
    function ae() {
    ...
    function pe(ce, _e) {
      ...
      if (r.left = -Me * ze, r.right = Me * ze, r.updateProjectionMatrix(), ce && be) {
        if (le ? (le.object = be, le.update()) : (le = new Sa(be, d.domElement), le.enableDamping = true, le.dampingFactor = 0.1, le.screenSpacePanning = true, le.zoomSpeed = 0.8, le.panSpeed = 1.2, le.rotateSpeed = 0.9, le.touches = {
          ...
          const Fe = (Oe) => {
            if (!ue || !le) return;
            const Ge = d.domElement.getBoundingClientRect(), Ee = Oe.clientX - Ge.left, tt = Ge.width / 2, Ye = Ee >= tt;
            p.enabled = !Ye, le.enabled = Ye;
          };
          d.domElement.addEventListener("pointerdown", Fe, true), d.domElement.addEventListener("wheel", Fe, {
            capture: true,
            passive: true
          }), ie = true;
        }
    ...
    if (l) {
      o.add(mr(_, A, S), xr(l, _, A), kr(_, A, S), Cr(l, _, A, S), vr(l, _, A, S), _r(l, _, A, S), $r(l, _, A, S), Ar(l, _, A, S), Fr(l, _, A), Lr(l, _, A, S), Pr(l, _, A, S)), window.__hekatanDiagrama2D || (oc(l, _), d.domElement.addEventListener("dblclick", () => {
        var _a2;
        const Fe = (_a2 = _.frameResults) == null ? void 0 : _a2.rawVal;
        !Fe || Fe === "none" || !(window.__hekatanModelSelection ?? []).some((Ge) => Ge.type === "frame") || setTimeout(() => {
          var _a3;
      ...
      o.add(ce);
      const _e = pc(l, _), ge = Vr(l, _, A, _e), xe = Ra(_e);
      o.add(ge), i.appendChild(xe);
      const Ne = jr(l, _, A);
      o.add(Ne);
      const ze = Ne.__colorMapValues, Me = Ra(ze);
      Me.id = "frame-legend", i.appendChild(Me), we.derive(() => {
        var _a2;
        const Fe = _.shellResults.val != "none", Oe = (((_a2 = _.solidResults) == null ? void 0 : _a2.val) ?? "none") !== "none", Ge = Fe || Oe, Ee = _.frameResults.val.startsWith("contour:"), tt = _e.val.some((Ye) => Number.isFinite(Ye));
        xe.hidden = !Ge || !tt, ge.visible = Ge, Me.hidden = !Ee;
      });
    }
    if (n) {
      ...
      xe.color.setHSL(11, 43, 96), xe.position.set(-10, 0, 30), o.add(xe), we.derive(() => {
        ...
        n.rawVal.forEach((Ne) => Ne.visible = _.solids.val), ae();
      });
    }
    if (s) {
      const ce = [], _e = (xe) => {
      ...
      we.derive(() => {
        const xe = s.val;
        ce.length && (o.remove(...ce), ce.length = 0), xe.length && (o.add(...xe), ce.push(...xe), ge(), d.clippingPlanes.length && C()), ae();
      }), we.derive(() => {
        _.custom3D.val, ge();
      }), we.derive(() => {
        _.showCotas.val, ge();
    ...
    const Ae = (ce, _e, ge) => {
      ...
      const Fe = Ne * 0.05;
      ge.addScaledVector(ze, -ce * Fe), ge.addScaledVector(Me, _e * Fe), c.position.addScaledVector(ze, -ce * Fe), c.position.addScaledVector(Me, _e * Fe), p.update(), ae();
    }, ot = (ce) => {
  ...
  function pc(l, e) {
    ...
    return ((n) => {
      ...
      const n = /* @__PURE__ */ new Map(), i = /* @__PURE__ */ new Map(), o = /* @__PURE__ */ new Map(), a = /* @__PURE__ */ new Map(), r = /* @__PURE__ */ new Map(), c = /* @__PURE__ */ new Map(), d = /* @__PURE__ */ new Map(), p = /* @__PURE__ */ new Map(), f = /* @__PURE__ */ new Map(), x = /* @__PURE__ */ new Map(), b = (xe, Ne) => {
        xe == null ? void 0 : xe.forEach((ze, Me) => {
          const Fe = l.elements.val[Me];
          if (Fe) for (let Oe = 0; Oe < Fe.length; Oe++) Ne.set(Fe[Oe], [
            ze[Oe] ?? ze[0]
          ]);
        });
      ...
      const A = /* @__PURE__ */ new Map(), P = /* @__PURE__ */ new Map(), H = /* @__PURE__ */ new Map(), U = /* @__PURE__ */ new Map(), G = /* @__PURE__ */ new Map(), W = (xe, Ne, ze, Me, Fe) => {
        xe.forEach((Oe, Ge) => {
          var _a3, _b2;
          const Ee = Oe[0] ?? 0, tt = ((_a3 = Ne.get(Ge)) == null ? void 0 : _a3[0]) ?? 0, Ye = ((_b2 = ze.get(Ge)) == null ? void 0 : _b2[0]) ?? 0, Ze = (Ee + tt) / 2, $e = Math.hypot((Ee - tt) / 2, Ye);
          Me.set(Ge, [
            Ze + $e
          ]), Fe.set(Ge, [
            Ze - $e
      ...
      }, re = e.shellResults.val, ue = rc.val, be = cc.val, le = re === "displacementX" || re === "displacementY" || re === "displacementZ", ie = re === "bendingXX" || re === "bendingYY" || re === "bendingXY" || re === "bendingPrincipalMax" || re === "bendingPrincipalMin", ae = re === "membraneXX" || re === "membraneYY" || re === "membraneXY" || re === "membranePrincipalMax" || re === "membranePrincipalMin", he = re === "vonMises" || re === "pressure", pe = re === "tranverseShearX" || re === "tranverseShearY" || re === "transverseShearMax", Ce = (_E = e.solidResults) == null ? void 0 : _E.val, ve = Ce === "vonMises" || Ce === "sigmaXX" || Ce === "sigmaYY" || Ce === "sigmaZZ" || Ce === "tauXY" || Ce === "tauYZ" || Ce === "tauXZ", Ae = Ce === "ux" || Ce === "uy" || Ce === "uz", Ve = dc.val, ot = ve ? uc[Ve] : Ae || le ? La[be] : ie || ae || he || pe ? 1 / hc[ue] : 1, yt = ve ? Ve : Ae || le ? be : ie ? `${ue}\xB7m/m` : ae ? `${ue}/m\xB2` : he ? `${ue}/m\xB2` : pe ? `${ue}/m` : "";
      Eo.val = yt, jn.val = Array.isArray(X) && X.length === 2 ? [
        X[0] * ot,
        X[1] * ot
      ] : null;
      const Se = il.val, _e = Ce && Ce !== "none" ? [
        f,
        0
      ] : Q[re], ge = [];
      if (l.nodes.val.forEach((xe, Ne) => {
        ...
        const Me = ze[0].get(Ne), Fe = Me ? Me[ze[1]] ?? 0 : 0;
        ge.push(Fe * ot);
      }), !jn.val && Se !== "auto") {
        const xe = l.nodes.val, Ne = /* @__PURE__ */ new Set(), ze = (Fe, Oe) => {
          var _a3;
          const Ge = (_a3 = xe[Fe[0]]) == null ? void 0 : _a3[Oe];
          return Fe.every((Ee) => {
            var _a4;
            return Math.abs((((_a4 = xe[Ee]) == null ? void 0 : _a4[Oe]) ?? NaN) - Ge) < 1e-6;
          });
        };
        for (const Fe of l.elements.val) {
          if (Fe.length !== 4) continue;
          const Oe = ze(Fe, 2), Ge = !Oe && ze(Fe, 0), Ee = !Oe && ze(Fe, 1);
          if (Se === "losas" ? Oe : Se === "muros" ? Ge || Ee : Se === "murosX" ? Ge : Se === "murosY" ? Ee : false) for (const Ze of Fe) Ne.add(Ze);
        }
        const Me = [];
        for (const Fe of Ne) {
          const Oe = ge[Fe];
...
`, " - or if errorr ", {
  ...
  let ct = new ut(), Jt = new yc(), hl = new gc(), Ln = new wc();
  xc = class extends rn {
    constructor(e) {
...
`)), C.push({
    ...
    resizeRecords() {
      ...
      function G(ie, ae, he) {
        let pe = "", Ce = "";
        var ve;
        pe += '<tr class="' + (ie % 2 ? "w2ui-even" : "w2ui-odd") + ' w2ui-empty-record" recid="-none-" style="height: ' + ae + 'px">', Ce += '<tr class="' + (ie % 2 ? "w2ui-even" : "w2ui-odd") + ' w2ui-empty-record" recid="-none-" style="height: ' + ae + 'px">', he.show.lineNumbers && (pe += '<td class="w2ui-col-number"></td>'), he.show.selectColumn && (pe += '<td class="w2ui-grid-data w2ui-col-select"></td>'), he.show.expandColumn && (pe += '<td class="w2ui-grid-data w2ui-col-expand"></td>'), Ce += '<td class="w2ui-grid-data-spacer" col="start" style="border-right: 0"></td>', he.reorderRows && (Ce += '<td class="w2ui-grid-data w2ui-col-order" col="order"></td>');
        for (let Ve = 0; Ve < he.columns.length; Ve++) {
          var Ae = he.columns[Ve];
          (Ae.hidden || Ve < he.last.colStart || Ve > he.last.colEnd) && !Ae.frozen || (ve = '<td class="w2ui-grid-data" ' + (Ae.attr != null ? Ae.attr : "") + ' col="' + Ve + '"></td>', Ae.frozen ? pe += ve : Ce += ve);
        }
        pe += '<td class="w2ui-grid-data-last"></td> </tr>', Ce += '<td class="w2ui-grid-data-last" col="end"></td> </tr>', h(he.box).find("#grid_" + he.name + "_frecords > table").append(pe), h(he.box).find("#grid_" + he.name + "_records > table").append(Ce);
      }
      let W, V;
      if (0 < p.length) {
...
`;
      ...
      if (U > this.total && this.total !== -1 && (U = this.total), (U = this.searchData.length == 0 || s ? U : this.last.searchIds.length) !== 0 && n.length !== 0 && n.prop("clientHeight") !== 0) {
        ...
        if (D > U && (D = U), R >= U - 1 && (R = U), h(this.box).find("#grid_" + this.name + "_footer .w2ui-footer-right").html((this.show.statusRange ? y.formatNumber(this.offset + D) + "-" + y.formatNumber(this.offset + R) + (this.total != -1 ? " " + y.lang("of") + " " + y.formatNumber(this.total) : "") : "") + (s && this.show.statusBuffered ? " (" + y.lang("buffered") + " " + y.formatNumber(U) + (0 < this.offset ? ", skip " + y.formatNumber(this.offset) : "") + ")" : "")), s || this.fixedBody && !(this.total != -1 && this.total <= this.vs_start)) {
          ...
          if (f < X || f == 1 || this.last.pull_refresh) {
            ...
            for (let ve = parseInt(ae) + 1; ve <= Q; ve++) this.records[ve - 1] && ((ie = this.records[ve - 1].w2ui) && !Array.isArray(ie.children) && (ie.expanded = false), he = this.getRecordHTML(ve - 1, ve), W.before(he[1]), q.before(he[0]));
          } else {
            ...
            for (let ve = parseInt(ae) - 1; ve >= X; ve--) this.records[ve - 1] && ((ie = this.records[ve - 1].w2ui) && !Array.isArray(ie.children) && (ie.expanded = false), he = this.getRecordHTML(ve - 1, ve), G.after(he[1]), V.after(he[0]));
          }
          Ce(), setTimeout(() => {
            this.refreshRanges();
  ...
  let Ro, Oa, Li, Va, ul, Vs, pl, bc, ln, Wn, Zn, Do, vc, _o, Nn, Ba, Ha, Qs, Xa, Ya, fl, _c, Kn, ja, sn;
  Ro = globalThis;
  Oa = (l) => l;
  Li = Ro.trustedTypes;
  Va = Li ? Li.createPolicy("lit-html", {
    createHTML: (l) => l
  }) : void 0;
  ul = "$lit$";
...
`;
  ...
  let Ni = "", Un = "";
  function Oi(l, e) {
    (!ns || !document.body.contains(ns)) && (ns = Yc()), ns.style.display = "flex", Bn.textContent = "\u{1F4C4} " + (l || "Hoja \xB7 Hekatan LISP"), Ni = e, To(), setTimeout(To, 60);
    const t = Wc(e);
    if (t) {
      Un = "", Zc(Ss, t).then((s) => {
        Un = s, s || (Ss.style.padding = "", qa(), Ss.innerHTML = Ao(e));
      });
      return;
    }
    qa(), Ss.style.padding = "", Ss.innerHTML = Ao(e), Ss.scrollTop = 0;
  }
  function jc() {
  ...
  async function Lo(l, e) {
    ...
    switch (l) {
      case "obtener_modelo": {
        ...
        return t === "cli-modeler" ? s.script = String(dt().__hekatanCliScript ?? "").slice(0, 3e3) : t && (s.parametros = Za()), s;
      }
...
solve`), Mi.push(Co()), dt().__hekatanCliStats = null, dt().__hekatanCliScript = t, await So("cli-modeler");
      ...
      case "analisis_modal": {
        ...
        for (let o = 0; o < 100; o++) {
          await Vi(150);
          const a = (_l = (_k = dt()).__hekatanModalResults) == null ? void 0 : _l.call(_k);
...
` : "") + "\u{1F4C4} La explicaci\xF3n, con las f\xF3rmulas, est\xE1 en la hoja de la izquierda."), s = document.createElement("button");
    s.textContent = "Abrir la hoja \u25B8", s.style.cssText = "margin-top:6px;background:#13314f;color:#e8eef5;border:1px solid #2b5480;border-radius:5px;padding:3px 8px;font-size:12px;cursor:pointer;display:block;", s.onclick = () => Oi(Ja(l), l), t.appendChild(s);
  }
  function Ja(l) {
...
`).map((s) => s.trim()).find(Boolean) ?? "").replace(/[*`$]/g, "").slice(0, 60) || "Hoja \xB7 Hekatan LISP";
  ...
  Oo = function(l) {
    Yi(), as || (as = ud()), as.style.display = "flex", No(), setTimeout(() => {
      try {
  ...
  async function vl(l) {
    Oo(), rs.value = l, await Io();
  }
  typeof window < "u" && (dt().__hekatanAgenteIA = Oo, dt().__hekatanPedirAgente = vl, dt().__hekatanAgenteTool = Lo);
})();
export {
  Ut as A,
  Tc as D,
