...
import { h as Lt, i as Et, g as zt, a as Pt, __tla as __tla_1 } from "./aiAgent-nlHwOj_U.js";
              ...
              if (!c) {
                ...
                try {
                  const { modalAnalysis: N } = await ot(async () => {
                    const { modalAnalysis: I } = await import("./index-K1OjVoSK.js").then(async (m2) => {
                      await m2.__tla;
                      return m2;
                    });
                    return {
