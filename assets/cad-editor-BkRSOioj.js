...
import { v as y, V as b, U as q, W as K, u as Q, X as ee, Y as oe, Z as ne, A as se, t as ie, _ as G, $ as k, a0 as te, B as F, b as z, d as N, S as ae, f as re, M as le, F as de, L as ce, P as pe } from "./theme-C-zoknmI.js";
import { O as me, T as M } from "./Text-Cehu0nom.js";
...
function Me() {
  ...
  new ResizeObserver(($) => {
    for (const A of $) {
      ...
      const O = S / X, Z = o.top;
      o.left = -Z * O, o.right = Z * O, o.updateProjectionMatrix(), n.setSize(S, X), C();
    }
