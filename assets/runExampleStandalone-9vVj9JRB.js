...
import { o as bt, t as wt, V as B, u as xt, B as ut, a as ht, d as _t, w as $t, v as K } from "./theme-Dxpmbnyd.js";
import { P as Mt } from "./tweakpane-BXg6ZhiP.js";
import { c as Lt, d as Et, g as zt } from "./getViewer-D6CRppMe.js";
import { g as Pt } from "./styles-DjzQZscE.js";
import { c as Tt } from "./renderModalTable-BJWFR1R0.js";
import { f as nt, d as it, e as Ft, g as It, h as St, i as st, j as Dt, s as lt, k as ct, l as dt, m as pt, n as Nt, o as Ct, p as At, q as Bt, t as Ot, r as jt } from "./units-DYymsd53.js";
let Kt;
let __tla = (async () => {
    ...
    try {
      ...
      if (l == null ? void 0 : l.addFolder) {
        ...
        p.addBinding(h, "limite", {
          ...
          const k = C.rawVal || [], x = Y.rawVal || [], b = (Z.rawVal || {}).deformations;
          if (!b || !b.size) {
