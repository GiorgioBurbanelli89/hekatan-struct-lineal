  ...
  return xe.derive(() => {
    ...
    try {
      x.forEach((A, P) => {
        var _a3, _b2, _c3;
        if (A.length === 2) {
          let X = rr(C.get(P)), q = true;
          if (X || (X = cr((_a3 = b.areas) == null ? void 0 : _a3.get(P), (_b2 = b.momentsOfInertiaY) == null ? void 0 : _b2.get(P), (_c3 = b.momentsOfInertiaZ) == null ? void 0 : _c3.get(P)), q = false), !X) return;
...
function gr({ drawingObj: r, gridObj: e, scene: t, getActiveCamera: s, controls: i, gridSize: n, derivedDisplayScale: o, rendererElm: a, viewerRender: l }) {
  ...
  ws.id = "hk-refplane-badge", ws.style.cssText = ["position:fixed", "pointer-events:none", "z-index:99997", "padding:3px 10px", "border-radius:4px", "font-family:Consolas,monospace", "font-size:12px", "font-weight:bold", "transform:translate(20px,40px)", "white-space:nowrap", "display:none"].join(";") + ";", document.body.appendChild(ws), window.__hekatanSetOrthoPlanes = (u) => {
    ...
    if (window.__hekatanShowOrthoPlanes = u, ps.visible = u, u) {
      ...
      $s(Us, E, "xy", k), $s(oi, E, "xz", k), $s(ai, E, "yz", k), Ms(as, E, "xy", k), Ms(fs, E, "xz", k), Ms(ms, E, "yz", k), as.material.opacity = 0.05, fs.material.opacity = 0.05, ms.material.opacity = 0.05;
    } else {
    ...
    $s(Us, E, "xy", u), $s(oi, E, "xz", u), $s(ai, E, "yz", u), Ms(as, E, "xy", u), Ms(fs, E, "xz", u), Ms(ms, E, "yz", u), l();
  };
  const Mo = (u) => {
  ...
  window.__hekatanRevolveSelection = (u, g, y, m = 360) => {
    ...
    const de = (Pe, Xe) => {
      ...
      for (let xt = 0, St = V.length - 1; xt < V.length; St = xt++) {
        ...
        hs > Xe != Ks > Xe && Pe < (fi - Ot) * (Xe - hs) / (Ks - hs) + Ot && (We = !We);
      }
      return We;
  ...
  cs.visible = false, t.add(cs), window.__hekatanShowAxes = (u, g, y = 12, m = 2) => {
    ...
    u.forEach((T, N) => {
      ...
      j.computeLineDistances(), cs.add(j), cs.add(I(F, T, v - 0.5, 0, "#60a5fa")), cs.add(I(F, T, E + 0.5, 0, "#60a5fa"));
    }), g.forEach((T, N) => {
  ...
  window.__hekatanUpdateSelectionPtScale = Oo, i.addEventListener("change", () => {
    var _a3;
    Mi(), ls.visible && Ao(), (_a3 = window.__hekatanUpdateOsnapScale) == null ? void 0 : _a3.call(window), Oo();
    ...
    if ((!y.length || ((_c2 = (_b = (_a3 = window.__hekatanCadState) == null ? void 0 : _a3.get) == null ? void 0 : _b.call(_a3)) == null ? void 0 : _c2.tool) !== "fillarea") && _t.visible && (_t.visible = false), y.length) {
      ...
      if ($ === "select" || !$) {
        const F = (window.__hekatanSnap2D ?? 0.5) * 1.5, L = tl(m.x, m.y, m.z, F), Y = Pn(m.x, m.y, m.z, F), j = To(m.x, m.y, m.z, F);
        if (L >= 0) {
          const H = r.points.rawVal[L];
          ls.position.set(H[0], H[1], H[2]), ls.visible = true, Ao(), ys.visible = false, bs = { kind: "pt", a: L };
        } else if (Y) {
      ...
      if ($ === "delete" || $ === "trim" || $ === "extend" || $ === "offset") {
        const F = (window.__hekatanSnap2D ?? 0.5) * 1.5, L = Pn(m.x, m.y, m.z, F), Y = To(m.x, m.y, m.z, F);
        let j = false;
        if (Y >= 0) if (!L) j = true;
        else {
      ...
      if (T.length > 0 && N[T[T.length - 1]]) {
        ...
        if (!Y && !j && z) {
          ...
          if (Je > 1e-3) {
            ...
            St.sort((Ot, hs) => Ot[1] - hs[1]), St[0][1] <= Pe && (Y = St[0][0]);
          }
        }
        if (Y) {
  ...
  const Go = (u, g) => {
    ...
    qe = [], Re.visible = false;
    let E = 0;
    u === "move" ? E = Ko(v[0], v[1], v[2]) : (E = Zo().size, (_c2 = window.__hekatanReplicateSelection) == null ? void 0 : _c2.call(window, v[0], v[1], v[2], 1)), we(`\u2713 ${u === "move" ? "Movidos" : "Copiados"} ${E} nudo${E === 1 ? "" : "s"} \u2014 \u0394 (${v[0].toFixed(2)}, ${v[1].toFixed(2)}, ${v[2].toFixed(2)}) m.`), u === "move" && (Ue.clear(), rs()), (_e2 = (_d = window.__hekatanCadState) == null ? void 0 : _d.setTool) == null ? void 0 : _e2.call(_d, "select"), ss();
  };
  ...
  const gl = () => {
    ...
    if (u === "offset") {
      ...
      for (let De = 0; De < O.length - 1; De++) {
        const Je = m[O[De]], Be = m[O[De + 1]], Pe = [Be[0] - Je[0], Be[1] - Je[1], Be[2] - Je[2]], Xe = Math.hypot(Pe[0], Pe[1], Pe[2]) || 1, We = Pe[0] / Xe, xt = Pe[1] / Xe, St = Pe[2] / Xe, Ot = [V[1] * St - V[2] * xt, V[2] * We - V[0] * St, V[0] * xt - V[1] * We], hs = Math.hypot(Ot[0], Ot[1], Ot[2]) || 1;
...
function zr(r) {
  ...
  C.visible = false, C.renderOrder = 100, e.add(C);
  const _ = new gt({ color: wn, transparent: true, opacity: 0.95, depthTest: false }), S = new gt({ color: wn, transparent: true, opacity: 0.85, depthTest: false }), A = new da(1, 1, 1, 12), P = new gt({ color: wn, transparent: true, opacity: 0.55, side: Pt, depthTest: false }), X = new mt({ color: wn, linewidth: 4, transparent: true, opacity: 1, depthTest: false }), q = [];
...
function Mc({ mesh: r, settingsObj: e, drawingObj: t, objects3D: s, solids: i }) {
  ...
  const _ = ql(e), S = xe.derive(() => Math.pow(10, _.displayScale.val / 10)), A = Or(r, _), P = () => {
    const ce = [];
...
async function yc(r, e, t, s) {
  ...
  const n = r.id === "ollama", o = [{ role: "system", content: gc }, ...Di], a = n ? { model: e, stream: false, options: { temperature: 0.1, num_ctx: 16384 }, tools: go.map((h) => ({ type: "function", function: h })), messages: o.map((h) => h.tool_calls ? { ...h, tool_calls: h.tool_calls.map((p) => ({ function: { name: p.function.name, arguments: typeof p.function.arguments == "string" ? JSON.parse(p.function.arguments || "{}") : p.function.arguments } })) } : h) } : { model: e, messages: o, temperature: 0.1, tool_choice: "auto", tools: go.map((h) => ({ type: "function", function: h })) }, l = await fetch(n ? "http://localhost:11434/api/chat" : r.url, { method: "POST", headers: i, signal: s, body: JSON.stringify(a) }).catch((h) => {
    ...
    if (r.id === "ollama") {
      ...
      throw new Error(p ? "Desde el sitio publico el navegador NO deja llegar a Ollama de tu PC (proteccion de red privada de Chrome/Edge), aunque Ollama este abierto. Opciones: abre Hekatan Struct en local, o elige aqui arriba un proveedor en la nube (Gemini tiene clave gratis en aistudio.google.com/apikey)." : "Ollama no responde en localhost:11434. Abrelo o instala: ollama.com \u2192 ollama pull qwen2.5:7b");
    }
...
function vc() {
  ...
  f.style.cssText = "display:flex;gap:6px;padding:8px 10px;border-top:1px solid #1e293b;", us = document.createElement("textarea"), us.rows = 2, us.placeholder = "Ej.: edificio de 4 pisos, 3\xD72 vanos de 5 m; dime la flecha y el periodo", us.style.cssText = i + "flex:1;resize:none;font-size:13px;", ["keydown", "keyup", "keypress"].forEach((A) => us.addEventListener(A, (P) => P.stopPropagation())), us.addEventListener("keydown", (A) => {
