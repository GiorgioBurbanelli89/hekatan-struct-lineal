...
import { u as G, r as Be, _ as We, L as Ue, B as ve, b as Ye, f as Xe, D as Ve, M as Ke, v as ue, F as pe, a4 as _e, a5 as Ge, a3 as qe } from "./theme-C-zoknmI.js";
...
function xt(D, e, t) {
  const i = Be(), s = new We(), l = new Ue(new ve(), new Ye({ color: i.elementLine, vertexColors: false, depthTest: false, transparent: true, opacity: 1 }));
  _e((u, p) => {
    l.material.color.setHex(p.elementLine);
  }), l.frustumCulled = false, l.renderOrder = 3, s.add(l);
...
function kt({ buttons: D, clickedButton: e, author: t, sourceCode: i }) {
  ...
  const r = ge`
    ...
    <div id="dropdown-menu" style="display: none;">
      ...
      >
      ${t ? ge`<a href="${t}" class="dropdown-link">Contacto · Jorge Burbano (LinkedIn)</a>` : ""}
