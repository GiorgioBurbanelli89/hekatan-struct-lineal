...
import { a as Ht, __tla as __tla_0 } from "./analyze-BNmKymcK.js";
import { d as Rt, __tla as __tla_1 } from "./didacticCpp-BoYi16rL.js";
import { g as Yt, j as vt, l as gt, m as xt, c as Zt, __tla as __tla_2 } from "./aiAgent-CDkRN2K5.js";
import { e as Jt } from "./makeDraggable-zx2br6Yh.js";
import { g as Kt, __tla as __tla_3 } from "./getParameters-C2E0DZJg.js";
...
Promise.all([
  ...
  s.derive(() => {
    ...
    let z = {}, D = {};
    try {
      z = Rt(u, g, pt, j), D = Ht(u, g, j, z);
    } catch (t) {
      console.warn("Viga doble T asim deform/analyze:", (t == null ? void 0 : t.message) ?? t);
    }
    const V = P * r, $ = F * d, H = w * v, ut = V + $ + H, _t = r / 2, ft = r + d / 2, bt = r + d + v / 2, b = (V * _t + $ * ft + H * bt) / ut, Tt = P * r ** 3 / 12, Ct = F * d ** 3 / 12, Gt = w * v ** 3 / 12, B = Tt + V * (_t - b) ** 2 + Ct + $ * (ft - b) ** 2 + Gt + H * (bt - b) ** 2, R = N * a, Ut = r + d + v - b, Lt = b, jt = R * Ut / B, Dt = -(R * Lt) / B, Y = -(N * a * a * a) / (3 * J * B);
    let Z = 0;
    const ht = D == null ? void 0 : D.vonMises;
    ...
    Bt.val = {
      ...
      delta_he: S,
      errPct: Vt
    }, Mt.val = u, wt.val = g, Pt.val = pt, kt.val = j, It.val = z, zt.val = D;
  });
  const St = Yt({
    mesh: {
      nodes: Mt,
  ...
  document.body.append(Kt(i), St, Zt({
