...
import { a as L } from "./analyze-C-HJ03ae.js";
import { d as P, __tla as __tla_0 } from "./didacticCpp-CzlDWovh.js";
import { g as R, a as W, __tla as __tla_1 } from "./aiAgent-8aEjWUw7.js";
import { g as E } from "./getParameters-UinN8YVe.js";
...
Promise.all([
  ...
  n.derive(() => {
    const c = p.span.value.val, w = p.towerH.value.val, d = p.deckH.value.val, u = p.deckW.value.val, o = Math.round(p.nSpanDiv.value.val), g = p.loadDeck.value.val, a = [], s = [];
    for (let e = 0; e <= o; e++) {
      const t = c * e / o;
      a.push([
        t,
