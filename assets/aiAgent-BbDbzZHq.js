...
import { l as Et, a0 as xi, a1 as Wl, v as we, a2 as Zl, D as Rt, M as pt, B as Fe, F as Mt, a3 as Kl, q as vt, a4 as Gl, a5 as Jl, a6 as wa, h as xa, a7 as ba, Y as Hs, a8 as Ai, a9 as Ti, $ as qn, H as ft, L as is, b as gt, f as yt, p as el, c as Ql, aa as er, V as te, I as an, J as Bt, ab as ho, u as Hi, d as Vt, a as uo, A as tl, k as Ri, t as tr, s as Xn, P as sr, ac as zi, n as po, m as nr, w as Ns, X as Pn, E as va, S as vn, ad as fo, ae as Rn, g as _a, i as ka, j as Ca, C as Sa, x as ir, y as or, z as ar, W as lr, G as Ma, af as bi, N as mo, O as rr, ag as cr, _ as dr } from "./Text-Br8EG2up.js";
...
let __tla = (async () => {
  class nl {
    ...
    setColorMap(e, t = 32) {
      ...
      const s = 1 / this.n, n = new Et(), i = new Et();
      this.lut.length = 0, this.lut.push(new Et(this.map[0][1]));
      for (let o = 1; o < t; o++) {
        const a = o * s;
        for (let r = 0; r < this.map.length - 1; r++) if (a > this.map[r][0] && a <= this.map[r + 1][0]) {
          ...
          const p = new Et().lerpColors(n, i, (a - c) / (d - c));
          this.lut.push(p);
        }
      }
      return this.lut.push(new Et(this.map[this.map.length - 1][1])), this;
    }
    copy(e) {
    ...
    updateCanvas(e) {
      ...
      let i = 0;
      const o = 1 / this.n, a = new Et(), r = new Et(), c = new Et();
  ...
  fr = function(l, e, t) {
    ...
    return i.renderOrder = -1, i.frustumCulled = false, i.userData.isShellArea = true, i.name = "__hekatan_shell_colormap", we.derive(() => {
      ...
      i.geometry.setAttribute("scalar", new vt(S, 1));
    }), i;
  };
  function mr(l, e, t) {
  ...
  const wr = new Et(16746496), xr = new Et(52428), Aa = new Et(52292), Ta = new Et(3377407), za = new Et(16763904);
  function Ia(l, e) {
  ...
  function Fa(l, e, t, s, n, i, o = 8) {
    ...
    for (let ie = 0; ie <= o; ie++) {
      const le = ie / o, he = 1 - 3 * le * le + 2 * le * le * le, pe = x * (le - 2 * le * le + le * le * le), Se = 3 * le * le - 2 * le * le * le, ve = x * (-le * le + le * le * le), Ae = he * W + pe * R + Se * V + ve * X, Ve = he * q - pe * Q + Se * D - ve * re, it = ue + (be - ue) * le, wt = [
        l[0] + f[0] * (le * x + it),
        l[1] + f[1] * (le * x + it),
        l[2] + f[2] * (le * x + it)
      ];
  ...
  function vr(l, e, t) {
    const s = Hs(), n = new ft(), i = new is(new Fe(), new gt({
      color: s.elementLine,
      vertexColors: false,
      depthTest: false,
      transparent: true,
    ...
    let r = new Et(s.shellWall), c = new Et(s.shellSlab), d = new Et(s.shellTri);
    return qn((p, f) => {
      r = new Et(f.shellWall), c = new Et(f.shellSlab), d = new Et(f.shellTri), o.opacity = f.shellOpacity, o.needsUpdate = true;
    }), we.derive(() => {
  ...
  function yo(l, e) {
    ...
    const c = new Et(t.grid).multiplyScalar(1.3), d = new Et(t.grid).multiplyScalar(0.8), p = (C, _, S, A) => {
      const P = [], H = C === "xy" ? (q, D) => [
        q,
        D,
        0
  ...
  function Ar(l, e, t, s) {
    const n = new ft(), i = new Fe(), o = new gt({
      vertexColors: true
    }), a = [
      0,
      0,
  ...
  function zr(l, e, t, s) {
    ...
    function o(G, W) {
      ...
      R.setAttribute("position", new vt(D, 3));
      ...
      return Q.setAttribute("position", new vt(X, 3)), {
        fill: R,
        outline: Q
      };
    }
    function a(G, W = 24) {
      ...
      const D = new Fe();
      D.setAttribute("position", new vt(q, 3));
      ...
      const X = new Fe();
      return X.setAttribute("position", new vt(R, 3)), {
        fill: D,
        outline: X
      };
    }
    function r(G, W, V, q) {
      ...
      const ie = new Fe();
      ie.setAttribute("position", new vt(new Float32Array(be), 3));
      ...
      return he.setAttribute("position", new vt(le, 3)), {
        fill: ie,
        outline: he
      };
    }
    function c(G, W, V) {
      ...
      const ue = new Fe();
      ue.setAttribute("position", new vt(new Float32Array(Q), 3));
      ...
      return ae.setAttribute("position", new vt(be, 3)), {
        fill: ue,
        outline: ae
      };
    }
    function d(G, W, V) {
      ...
      Q.setAttribute("position", new vt(re, 3));
      const ue = [];
      ...
      const ae = new Fe();
      ae.setAttribute("position", new vt(new Float32Array(ue), 3));
      ...
      return le.setAttribute("position", new vt(ie, 3)), {
        concFill: Q,
        steelFillGeom: ae,
        outline: le
      };
    ...
    function p(G, W, V) {
      ...
      const X = new Fe();
      X.setAttribute("position", new vt(new Float32Array(q), 3));
      const Q = [];
      ...
      const re = new Fe();
      return re.setAttribute("position", new vt(new Float32Array(Q), 3)), {
        fill: X,
        outline: re
      };
    }
    function f(G, W, V, q) {
      ...
      const ue = new Fe();
      ue.setAttribute("position", new vt(new Float32Array(R), 3));
      const be = [];
      for (const ie of [
        X,
        Q
      ...
      const ae = new Fe();
      return ae.setAttribute("position", new vt(new Float32Array(be), 3)), {
        fill: ue,
        outline: ae
      };
    }
    function x(G, W, V, q) {
      ...
      const ue = new Fe();
      ue.setAttribute("position", new vt(new Float32Array(re), 3));
      const be = [];
    ...
    function b(G, W, V, q, D) {
      ...
      const ae = new Fe();
      ae.setAttribute("position", new vt(new Float32Array(Q), 3));
      const ie = [];
      for (const he of [
        re,
        ue
      ...
      const le = new Fe();
      return le.setAttribute("position", new vt(new Float32Array(ie), 3)), {
        fill: ae,
        outline: le
      };
    }
    function C(G, W, V, q) {
      ...
      const be = new Fe();
      be.setAttribute("position", new vt(new Float32Array(ue), 3));
      const ae = [];
      ...
      const ie = new Fe();
      return ie.setAttribute("position", new vt(new Float32Array(ae), 3)), {
        fill: be,
        outline: ie
      };
    }
    function _(G, W, V = 24) {
      ...
      const X = new Fe();
      X.setAttribute("position", new vt(new Float32Array(R), 3));
      const Q = [];
      for (let ue = 0; ue < V; ue++) {
    ...
    return we.derive(() => {
      ...
      V.forEach((X, Q) => {
        ...
        if (ae.type === "CFT") {
          ...
          Ve.position.set(...ie), he(Ve), Ve.rotation.setFromRotationMatrix(le), n.add(Ve);
          const it = new Vt(Se.outline, Ae);
          it.position.set(...ie), he(it), it.rotation.setFromRotationMatrix(le), n.add(it);
        }
        const pe = Tr(ae);
        if (pe) {
          const ve = [
  ...
  class wo extends ft {
    constructor(e, t, s, n, i, o, a) {
      ...
      if (this.text = new Bt(`${i[0].toFixed(4)}`), this.text2 = new Bt(`${(i[1] * -1).toFixed(4)}`), this.normalizedResult = o, this.textPosition = Mo(e, t), this.text2Position = Mo(t, e), this.text.position.set(...this.textPosition), this.text2.position.set(...this.text2Position), this.text.rotation.setFromRotationMatrix(n), this.text2.rotation.setFromRotationMatrix(n), this.add(this.text, this.text2), c) {
        const d = new Xn().moveTo(0, 0).lineTo(0, o[0]).lineTo(r, 0).lineTo(0, 0), p = new Xn().moveTo(r, 0).lineTo(s, -o[1]).lineTo(s, 0).lineTo(r, 0), f = d.getPoints(), x = p.getPoints(), b = new Fe().setFromPoints(f), C = new Fe().setFromPoints(x), _ = new gt({
          color: Hs().resultOutline
        });
        ...
        const S = new zi(d), A = new zi(p), P = new yt({
        ...
        this.lines = new Vt(f, new gt({
          color: Hs().resultOutline
        })), this.lines.position.set(...e), this.lines.rotation.setFromRotationMatrix(n), a && this.lines.rotateX(Math.PI / 2), this.add(this.lines);
        const x = new zi(d), b = new yt({
          color: o[0] > 0 ? 24435 : 11411474,
          side: Rt
        });
  ...
  function Vr({ drawingObj: l, gridObj: e, scene: t, getActiveCamera: s, controls: n, gridSize: i, derivedDisplayScale: o, rendererElm: a, viewerRender: r }) {
    ...
    }, f = new pt(new Ns(1e4, 1e4), new yt({
      side: Rt,
      transparent: true,
      opacity: 0,
      depthWrite: false
    ...
    const x = (u, g, w) => {
      const m = new pt(new Ns(1e4, 1e4), new yt({
        side: Rt,
        transparent: true,
        opacity: 0,
        depthWrite: false
    ...
    const U = (u, g, w) => Math.round(u * 1e3) + "," + Math.round(g * 1e3) + "," + Math.round(w * 1e3), G = (u) => {
      ...
      const { S: g, adj: w } = u, m = (B, Y) => new te(g[6 * B + 3 * Y], g[6 * B + 3 * Y + 1], g[6 * B + 3 * Y + 2]), v = /* @__PURE__ */ new Set([
        ...
        for (let se = 0; se < 3e3; se++) {
          ...
          const ne = oe[0], de = m(ne, 0), me = m(ne, 1), ke = de.distanceTo(J) < me.distanceTo(J) ? me : de, Te = J.clone().sub(K).normalize(), nt = ke.clone().sub(J).normalize();
          if (Te.dot(nt) < Math.cos(35 * Math.PI / 180)) break;
    ...
    const re = (u, g) => {
      ...
      X.geometry.dispose(), X.geometry = new Fe(), X.geometry.setAttribute("position", new vt(E, 3)), X.material.color.set(M ? 3718648 : 16096779), X.visible = true, Q = {
        m: u,
        t0: g,
        tris: v,
        normal: k,
    ...
    const ie = /* @__PURE__ */ new Map(), le = new is(new Fe(), new gt({
      color: 16498468,
      transparent: true,
      opacity: 0.35,
      depthTest: true
    ...
    const Ae = (u) => {
      ...
      le.geometry.dispose(), le.geometry = new Fe(), le.geometry.setAttribute("position", new vt(v, 3)), le.visible = m > 0 && window.__hekatanRefIfcBordes !== false;
    };
    ...
    const Ve = (u, g) => {
      ...
      for (let O = -1; O <= 1; O++) for (let z = -1; z <= 1; z++) for (let B = -1; B <= 1; B++) {
        ...
        if (Y) for (const ee of Y) {
          ...
          const nt = Math.hypot(w.x - (J.x + Te * de), w.y - (J.y + Te * me));
          nt < N && (N = nt, F = j.clone().lerp(Z, Te), L = ee);
        }
      }
    ...
    const _e = () => {
      ...
      return Ce = new Float32Array(v), ce.geometry.dispose(), ce.geometry = new Fe(), ce.geometry.setAttribute("position", new vt(Ce, 3)), ce.visible = Ce.length > 0, Ce;
    };
    let ge = null, xe = null;
    const Ne = (u, g) => {
      const w = _e();
  ...
  @5<45<30  \u2192 esf\xE9rica 3D: 5m, azimuth 45\xB0, elevaci\xF3n 30\xB0`, $e.style.cssText = [
    ...
    const Be = new te(), Dt = (u, g, w, m, v, E) => {
      ...
      if (g === "col" || g === "wall" || g === "extp" || g === "extl") {
        Ft = u, ye(`\u{1F4D0} Altura ${u}m memorizada \u2014 hac\xE9 el click para crear ${{
          col: "columna",
          wall: "pared",
      ...
      It === "x" ? (w = Math.sign(w) || 1, m = 0, v = 0) : It === "y" ? (w = 0, m = Math.sign(m) || 1, v = 0) : It === "z" && (w = 0, m = 0, v = Math.sign(v) || 1);
    ...
    window.__hekatanTypeCoord = (u) => {
      ...
      const g = qt(u);
      if (!g) return false;
      if (g.kind === "length") return Tt(g.L), true;
      const w = lt(g);
      if (!w) return false;
      ...
      if (u.key === "Enter") {
        ...
        const w = qt($e.value);
        if (!w) return;
        if (Ee = false, w.kind === "length") Tt(w.L), ye(`\u270F DDE ${w.L}m aplicado en direcci\xF3n actual`);
        else {
          const m = lt(w);
          if (!m) return;
          et(m);
    ...
    const Re = new Vt(new Fe().setFromPoints([
      new te(0, 0, 0),
      new te(0, 0, 0)
    ]), new Pn({
      color: 2282478,
    ...
    let rt = [];
    const zt = new Vt(new Fe(), new gt({
      color: 16763904,
      transparent: true,
      opacity: 0.95
    }));
    zt.frustumCulled = false, zt.visible = false, zt.renderOrder = 999, t.add(zt);
    let Ge = [];
    ...
    const Jt = (u) => {
      ...
      c.setFromCamera(d, g);
      let w = null, m = null;
      const v = c.intersectObjects(t.children, true).filter((F) => F.object.isMesh && F.object !== _t && F.object !== mt && F.object.visible !== false);
      if (v.length) {
      ...
      at.style.left = E.left + (v.x * 0.5 + 0.5) * E.width + "px", at.style.top = E.top + (-v.y * 0.5 + 0.5) * E.height - 14 + "px", at.style.display = "block";
    };
    window.__hekatanMeasureRefresh = $t, window.__hekatanClearMeasure = () => {
      Ge = [], zt.visible = false, at.style.display = "none";
      try {
        r();
      } catch {
      }
    ...
    try {
      (_a2 = n.addEventListener) == null ? void 0 : _a2.call(n, "change", $t);
    } catch {
    }
    const mt = new pt(new Fe(), new yt({
      color: 16096779,
      transparent: true,
      opacity: 0.35,
      side: Rt,
    ...
    mt.frustumCulled = false, mt.visible = false, mt.renderOrder = 998, mt.name = "hk-fill-preview", t.add(mt), a.addEventListener("pointerleave", () => {
      Pe.style.display = "none", mt.visible && (mt.visible = false, r());
    });
    const Ms = (u) => {
      var _a3, _b, _c2, _d2;
      ...
      return j;
    }, Lt = new ft(), Ht = new pt(new Ns(1, 1), new yt({
      color: 2282478,
      transparent: true,
      opacity: 0.08,
      side: Rt,
      depthWrite: false
    })), $s = new is(new va(new Ns(1, 1)), new gt({
      color: 2282478,
      transparent: true,
      opacity: 0.85
    })), Xs = new is(new Fe(), new gt({
      color: 2282478,
      transparent: true,
      opacity: 0.3
    })), Qn = (u, g) => {
    ...
    const Wt = new ft();
    Wt.frustumCulled = false, Wt.visible = false, t.add(Wt);
    const Es = (u) => {
    ...
    Zt.material.dashSize = 0.28, Zt.material.gapSize = 0.16, Zt.material.opacity = 0.9, Zt.frustumCulled = false, Zt.visible = false, Zt.renderOrder = 98, t.add(Zt);
    const Mn = (u) => {
      const g = new Fe().setFromPoints([
        new te(0, 0, 0),
        new te(0, 0, 0),
    ...
    const Ho = () => {
      ...
      Yt.style.background = "rgba(15,23,42,0.92)", Yt.style.color = u[It], Yt.style.border = `1.5px solid ${u[It]}`, Yt.textContent = `\u{1F512} LOCK ${It.toUpperCase()}`, Yt.style.display = "block";
    };
    window.addEventListener("keydown", (u) => {
      ...
      if (w === "x" || w === "y" || w === "z") It = It === w ? null : w, Ho(), u.preventDefault();
      ...
      window.__hekatanPolarTrack = u, u || (Wt.visible = false), ye(`\u25C8 POLAR ${u ? "ON" : "OFF"} (F10)`);
    ...
    const ti = new te(), si = new te(), Xo = new te(), kl = (u) => {
      ...
      return It === "x" ? (ti.set(g - 1e4, w, m), si.set(g + 1e4, w, m)) : It === "y" ? (ti.set(g, w - 1e4, m), si.set(g, w + 1e4, m)) : (ti.set(g, w, m - 1e4), si.set(g, w, m + 1e4)), c.ray.distanceSqToSegment(ti, si, null, Xo), Xo;
    };
    ...
    const ds = new pt(new vn(0.02, 12, 12), new yt({
      color: 16766720,
      transparent: true,
      opacity: 0.9,
      depthTest: false
    ...
    const Cl = (u, g, w, m) => {
      ...
      for (const k of Ue) {
        ...
        if (M === "pt") {
          const I = u[+$[0]];
          if (!I) continue;
          const T = new pt(new vn(0.025, 12, 12), new yt({
            color: ii,
            transparent: true,
            opacity: 0.9,
            depthTest: false
          ...
          const N = new Fe().setFromPoints(T), F = new Vt(N, new gt({
            color: ii,
            transparent: true,
            opacity: 0.95,
            depthTest: false
    ...
    window.__hekatanDrawCircle = (u, g, w, m, v = window.__hekatanArcSegs ?? 12, E = "xy") => {
      ...
      let me = false;
      if (de >= 0) {
        const ke = u[de], Te = w[de], nt = 512;
        let We = Math.abs(Te - ke) > 1e-9, tt = ke;
        for (let Le = 1; Le <= nt && We; Le++) {
          const Je = oe(K * Le / nt).getComponent(de);
        ...
        if (We) {
          ...
          for (let Le = 0; Le <= v; Le++) {
            ...
            for (let Ze = 0; Ze < 60; Ze++) {
              const bt = (He + De) / 2;
              (oe(bt).getComponent(de) - Je) * (Te - ke) < 0 ? He = bt : De = bt;
            }
            const Xe = oe((He + De) / 2);
            se.push([
              Xe.x,
      ...
      if (l.points.val = [
        ...
        const ke = se.map((nt, We) => J + We), Te = l.polylines.rawVal;
        l.polylines.val = [
          ...Te.slice(0, -1),
          ke,
          []
    ...
    window.__hekatanRevolveSelection = (u, g, w, m = 360) => {
      ...
      const F = N > 0 ? 1 : -1, L = (de) => {
        const me = $[(de - 1 + I) % I], ke = $[de], Te = $[(de + 1) % I], nt = [
          ke[0] - me[0],
          ke[1] - me[1]
        ], We = [
          Te[0] - ke[0],
          Te[1] - ke[1]
        ], tt = Math.hypot(nt[0], nt[1]) || 1, Le = Math.hypot(We[0], We[1]) || 1, Je = [
          F * nt[1] / tt,
          -F * nt[0] / tt
        ], He = [
          F * We[1] / Le,
          -F * We[0] / Le
        ], De = 1 + (Je[0] * He[0] + Je[1] * He[1]);
        return [
          (Je[0] + He[0]) / Math.max(De, 1e-6),
          (Je[1] + He[1]) / Math.max(De, 1e-6)
        ];
      ...
      N /= j, F /= j, L /= j;
      const Z = u[0], O = (De) => [
        (De[0] - Z[0]) * M + (De[1] - Z[1]) * $ + (De[2] - Z[2]) * I,
        (De[0] - Z[0]) * N + (De[1] - Z[1]) * F + (De[2] - Z[2]) * L
      ], z = (De, Xe) => [
        Z[0] + De * M + Xe * N,
        Z[1] + De * $ + Xe * F,
        Z[2] + De * I + Xe * L
      ...
      for (const [De, Xe] of B) De < Y && (Y = De), De > ee && (ee = De), Xe < K && (K = Xe), Xe > J && (J = Xe);
      ...
      const de = (De, Xe) => {
        let Ze = false;
        for (let bt = 0, St = B.length - 1; bt < B.length; St = bt++) {
          const [Ot, fs] = B[bt], [xn, Js] = B[St];
          fs > Xe != Js > Xe && De < (xn - Ot) * (Xe - fs) / (Js - fs) + Ot && (Ze = !Ze);
        }
        return Ze;
      }, me = Math.max(1, Math.round(se / ne)), ke = Math.max(1, Math.round(oe / ne)), Te = se / me, nt = oe / ke, We = /* @__PURE__ */ new Map(), tt = [], Le = l.points.rawVal.length, Je = (De, Xe) => {
        const Ze = De + "," + Xe, bt = We.get(Ze);
        if (bt !== void 0) return bt;
        const St = Le + tt.length;
        return tt.push(z(Y + De * Te, K + Xe * nt)), We.set(Ze, St), St;
      }, He = [];
      for (let De = 0; De < me; De++) for (let Xe = 0; Xe < ke; Xe++) {
        if (!de(Y + (De + 0.5) * Te, K + (Xe + 0.5) * nt)) continue;
        const Ze = Je(De, Xe), bt = Je(De + 1, Xe), St = Je(De + 1, Xe + 1), Ot = Je(De, Xe + 1);
        He.push([
          Ze,
          bt,
          St,
      ...
      if (window.__hekatanPushUndo && window.__hekatanPushUndo(), l.points.val = [
        ...
        let De = l.polylines.rawVal.slice();
        De.length && De[De.length - 1].length === 0 && (De = De.slice(0, -1));
        const Xe = [];
        for (const Ze of He) Xe.push(De.length), De.push([
          Ze[0],
          Ze[1],
          Ze[2],
          Ze[3],
        ...
        De.push([]), l.polylines.val = De, l.areas.val = [
          ...l.areas.rawVal,
          ...Xe
        ];
      }
    ...
    window.__hekatanShowRefPlanes = (u = [
      ...
      u.forEach((E, k) => {
        const M = v[k % v.length], $ = g / 2, I = [
          ...
          new te(w - $, m + $, E),
          new te(w - $, m - $, E)
        ], T = new Fe().setFromPoints(I), N = new gt({
          color: M,
          transparent: true,
          opacity: 0.55
        });
        ...
        const z = new Ns(1e4, 1e4), B = new yt({
          visible: false,
          side: Rt
        }), Y = new pt(z, B);
    ...
    const Jo = () => {
      ...
      for (const w of g) {
        ...
        const m = new pt(new vn(0.025, 12, 12), new yt({
          color: 2282478,
          transparent: true,
          opacity: 0.85,
          depthTest: false
    ...
    const _t = new ft(), Al = new pt(new vn(0.01, 12, 12), new yt({
      color: 16777215,
      transparent: true,
      opacity: 0.95
    })), Qo = new pt(new vn(0.015, 12, 12), new yt({
      color: 16498468,
      transparent: true,
      opacity: 0.2,
      depthWrite: false
    }));
    Qo.visible = false, _t.add(Al, Qo);
    const mn = 0.08, Wi = (u, g, w) => {
      const m = new Fe().setFromPoints([
        new te(...u),
        new te(...g)
      ]);
      return new Vt(m, new gt({
        color: w,
        transparent: true,
        opacity: 0.7
      }));
    ...
    _t.add(Wi([
      ...
      0,
      mn
    ], 16777215)), _t.visible = false, _t.frustumCulled = false, t.add(_t);
    let Zi = 2;
    const di = (u) => {
      ...
      const u = Zi * di(_t.position) / 0.015;
      _t.scale.setScalar(Math.max(1e-4, Math.min(1e5, u)));
    };
    let Rs = 10;
    const Ki = (u) => Math.max(1e-4, Rs * di(u));
    window.__hekatanAperturaPx = (u) => (typeof u == "number" && u > 0 && (Rs = u), Rs), window.__hekatanUpdateSnapScale = Tn, window.__hekatanSnapMarker = _t, window.__hekatanMetrosPorPixel = di, window.__hekatanSnapPx = (u) => (typeof u == "number" && u > 0 && (Zi = u, Tn(), r()), Zi);
    const ea = () => {
    ...
    window.__hekatanUpdateSelectionPtScale = ea, n.addEventListener("change", () => {
      ...
      _t.position.set(u, g, w), _t.visible = true, Tn(), r();
      ...
      const w = Me();
      if ((!w.length || ((_c2 = (_b = (_a3 = window.__hekatanCadState) == null ? void 0 : _a3.get) == null ? void 0 : _b.call(_a3)) == null ? void 0 : _c2.tool) !== "fillarea") && mt.visible && (mt.visible = false), w.length) {
        const m = w[0].point;
        if (((_f = (_e2 = (_d2 = window.__hekatanCadState) == null ? void 0 : _d2.get) == null ? void 0 : _e2.call(_d2)) == null ? void 0 : _f.tool) === "fillarea") {
          ...
          if (L) {
            ...
            const O = mt.geometry;
            O.setAttribute("position", new Mt(Z, 3)), O.computeVertexNormals(), mt.visible = true;
        ...
        if (M) pi(M.type, M.x, M.y, M.z), _t.position.set(M.x, M.y, M.z), _t.visible = true, m.set(M.x, M.y, M.z), mi(M.type, u.clientX, u.clientY);
        else if (!v && (ze = Ne(u.clientX, u.clientY))) E = true, m.copy(ze), pi("ifcSec", m.x, m.y, m.z), mi("ifcSec", u.clientX, u.clientY), _t.position.copy(m), _t.visible = true;
        else if (S && !v) E = true, pi(S.tipo, m.x, m.y, m.z), mi(S.tipo, u.clientX, u.clientY), _t.position.copy(m), _t.visible = true;
        else {
          Fl(), fi();
          const F = !v && window.__hekatanSnapEnabled !== false, L = window.__hekatanSnap2D ?? 0.5;
          F && L > 0 && (m.x = Math.round(m.x / L) * L, m.y = Math.round(m.y / L) * L, m.z = Math.round(m.z / L) * L), _t.position.copy(m), _t.visible = true;
        }
        ...
        if ($ === "select" || !$) {
          ...
          B && (B.textContent = z), Xt = {
            ...
            x: u.clientX,
            y: u.clientY
          }, Re.visible = false, Wt.visible = false, Zt.visible = false, r();
          return;
        }
        if ($ === "delete" || $ === "trim" || $ === "extend" || $ === "offset") {
          ...
          Z ? (Ps = j, ws = -1, Fs = -1, Sl(j)) : L ? (ws = L.polyIdx, Fs = L.segIdx, Ps = -1, Ml(L.polyIdx, L.segIdx)) : (ws = -1, Fs = -1, Ps = -1, Qt.visible = false), Re.visible = false, Wt.visible = false, Zt.visible = false, ot(), Pe.style.left = u.clientX + "px", Pe.style.top = u.clientY + "px", Pe.style.display = "block";
        ...
        if (T.length > 0 && N[T[T.length - 1]]) {
          ...
          if (!j && !Z && window.__hekatanAxisSnap !== false) {
            const We = a.getBoundingClientRect(), tt = u.clientX, Le = u.clientY, Je = ((_q = settings.gridSize) == null ? void 0 : _q.rawVal) ?? 10, He = new te(L[0], L[1], L[2]), De = [
              [
                "x",
                new te(1, 0, 0)
              ],
          ...
          if (!j && !Z && z) {
            ...
            if (Je > 1e-3) {
              const De = Math.tan(6 * Math.PI / 180) * Je, Xe = Math.hypot(tt, Le), Ze = Math.hypot(We, Le), bt = Math.hypot(We, tt), St = [
                [
                  "x",
                  Xe
                ],
              ...
              St.sort((Ot, fs) => Ot[1] - fs[1]), St[0][1] <= De && (j = St[0][0]);
            }
          }
          if (j) {
            ...
            Yt.style.background = "rgba(15,23,42,0.92)", Yt.style.color = De, Yt.style.border = `1.5px solid ${De}`;
            const Xe = (_s2 = w[0]) == null ? void 0 : _s2.object;
            let Ze = null;
            Xe === cs ? Ze = "xy" : Xe === gs ? Ze = "xz" : Xe === ys && (Ze = "yz");
            const bt = Ze ? ` (plano ${Ze.toUpperCase()})` : "";
            Yt.textContent = Je ? `\u{1F512} LOCK ${j.toUpperCase()}${bt}` : `\u22A5 ORTO ${j.toUpperCase()}${bt}`, Yt.style.left = u.clientX + 20 + "px", Yt.style.top = u.clientY + 18 + "px", Yt.style.transform = "none", Yt.style.display = "block";
          } else It || (Yt.style.display = "none");
          let B = null;
          if (!v && !Z && window.__hekatanTrack !== false && window.__hekatanOsnapOn !== false) {
            ...
            let Je = 1 / 0;
            for (const He of We) if (!(Math.abs(He[0] - L[0]) < 1e-9 && Math.abs(He[1] - L[1]) < 1e-9 && Math.abs(He[2] - L[2]) < 1e-9)) for (const De of tt) {
              const Xe = new te(De === "x" ? He[0] : m.x, De === "y" ? He[1] : m.y, De === "z" ? He[2] : m.z), Ze = Ks(Xe.x, Xe.y, Xe.z);
              if (!Ze) continue;
              const bt = Math.hypot(Ze.x - Le.x, Ze.y - Le.y);
              bt < Rs && bt < Je && (Je = bt, B = {
                q: He,
                eje: De
              });
          ...
          B ? (B.eje === "x" ? m.x = B.q[0] : B.eje === "y" ? m.y = B.q[1] : m.z = B.q[2], Zt.geometry.setFromPoints([
            new te(B.q[0], B.q[1], B.q[2]),
            new te(m.x, m.y, m.z)
          ]), (_t2 = Zt.computeLineDistances) == null ? void 0 : _t2.call(Zt), Zt.visible = true, _t.position.set(m.x, m.y, m.z), _t.visible = true, mi("track", u.clientX, u.clientY)) : Zt.visible = false, Xt = {
            p: m.clone(),
            x: u.clientX,
            y: u.clientY
          };
          ...
          se && (se.textContent = K), Re.geometry.setFromPoints([
            new te(L[0], L[1], L[2]),
            new te(m.x, m.y, m.z)
          ]), (_u = Re.computeLineDistances) == null ? void 0 : _u.call(Re), Re.visible = true, Dt(L[0], L[1], L[2], m.x, m.y, m.z);
          ...
          Bo(me), me && (xs.style.left = u.clientX + "px", xs.style.top = u.clientY + "px"), Ys.geometry.setFromPoints([
            ...
            new te(L[0], L[1], L[2] + oe)
          ]), (_x = Us.computeLineDistances) == null ? void 0 : _x.call(Us), Wt.visible = true;
          const ke = Ys.material, Te = js.material, nt = Us.material;
          Ys.visible = j === "x", js.visible = j === "y", Us.visible = j === "z", ke.opacity = 0.95, Te.opacity = 0.95, nt.opacity = 0.95;
        } else {
          const F = `X=${m.x.toFixed(2)} Y=${m.y.toFixed(2)} Z=${m.z.toFixed(2)}`;
          Pe.textContent = F;
          const L = document.getElementById("hk-coord-fixed");
          if (L && (L.textContent = F), Re.visible = false, Wt.visible = false, (/* @__PURE__ */ new Set([
            "line",
            "polyline",
            "area",
            "node",
        ...
        r();
      } else fi(), Pe.style.display = "none", _t.visible = false, Re.visible = false, Wt.visible = false, ot(), r();
    }), we.derive(() => {
      var _a3;
    ...
    Kt.id = "hk-window-select", Kt.style.cssText = [
      "position:fixed",
      "pointer-events:none",
      "z-index:99996",
      "display:none",
    ...
    ].join(";") + ";", document.body.appendChild(Kt);
    let ps = null, zn = false, ts = null;
    const Ji = (u, g, w, m, v) => {
      v ? (Kt.style.borderColor = "#34d399", Kt.style.borderStyle = "dashed", Kt.style.background = "rgba(52, 211, 153, 0.10)") : (Kt.style.borderColor = "#22d3ee", Kt.style.borderStyle = "solid", Kt.style.background = "rgba(34, 211, 238, 0.10)"), Kt.style.left = Math.min(u, w) + "px", Kt.style.top = Math.min(g, m) + "px", Kt.style.width = Math.abs(w - u) + "px", Kt.style.height = Math.abs(m - g) + "px", Kt.style.display = "block";
    }, ta = (u, g, w, m, v) => {
      var _a3, _b, _c2, _d2;
      ...
      hs(), ye(Z === 0 && !I ? "\u{1F535} Window (izq\u2192der) \u2014 0: solo coge lo que quede ENTERO dentro. De DERECHA a IZQUIERDA (\u{1F7E2} captura) coge todo lo que toque." : `${I ? "\u{1F7E2} Crossing" : "\u{1F535} Window"} \u2014 ${Z} item(s) ${v ? "agregados a" : "\u2192"} selecci\xF3n (total ${Ue.size})`), Kt.style.display = "none";
    }, hi = () => {
      ts && (ts = null, Kt.style.display = "none", ye("Selecci\xF3n cancelada"));
    };
    ...
    const Nt = (u, g, w, m) => {
      ...
      var _a3, _b;
      if (xt && (xt.dispose(), xt = null), Ue.size === 0) {
    ...
    const Pl = (u, g, w, m, v) => {
      ...
      if (E.int) {
        ...
        for (let B = 0; B < z.length; B++) for (let Y = B + 1; Y < z.length; Y++) {
          const [ee, K] = z[B], [J, se] = z[Y], oe = [
            ...
            ee[1] - J[1],
            ee[2] - J[2]
          ], me = oe[0] * oe[0] + oe[1] * oe[1] + oe[2] * oe[2], ke = oe[0] * ne[0] + oe[1] * ne[1] + oe[2] * ne[2], Te = ne[0] * ne[0] + ne[1] * ne[1] + ne[2] * ne[2], nt = oe[0] * de[0] + oe[1] * de[1] + oe[2] * de[2], We = ne[0] * de[0] + ne[1] * de[1] + ne[2] * de[2], tt = me * Te - ke * ke;
          if (tt < 1e-12) continue;
          const Le = (ke * We - Te * nt) / tt, Je = (me * We - ke * nt) / tt;
          ...
          if (Math.hypot(He[0] - De[0], He[1] - De[1], He[2] - De[2]) > 1e-4) continue;
          [
            ee,
            K,
            J,
      ...
      if (E.int || E.node) for (let z = 0; z < j.length; z++) for (let B = z + 1; B < j.length; B++) {
        ...
        const ke = Y[0] - K[0], Te = Y[1] - K[1], nt = (ne * Te - de * ke) / me, We = (se * Te - oe * ke) / me;
        if (nt < -1e-6 || nt > 1 + 1e-6 || We < -1e-6 || We > 1 + 1e-6) continue;
        const tt = (_h = (_g = (_f = window.__hekatanCadState) == null ? void 0 : _f.get) == null ? void 0 : _g.call(_f)) == null ? void 0 : _h.workZ;
        N("int", Y[0] + nt * se, Y[1] + nt * oe, typeof tt == "number" ? tt : w);
      }
    ...
    const Rl = () => {
      var _a3, _b, _c2;
      const u = [];
      window.__hekatanOrthoMode && u.push("\u22A5 ORTO ON (F8)"), It && u.push(`\u{1F512} LOCK ${It.toUpperCase()}`);
      ...
      switch (u) {
        ...
        case "col":
          return v(`COLUMNA Precise punto de inserci\xF3n (altura ${Ft > 0 ? Ft : 3} m; teclee otra + Enter antes del clic):`);
        case "wall":
          return v(m ? "MURO Precise segundo punto de la base:" : `MURO Precise primer punto de la base (altura ${Ft > 0 ? Ft : 3} m; teclee otra + Enter):`);
        case "plane3":
    ...
    const wn = [], gi = [], Nl = () => {
      ...
      qe = [], Re.visible = false, Wt.visible = false, ot();
      try {
        (_a3 = window.__hekatanRebuild) == null ? void 0 : _a3.call(window);
      } catch {
      }
    ...
    window.__hekatanPushUndo = At, window.__hekatanUndo = yi, window.__hekatanRedo = ra, document.addEventListener("keydown", (u) => {
      var _a3;
      const g = u.key.toLowerCase();
    ...
    const io = () => {
      qe = [], jt = null, so(), It = null, Ho(), Re.visible = false, Wt.visible = false, ot(), ye("\u23F9 Dibujo finalizado \u2014 click para empezar otra serie"), r(), ss();
    };
    ...
    const Ol = () => {
      ...
      if (u === "offset") {
        ...
        for (let Le = 0; Le < O.length - 1; Le++) {
          const Je = m[O[Le]], He = m[O[Le + 1]], De = [
            He[0] - Je[0],
            He[1] - Je[1],
            He[2] - Je[2]
          ], Xe = Math.hypot(De[0], De[1], De[2]) || 1, Ze = De[0] / Xe, bt = De[1] / Xe, St = De[2] / Xe, Ot = [
            B[1] * St - B[2] * bt,
            B[2] * Ze - B[0] * St,
            B[0] * bt - B[1] * Ze
    ...
    window.__hekatanSelectionSize = () => Ue.size, window.__hekatanSelectLast = () => {
      ...
      for (const [Z, O] of $) {
        ...
        for (const me of de) {
          const ke = J * w * me, Te = se * w * me, nt = N.length;
          N.push([
            z[0] + ke,
            z[1] + Te,
            z[2]
    ...
    const pa = (u, g) => {
      ...
      if (w === "medir") {
        ...
        if (!M) return;
        if (Ge.length >= 2 && (Ge = []), Ge.push(M), Ge.length === 1) zt.visible = false, $t(), ye("\u{1F4CF} Regla \u2014 1er punto puesto. Marca el 2\xBA.");
        else {
          const [$, I] = Ge;
          zt.geometry.setFromPoints([
            new te($[0], $[1], $[2]),
            new te(I[0], I[1], I[2])
          ]), zt.visible = true;
          const T = Math.hypot(I[0] - $[0], I[1] - $[1], I[2] - $[2]), N = Math.hypot(I[0] - $[0], I[1] - $[1]);
          at.textContent = `${T.toFixed(3)} m`, $t(), ye(`\u{1F4CF} Distancia ${T.toFixed(3)} m  \xB7  \u0394x ${(I[0] - $[0]).toFixed(3)}  \u0394y ${(I[1] - $[1]).toFixed(3)}  \u0394z ${(I[2] - $[2]).toFixed(3)}  \xB7  en planta ${N.toFixed(3)} m`);
        }
        r();
        return;
      }
      if (w === "fillarea") {
        ...
        const j = ((_E = (_D = (_C = window.__hekatanCadState) == null ? void 0 : _C.get) == null ? void 0 : _D.call(_C)) == null ? void 0 : _E.workPlane) ?? "xy", Z = (oe) => j === "xy" ? [
          ...
          for (let me = 0, ke = ne.length - 1; me < ne.length; ke = me++) {
            const Te = ne[me][0], nt = ne[me][1], We = ne[ke][0], tt = ne[ke][1];
            nt > oe[1] != tt > oe[1] && oe[0] < (We - Te) * (oe[1] - nt) / (tt - nt) + Te && (de = !de);
          }
          return de;
        }, B = (oe) => {
          let ne = 0;
      ...
      if (w === "col") {
        ...
        l.polylines.val = [
          ...
          []
        ], Ft = 0, ye(`\u258C Columna creada \u2014 h=${M.toFixed(2)}m. Tipe\xE1 altura + Enter para custom.`);
        try {
      ...
      if (w === "wall") {
        ...
        ye(`\u25A5 Pared Q4 creada \u2014 h=${$.toFixed(2)}m. Tipe\xE1 altura + Enter para custom.`), qe = [], Ft = 0;
        try {
      ...
      if (w === "extp") {
        ...
        l.polylines.val = [
          ...
          []
        ], Ft = 0, ye(`\u2B06 Extrusi\xF3n punto\u2192l\xEDnea \u2014 h=${k.toFixed(2)}m`);
        try {
      ...
      if (w === "extl") {
        ...
        Ft = 0, ye(`\u2B06 Extrusi\xF3n l\xEDnea\u2192\xE1rea Q4 \u2014 h=${L.toFixed(2)}m`);
        try {
    ...
    return we.derive(() => {
      ...
      for (const { idx: X, vals: Q } of b) {
        ...
        for (let Ae = 0; Ae < Se; Ae++) {
          const Ve = Ae / xo, it = ue[0] + ae.x * ie * Ve, wt = ue[1] + ae.y * ie * Ve, Ce = ue[2] + ae.z * ie * Ve, ce = Q[0] + (Q[1] - Q[0]) * Ve, _e = i.getColor(ce) ?? new Et(0, 0, 0);
          o.copy(_e).convertSRGBToLinear();
          for (let ge = 0; ge < ve; ge++) {
            const xe = ge / ve * Math.PI * 2, Ne = Math.cos(xe), ze = Math.sin(xe);
            U.push(it + (he.x * Ne + pe.x * ze) * H, wt + (he.y * Ne + pe.y * ze) * H, Ce + (he.z * Ne + pe.z * ze) * H), G.push(o.r, o.g, o.b);
          }
        }
        for (let Ae = 0; Ae < xo; Ae++) for (let Ve = 0; Ve < ve; Ve++) {
          const it = (Ve + 1) % ve, wt = V + Ae * ve + Ve, Ce = V + Ae * ve + it, ce = V + (Ae + 1) * ve + Ve, _e = V + (Ae + 1) * ve + it;
  ...
  function tc(l) {
    ...
    const t = new vn(1, 16, 16), s = new yt({
      color: Jr,
      transparent: true,
      opacity: 0.85,
      depthTest: false
    ...
    function q(Ce, ce) {
      ...
      const Ie = /* @__PURE__ */ new Map(), Oe = (lt) => {
        ...
        const Pe = et.clone().project(_e), st = (Pe.x * 0.5 + 0.5) * ge.width, Re = (-Pe.y * 0.5 + 0.5) * ge.height, ht = {
          x: st,
          y: Re,
          z: Pe.z
        };
      ...
      for (let lt = 0; lt < ze.length; lt++) {
        ...
        const Pe = et.x - xe, st = et.y - Ne, Re = Math.sqrt(Pe * Pe + st * st);
        Re < je && (je = Re, Qe = lt);
      }
...
(${lt[0].toFixed(3)}, ${lt[1].toFixed(3)}, ${lt[2].toFixed(3)})`;
        ...
        if (Pe == null ? void 0 : Pe.deformations) {
          ...
          if (st && (et += `
\u2500\u2500\u2500\u2500 \u0394 desplaz. \u2500\u2500\u2500\u2500`, et += `
Ux = ${Pt(st[0] * Ee, 3)} ${Ke.dispUnit}`, et += `
Uy = ${Pt(st[1] * Ee, 3)} ${Ke.dispUnit}`, et += `
Uz = ${Pt(st[2] * Ee, 3)} ${Ke.dispUnit}`, (Math.abs(st[3]) > 1e-9 || Math.abs(st[4]) > 1e-9 || Math.abs(st[5]) > 1e-9) && (et += `
Rx = ${Pt(st[3] * 1e3, 3)} mrad`, et += `
Ry = ${Pt(st[4] * 1e3, 3)} mrad`, et += `
Rz = ${Pt(st[5] * 1e3, 3)} mrad`)), Pe.reactions) {
            const Re = Pe.reactions.get(Qe);
            Re && (Math.abs(Re[0]) > 1e-9 || Math.abs(Re[1]) > 1e-9 || Math.abs(Re[2]) > 1e-9 || Math.abs(Re[3]) > 1e-6 || Math.abs(Re[4]) > 1e-6 || Math.abs(Re[5]) > 1e-6) && (et += `
\u2500\u2500\u2500\u2500 R reacciones \u2500\u2500\u2500\u2500`, et += `
Fx = ${Pt(Re[0] * Be)} ${Ke.forceUnit}`, et += `
Fy = ${Pt(Re[1] * Be)} ${Ke.forceUnit}`, et += `
Fz = ${Pt(Re[2] * Be)} ${Ke.forceUnit}`, (Math.abs(Re[3]) > 1e-6 || Math.abs(Re[4]) > 1e-6 || Math.abs(Re[5]) > 1e-6) && (et += `
Mx = ${Pt(Re[3] * Be)} ${Ke.forceUnit}\xB7m`, et += `
My = ${Pt(Re[4] * Be)} ${Ke.forceUnit}\xB7m`, et += `
Mz = ${Pt(Re[5] * Be)} ${Ke.forceUnit}\xB7m`));
          }
        }
        return {
          type: "node",
      ...
      for (let lt = 0; lt < Me.length; lt++) {
        ...
        if (!(!et || et.length < 2)) {
          if (et.length === 2) {
            ...
            const Re = sc(xe, Ne, Pe.x, Pe.y, st.x, st.y);
            Re < Tt && (Tt = Re, ot = lt, qt = "frame");
            ...
            if (!st) continue;
            if (nc(xe, Ne, Pe)) {
              const ht = Pe.reduce((rt, zt) => rt + zt.z, 0) / Pe.length * 1e-3;
              ht < Tt && (Tt = ht, ot = lt, qt = "shell");
            }
          } else if (et.length === 8) {
            const Pe = [];
            let st = true;
            ...
            if (!st) continue;
            const Re = Math.min(...Pe.map((Ge) => Ge.x)), ht = Math.max(...Pe.map((Ge) => Ge.x)), rt = Math.min(...Pe.map((Ge) => Ge.y)), zt = Math.max(...Pe.map((Ge) => Ge.y));
            if (xe >= Re && xe <= ht && Ne >= rt && Ne <= zt) {
              const at = Pe.reduce((Jt, $t) => Jt + $t.z, 0) / Pe.length * 1e-3;
              at < Tt && (Tt = at, ot = lt, qt = "solid");
            }
          }
        }
      }
      if (ot >= 0) {
        const lt = Me[ot];
        let Pe = `${qt === "frame" ? "Frame" : qt === "shell" ? "Shell" : "Solid"} ${ot}`;
        ...
        if (Re) {
          Re.name && (Pe += `
  Secci\xF3n: ${Re.name}`), Re.shape && (Pe += `
  Shape: ${Re.shape}`);
          const ht = /concrete|hormig|conc|rect.*sólida/i.test(`${Re.shape || ""} ${Re.material || ""}`), rt = ht ? 100 : 1e3, zt = ht ? "cm" : "mm", Ge = ($t) => {
            if (!Number.isFinite($t)) return "\u2014";
            const mt = $t * rt;
            return Math.abs(mt - Math.round(mt)) < 0.05 ? `${Math.round(mt)}` : `${mt.toFixed(1)}`;
          }, at = [];
          Re.D != null && at.push(`D=${Ge(Re.D)}`), Re.B != null && at.push(`B=${Ge(Re.B)}`), Re.TF != null && at.push(`TF=${Ge(Re.TF)}`), Re.TW != null && at.push(`TW=${Ge(Re.TW)}`), Re.t != null && at.push(`t=${Ge(Re.t)}`);
          const Jt = at.filter(($t) => !$t.endsWith("=\u2014"));
          if (Jt.length && (Pe += `
  Dim: ${Jt.join(" ")} ${zt}`), Re.material) {
            let $t = Re.material;
            Re.fillMaterial && ($t += ` + FILL "${Re.fillMaterial}"`), Pe += `
  Material: ${$t}`;
          }
        } else {
          const ht = (_i2 = (_h = st == null ? void 0 : st.sectionLabels) == null ? void 0 : _h.get) == null ? void 0 : _i2.call(_h, ot), rt = (_k = (_j = st == null ? void 0 : st.materialTypes) == null ? void 0 : _j.get) == null ? void 0 : _k.call(_j, ot);
          ht ? (Pe += `
...
nodos: [${lt.join(", ")}]`, qt === "shell" && ((_l2 = l.mesh) == null ? void 0 : _l2.analyzeOutputs)) {
          const ht = l.mesh.analyzeOutputs.rawVal, rt = Gr[Ke.stressUnit] ?? 1, zt = [
            [
              "bendingXX",
              "Mxx",
              Be,
          ...
          for (const [at, Jt, $t, mt] of zt) {
            const Ms = ht == null ? void 0 : ht[at];
            if (Ms && Ms instanceof Map) {
              const Lt = Ms.get(ot);
              if (Lt != null) {
                if (typeof Lt == "number") Ge.push(`${Jt} = ${Pt(Lt * $t, 3)} ${mt}`);
                else if (Array.isArray(Lt)) {
                  let Ht = Lt[0];
                  for (const $s of Lt) Math.abs($s) > Math.abs(Ht) && (Ht = $s);
                  Ge.push(`${Jt} = ${Pt(Ht * $t, 3)} ${mt}`);
                }
              }
            }
          }
...
`));
        ...
        if (qt === "frame" && ((_m = l.mesh) == null ? void 0 : _m.deformOutputs) && l.mesh.elementInputs) {
          const ht = l.mesh.deformOutputs.rawVal, rt = l.mesh.elementInputs.rawVal, zt = ht == null ? void 0 : ht.deformations;
          if (zt && lt.length === 2) {
            const Ge = zt.get(lt[0]), at = zt.get(lt[1]), Jt = ze[lt[0]], $t = ze[lt[1]];
            if (Ge && at && Jt && $t) {
              const mt = $t[0] - Jt[0], Ms = $t[1] - Jt[1], Lt = $t[2] - Jt[2], Ht = Math.sqrt(mt * mt + Ms * Ms + Lt * Lt);
              if (Ht > 1e-9) {
                const $s = mt / Ht, Xs = Ms / Ht, Qn = Lt / Ht, Wt = (at[0] - Ge[0]) * $s + (at[1] - Ge[1]) * Xs + (at[2] - Ge[2]) * Qn, Es = ((_n2 = rt.elasticities) == null ? void 0 : _n2.get(ot)) ?? 0, Ys = ((_o2 = rt.areas) == null ? void 0 : _o2.get(ot)) ?? 0, js = ((_p = rt.momentsOfInertiaY) == null ? void 0 : _p.get(ot)) ?? 0, Us = ((_q = rt.momentsOfInertiaZ) == null ? void 0 : _q.get(ot)) ?? 0, Sn = ((_r2 = rt.torsionalConstants) == null ? void 0 : _r2.get(ot)) ?? 0, ji = ((_s = rt.shearModuli) == null ? void 0 : _s.get(ot)) ?? Es / 2.6, Zt = Es * Ys * (Wt / Ht), Mn = (at[3] - Ge[3]) * $s + (at[4] - Ge[4]) * Xs + (at[5] - Ge[5]) * Qn, qs = ji * Sn * (Mn / Ht), dn = at[4] - Ge[4], hn = at[5] - Ge[5], ms = Es * js * dn / Ht, un = Es * Us * hn / Ht;
                Pe += `
\u2500\u2500\u2500\u2500 frame \u2500\u2500\u2500\u2500`, Pe += `
L = ${Pt(Ht, 3)} m`, Pe += `
\u0394L = ${Pt(Wt * Ee, 3)} ${Ke.dispUnit}`, Pe += `
\u03B5 = ${Pt(Wt / Ht, 6)}`, Math.abs(Zt) > 1e-6 && (Pe += `
N \u2248 ${Pt(Zt * Be)} ${Ke.forceUnit}`), Math.abs(qs) > 1e-6 && (Pe += `
T \u2248 ${Pt(qs * Be)} ${Ke.forceUnit}\xB7m`), Math.abs(ms) > 1e-6 && (Pe += `
My \u2248 ${Pt(ms * Be)} ${Ke.forceUnit}\xB7m`), Math.abs(un) > 1e-6 && (Pe += `
Mz \u2248 ${Pt(un * Be)} ${Ke.forceUnit}\xB7m`);
              }
            }
          }
        }
  ...
  function lc(l, e) {
    ...
    function r() {
      ...
      if (Q.forEach((Ee, Be) => {
        ...
        const Dt = X[Ee[0]], ot = X[Ee[1]];
        if (!Dt || !ot) return;
        const Tt = Dn(Dt, s.plano), qt = Dn(ot, s.plano);
        Math.abs(Tt.fuera - s.en) < Os && Math.abs(qt.fuera - s.en) < Os && ae.push({
          i: Be,
          a: Tt,
          b: qt
        });
      ...
      const Se = le - ie || 1, ve = pe - he || 1, Ae = 0.12 * Math.max(Se, ve), Ve = 46, it = Math.min((ue - 2 * Ve) / (Se + 2 * Ae), (be - 2 * Ve) / (ve + 2 * Ae)), wt = (ue - Se * it) / 2, Ce = (be - ve * it) / 2, ce = (Ee) => wt + (Ee - ie) * it, _e = (Ee) => be - (Ce + (Ee - he) * it), ge = "http://www.w3.org/2000/svg", xe = (Ee, Be, Dt) => {
        const ot = document.createElementNS(ge, Ee);
        for (const Tt in Be) ot.setAttribute(Tt, String(Be[Tt]));
        return Dt != null && (ot.textContent = Dt), P.appendChild(ot), ot;
      }, Ne = /* @__PURE__ */ new Map();
      for (const Ee of ae) {
        const Be = ((_h = (_g = (_f = (_e2 = l.elementInputs) == null ? void 0 : _e2.rawVal) == null ? void 0 : _f.localAngles) == null ? void 0 : _g.get) == null ? void 0 : _h.call(_g, Ee.i)) ?? 0, Dt = Dn(rl(R ?? "normals", ll(X[Q[Ee.i][0]], X[Q[Ee.i][1]], Be)), s.plano), ot = Math.hypot(Dt.u, Dt.v);
        Ne.set(Ee.i, ot > 0.3 ? [
          Dt.u / ot,
          -Dt.v / ot
        ] : null);
      ...
      const Ie = 0.12 * Math.max(Se, ve) * it, Oe = Me > 0 ? Ie / Me : 0, Ye = R === "bendingsY" || R === "bendingsZ", $e = (Ee) => Math.abs(Ee) >= 100 ? Ee.toFixed(1) : Math.abs(Ee) >= 10 ? Ee.toFixed(2) : Ee.toFixed(3), Qe = [];
      for (const Ee of ae) {
        const Be = ce(Ee.a.u), Dt = _e(Ee.a.v), ot = ce(Ee.b.u), Tt = _e(Ee.b.v), qt = Ne.get(Ee.i), [lt, et] = qt ?? [
          0,
          0
        ], Pe = re && qt ? re instanceof Map ? re.get(Ee.i) : re[Ee.i] : null, [st, Re] = Pe ? $o(R, Pe) : [
          0,
          0
        ];
        if (Pe && Oe > 0) {
          const Ge = [
            ...
            ot + lt * Re * Oe * 1,
            Tt + et * Re * Oe * 1
          ], mt = st + Re >= 0 ? "#3fa7d6" : "#d9534f";
          xe("polygon", {
            points: `${Be},${Dt} ${Ge[0]},${Ge[1]} ${at[0]},${at[1]} ${ot},${Tt}`,
            fill: mt,
            "fill-opacity": 0.38,
            stroke: mt,
            "stroke-width": 1.2
    ...
    function S() {
      ...
      let W = 0, V = -1;
      U.forEach((le, he) => {
        const [pe, Se] = P[le], ve = he === 0 ? U.length > 1 && P[U[1]].includes(pe) : pe !== V, Ae = ve ? Se : pe, Ve = ve ? pe : Se, it = Math.hypot(A[Ve][0] - A[Ae][0], A[Ve][1] - A[Ae][1], A[Ve][2] - A[Ae][2]);
        G.push({
          x: W,
          e: le,
          fin: ve ? 1 : 0
      ...
      for (const [le, he, pe, Se] of Q) {
        const ve = G.map((Me) => D(le, Me)), Ae = Math.max(...ve), Ve = Math.min(...ve), it = Math.max(Math.abs(Ae), Math.abs(Ve)) || 1, wt = (Me) => ae + Me / (q || 1) * (ue - 2 * ae), Ce = (Me) => ie + (Se ? 1 : -1) * (Me / it) * (ie - 16), ce = (Me) => Math.abs(Me) >= 100 ? Me.toFixed(1) : Math.abs(Me) >= 10 ? Me.toFixed(2) : Me.toFixed(3);
        let _e = wt(0) + "," + ie + " ";
        G.forEach((Me, Ie) => {
          _e += wt(Me.x) + "," + Ce(ve[Ie]) + " ";
        }), _e += wt(q) + "," + ie;
        const ge = ve.indexOf(Ae), xe = ve.indexOf(Ve), Ne = (Me, Ie) => {
          ...
          return '<text x="' + wt(G[Me].x) + '" y="' + Oe + '" text-anchor="middle" fill="' + Ie + '" font-size="11" font-weight="700" paint-order="stroke" stroke="#0b0e14" stroke-width="3">' + ce(ve[Me]) + "</text>";
        }, ze = Se ? "#d9534f" : "#3fa7d6";
  ...
  bd = function({ mesh: l, settingsObj: e, drawingObj: t, objects3D: s, solids: n }) {
    ...
    return ve.append(wt()), ve.append(Ae("\u2191", "Pan arriba", () => Ve(0, 1))), ve.append(Ae("\u2295", "Zoom in", () => it(0.85))), ve.append(Ae("\u2190", "Pan izquierda", () => Ve(-1, 0))), ve.append(Ae("\u2302", "Reset vista", () => {
      p.reset(), le();
    })), ve.append(Ae("\u2192", "Pan derecha", () => Ve(1, 0))), ve.append(Ae("\u2296", "Zoom out", () => it(1.18))), ve.append(Ae("\u2193", "Pan abajo", () => Ve(0, -1))), ve.append(wt()), getComputedStyle(i).position === "static" && (i.style.position = "relative"), typeof window.matchMedia == "function" && window.matchMedia("(pointer: coarse)").matches && i.appendChild(ve), i;
  };
  let La = "";
  function dl(l) {
...
`, " - or if errorr ", {
  ...
  let ct = new ut(), Gt = new xc(), ul = new wc(), Ln = new bc();
  vc = class extends cn {
    constructor(e) {
        ...
        if (e == null) for (let c = 0; c < this.items.length; c++) {
          ...
          if (typeof i.onRefresh != "function" || (r = this.trigger("refresh", {
            ...
            if ([
              ...
              }), Gt.update(this.name + "-drop", i.items);
            }
  ...
  _d = class extends cn {
    ...
    searchSuggest(e, t, s) {
      ...
      clearTimeout(this.last.kbd_timer), clearTimeout(this.last.overlay_timer), this.searchShowFields(true), this.searchClose(), t === true ? ct.hide(this.name + "-search-suggest") : 0 < h(`#w2overlay-${this.name}-search-suggest`).length || (e ? (t = h(this.box).find(`#grid_${this.name}_search_all`).get(0), e = [
        ...
        ...this.savedSearches ?? []
      ], Array.isArray(e) && 0 < e.length && Gt.show({
   ...
   EXPECTED:`, {
    ...
    columnContextMenu(e, t) {
      e = this.trigger("columnContextMenu", {
        ...
        field: e,
        originalEvent: t
      }), e.isCancelled !== true && (this.show.columnMenu && (Gt.show({
        type: "check",
    ...
    showContextMenu(e, t, s) {
      if (this.last.userSelect != "text") {
        ...
        i.isCancelled !== true && (0 < this.contextMenu.length && (Gt.show({
          anchor: document.body,
          originalEvent: s,
        ...
        if (D > U && (D = U), R >= U - 1 && (R = U), h(this.box).find("#grid_" + this.name + "_footer .w2ui-footer-right").html((this.show.statusRange ? y.formatNumber(this.offset + D) + "-" + y.formatNumber(this.offset + R) + (this.total != -1 ? " " + y.lang("of") + " " + y.formatNumber(this.total) : "") : "") + (s && this.show.statusBuffered ? " (" + y.lang("buffered") + " " + y.formatNumber(U) + (0 < this.offset ? ", skip " + y.formatNumber(this.offset) : "") + ")" : "")), s || this.fixedBody && !(this.total != -1 && this.total <= this.vs_start)) {
          let Se = function() {
            t.markSearch && (clearTimeout(t.last.marker_timer), t.last.marker_timer = setTimeout(() => {
              var ve = [];
              for (let it = 0; it < t.searchData.length; it++) {
                var Ae = t.searchData[it], Ve = t.getSearch(Ae.field);
              ...
              0 < ve.length && ve.forEach((it) => {
                var wt = h(t.box).find('td[col="' + it.col + '"]:not(.w2ui-head)');
                y.marker(wt, it.search);
              });
            }, 50));
  ...
  class Ci extends cn {
    ...
    set(e, t) {
      [
        ...
        "enum",
        "file"
      ].indexOf(this.type) !== -1 ? (this.type !== "list" && t ? (Array.isArray(this.selected) || (this.selected = []), this.selected.push(e), (t = Gt.get(this.el.id + "_menu")) && (t.options.selected = this.selected)) : (e == null && (e = []), t = this.type !== "enum" || Array.isArray(e) ? e : [
        e
    ...
    setIndex(e, t) {
      if ([
        ...
        if (s && s[e]) return this.type == "list" && (this.selected = s[e]), this.type == "enum" && (t || (this.selected = []), this.selected.push(s[e])), (t = Gt.get(this.el.id + "_menu")) && (t.options.selected = this.selected), h(this.el).trigger("input").trigger("change"), this.refresh(), true;
      }
      return false;
    }
    refresh() {
    ...
    keyDown(e, i) {
      ...
      if ([
        ...
        case 8:
        case 46:
          this.type == "list" ? h(this.helpers.search_focus).val() == "" && (this.selected = null, Gt.hide(this.el.id + "_menu"), h(this.el).val("").trigger("input").trigger("change")) : h(this.helpers.multi).find("input").val() == "" && (Gt.hide(this.el.id + "_menu"), this.selected.pop(), (s = Gt.get(this.el.id + "_menu")) && (s.options.selected = this.selected), this.refresh());
          break;
        case 9:
        case 16:
          break;
        case 27:
          Gt.hide(this.el.id + "_menu"), this.refresh();
      }
    }
    keyUp(e) {
      var _a2, _b;
      if (this.type == "list") {
        ...
        n.val() !== "" ? h(this.el).attr("placeholder", "") : h(this.el).attr("placeholder", this.tmp.pholder), e.keyCode == 13 && setTimeout(() => {
          n.val(""), Gt.hide(this.el.id + "_menu"), this.refresh();
        }, 1), [
          38,
          40
    ...
    findItemIndex(e, t, s) {
      ...
      return s = s || [], [
        ...
        "combo",
        "enum"
      ].includes(this.type) && this.options.url && (i = Gt.get(this.el.id + "_menu")) && (e = i.options.items, this.options.items = e), e.forEach((o, a) => {
        o.id === t && (n = s.concat([
          a
        ]), this.options.index = [
          a
    ...
    updateOverlay(e) {
      ...
      if ([
        ...
        }), this.tmp.overlay = Gt.show(s).select((i) => {
          var _a2;
          var o, a;
          [
            "list",
            ...
            item: o,
            originalEvent: i
          })).isCancelled !== true && (a.length >= t.max && 0 < t.max && a.pop(), delete o.hidden, a.push(o), h(this.el).trigger("input").trigger("change"), h(this.helpers.multi).find("input").val(""), (a = Gt.get(this.el.id + "_menu")) && (a.options.selected = this.selected), i.finish()));
        }));
      }
      ![
        "date",
