...
import { n as J, o as N, g as Z, c as q, __tla as __tla_0 } from "./aiAgent-86HwhYYU.js";
import { g as Q, __tla as __tla_1 } from "./getParameters-vOEFDHQf.js";
import { g as W, __tla as __tla_2 } from "./getTables--vAmAiVy.js";
import { g as Y, __tla as __tla_3 } from "./getDialog-C95RxgyF.js";
import { g as tt, __tla as __tla_4 } from "./getReport-tdzvIAN4.js";
import { a as et, __tla as __tla_5 } from "./analyze-DtswgObf.js";
import { d as at, __tla as __tla_6 } from "./didacticCpp-ClOTguHC.js";
import { g as st, a as lt, b as ot, c as H, d as A, __tla as __tla_7 } from "./getSolids-D0cNR5Lh.js";
import "./tweakpane-BXg6ZhiP.js";
import "./pureFunctionsAny.generated-DeJSBP3k.js";
import { __tla as __tla_8 } from "./getMesh-zo4pg-oR.js";
...
`, document.head.appendChild(n), a;
  ...
  function rt(a, s, n, l, u, C) {
    ...
    const B = M.map((i) => Number((u * 1e6 * i / k).toFixed(2))), G = Math.max(...B), F = a.f_mk * C, _ = B.map((i) => Number((i / F).toFixed(2))), O = Math.max(..._);
    return {
      slabHeight: b,
      thicknesses: o,
      zCordsFromMid: M,
  ...
  const dt = "" + new URL("logo-DnnuEFJ2.png", import.meta.url).href, mt = "" + new URL("clt-bending-stress-DvR3Ux1R.png", import.meta.url).href, ct = ({ designMomentInput: a, designOutputs: s }) => N`
    <div id="report">
      <header class="header">
  ...
  function gt() {
    w === "1st-floor" ? c.val = [] : (m.val = [], h.val = []), f.val = [], S.val = [], e.points.val = [], e.columns.val = [], e.slabs.val = [], e.columnsByStory.val = /* @__PURE__ */ new Map(), e.slabsByStory.val = /* @__PURE__ */ new Map(), e.columnData.val = /* @__PURE__ */ new Map(), e.slabData.val = /* @__PURE__ */ new Map(), r.nodes.val = [], r.elements.val = [], r.nodeInputs.val = {}, L.geometry = H(e.points.val, e.slabs.val, e.columns.val), I.geometry = A(e.points.val, e.slabs.val, e.columns.val), g.val = [
      ...g.rawVal
    ];
  }
  t.derive(() => {
    w == "1st-floor" && (c.val = f.val), w == "2nd-floor" && (m.val = f.val, h.val = S.val);
  });
  t.derive(() => {
  ...
  t.derive(() => {
    ...
    L.geometry = H(e.points.val, [], e.columns.val), I.geometry = A(e.points.val, e.slabs.val, e.columns.val), g.val = [
      ...g.rawVal
    ], r.deformOutputs.val = at(a, s, n, l), r.analyzeOutputs.val = et(a, s, l, r.deformOutputs.val), T.val = Math.max(...Array.from(r.analyzeOutputs.val.bendingXX.values()).flat()) * 1e-3, U.val = rt({
      f_mk: 24
