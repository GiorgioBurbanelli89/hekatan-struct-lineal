...
import { a as G, __tla as __tla_0 } from "./analyze-CC0LMJ9d.js";
import { d as E, __tla as __tla_1 } from "./didacticCpp-BoYi16rL.js";
import { g as K, c as N, __tla as __tla_2 } from "./aiAgent-DZGNXC2w.js";
import { g as T, __tla as __tla_3 } from "./getParameters-BOAc21Cg.js";
...
Promise.all([
  ...
  }, z = o.state([]), S = o.state([]), P = o.state({}), R = o.state({}), C = o.state({}), j = o.state({}), c = 3;
  o.derive(() => {
    const m = Math.round(i.nFloors.value.val), k = i.H_floor.value.val, H = i.baseR.value.val, A = i.windFactor.value.val, l = [], s = [];
    for (let t = 0; t <= m; t++) {
      const e = t / m, u = t * k;
      let d = H * (1 - e * 0.7);
      ...
      for (let n = 0; n < c; n++) {
        const p = n * 2 * Math.PI / c - Math.PI / 2, a = d * Math.cos(p), _ = d * Math.sin(p), x = l.length;
        l.push([
          a,
          _,
          u
    ...
    const w = 1 + c * 2, b = /* @__PURE__ */ new Map();
