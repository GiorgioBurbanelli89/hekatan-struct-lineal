...
import { s as q, __tla as __tla_0 } from "./didacticCpp-ClOTguHC.js";
import { g as A, __tla as __tla_1 } from "./getMesh-zo4pg-oR.js";
import { g as Y, c as C, __tla as __tla_2 } from "./aiAgent-86HwhYYU.js";
import { g as L, __tla as __tla_3 } from "./getParameters-vOEFDHQf.js";
...
Promise.all([
  ...
  a.derive(() => {
    ...
    for (let e = 0; e < n.length; e++) {
      const i = n[e][0], l = n[e][1];
      Math.abs(l + c) < 1e-6 ? (v.push({
        node: e,
        fixX: true,
        fixY: true
      }), h.set(e, [
    ...
    try {
      ...
      for (let t = 0; t < l.displacements.length; t++) {
        const [o, b] = l.displacements[t];
        $.set(t, [
          o,
          0,
          b,
      ...
      for (let t = 0; t < l.plasticStrain.length; t++) {
        const o = l.plasticStrain[t];
        T.set(t, [
          o,
          o,
          o
      ...
      let f = 0;
      for (const [t, o] of l.displacements) {
        const b = Math.sqrt(t * t + o * o);
        f = Math.max(f, b);
      }
      let d = 0;
      for (const t of l.plasticStrain) d = Math.max(d, t);
      console.log(`Talud SRM: ${n.length} nodos, ${r.length} tri\xE1ngulos | H=${m} \u03B1=${g}\xB0 c=${M} \u03C6=${w}\xB0 \u03B3=${S} | FOS=${l.fos.toFixed(3)} max|u|=${f.toExponential(3)} \u03B5_pl_max=${d.toExponential(3)}`), l.fos < 1 ? console.warn("\u26A0 TALUD INESTABLE (FOS < 1.0)") : l.fos < 1.5 && console.warn("\u26A0 FOS < 1.5 \u2014 revisar estabilidad");
    } catch (e) {
