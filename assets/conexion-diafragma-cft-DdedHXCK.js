...
import { v as i } from "./Text-BE1eWO-3.js";
import { P as $t } from "./tweakpane-BXg6ZhiP.js";
import { a as Ut, __tla as __tla_0 } from "./analyze-4AlEzwQI.js";
import { d as Gt, __tla as __tla_1 } from "./didacticCpp-Czy7NlhT.js";
import { g as Yt, i as gt, j as yt, a as Zt, __tla as __tla_2 } from "./aiAgent-DXUgOPxy.js";
import { e as Rt } from "./makeDraggable-zx2br6Yh.js";
import { g as Jt, __tla as __tla_3 } from "./getParameters-Di5RhpFO.js";
...
Promise.all([
  ...
  i.derive(() => {
    ...
    const z = [], it = /* @__PURE__ */ new Set(), F = (t) => {
      const e = t.toFixed(5);
      it.has(e) || (it.add(e), z.push(t));
    };
    for (let t = 0; t <= V; t++) F(t * N / V);
    F(w), F($), F(O), z.sort((t, e) => t - e);
    const ct = l / u, rt = d / u, A = (t, e, b, s, a, o) => {
      ...
      for (let n = 0; n < z.length - 1; n++) for (let c = 0; c < a; c++) g(f[n][c], f[n][c + 1], f[n + 1][c + 1], f[n + 1][c], o);
      return f;
    };
    ...
    function mt(t) {
      ...
      for (let n = 0; n < s; n++) {
        ...
        for (let r = 0; r < u + 2; r++) {
          ...
          g(m(x, c, t), m(h, c, t), m(h, p, t), m(x, p, t), S);
        }
      }
      for (let n = 0; n < s; n++) {
        const c = -a - n / s * (o - a), p = -a - (n + 1) / s * (o - a);
      ...
      for (let n = 0; n < s; n++) {
        ...
        for (let r = 0; r < u; r++) {
          ...
          g(m(c, x, t), m(p, x, t), m(p, h, t), m(c, h, t), S);
        }
      }
      for (let n = 0; n < s; n++) {
        const c = -f - n / s * M, p = -f - (n + 1) / s * M;
    ...
    for (let t = 0; t < j; t++) for (let e = 0; e < I; e++) g(y[t][e], y[t][e + 1], y[t + 1][e + 1], y[t + 1][e], Bt);
    const ut = (t) => {
      const b = T / 4, s = [];
      for (let a = 0; a <= I; a++) {
        const o = [], f = d / 2 + a * dt;
        for (let n = 0; n <= 4; n++) {
          const c = -T / 2 + n * b;
          Math.abs(c) < 1e-7 ? Math.abs(t - O) < 1e-6 ? o.push(y[j][a]) : Math.abs(t - w) < 1e-6 ? o.push(y[0][a]) : o.push(m(0, f, t)) : o.push(m(c, f, t));
        }
        s.push(o);
      }
  ...
  jt.addBinding(C, "vmMax", {
    readonly: true,
    label: "\u03C3 vM max (kN/m\xB2)",
    format: D
  });
  jt.addBinding(C, "ratio", {
    readonly: true,
