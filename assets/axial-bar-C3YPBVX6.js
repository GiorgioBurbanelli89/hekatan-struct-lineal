...
import { a as P, __tla as __tla_0 } from "./analyze-CoM5hauA.js";
import { d as T, __tla as __tla_1 } from "./didacticCpp-Czy7NlhT.js";
import { g as G, a as V, __tla as __tla_2 } from "./aiAgent-DlwrNRGZ.js";
import { g as j, __tla as __tla_3 } from "./getParameters-MpK2zdCh.js";
...
Promise.all([
  ...
  }, F = o.state([]), M = o.state([]), w = o.state({}), z = o.state({}), k = o.state({}), L = o.state({}), _ = document.createElement("div");
  ...
  o.derive(() => {
    const l = i.E_gpa.value.val * 1e6, n = i.A_cm2.value.val * 1e-4, r = i.L_m.value.val, d = i.F_kN.value.val, s = i.nElem.value.val, m = [], a = [], v = r / s;
    ...
    }, p = T(m, a, E, u), R = P(m, a, u, p);
    F.val = m, M.val = a, w.val = E, z.val = u, k.val = p, L.val = R;
    const c = d * r / (l * n), S = l * n / (r / s), x = p.deformations;
    let f = 0;
    if (x) {
      const e = x.get(s);
      e && (f = e[0]);
    ...
    <div>  L = ${r} m  (${s} elem \xD7 ${v.toFixed(2)} m)</div>
    <div>  F = ${d} kN</div>
    <br/>
    ...
    <div style="color:#aaa;margin-top:4px;">
      Reaccion nodo 0: R_x = ${I.toFixed(4)} kN  (debe ser -${d} kN)
    </div>
    <br/>
