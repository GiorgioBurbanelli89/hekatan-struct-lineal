...
| **Shell forces, joint by joint** (`AreaForceShell` M11/M22/M12 at the 4 joints of every shell, unaveraged) — Shell-Thin = DKQ evaluated at 2×2 Gauss and extrapolated | ETABS 22, templates portico-losa / losa-plana / losa-vigas-borde / dual (3600–3760 joints each) · SAP2000 24 | **0.0000 %** vs ETABS in all four (centroid, joint and node); 0.5–0.9 % vs SAP2000 = what SAP and ETABS differ from each other | ✅ 2026-09-08 |
| **Shell forces, Shell-Thick** (CSI formulation extracted from the binary, 10 internal DOFs recovered) | SAP2000 24: 4×4 plate 8×8 (256 joints) · SAP2000 + ETABS: flat slab building with thick slab (3600 joints) | **0.026 %** joint by joint, centre 7.4170 vs 7.4169 · **0.075 %** (both programs agree) | ✅ 2026-09-08 |
...
| **Edge constraint, interpolated** (`OBJMESHTYPE "NONE"`, hanging joint at 0.35 of a 2 m edge) | ETABS 22 by e2k | w at the hanging joint = **Hermite cubic** in w with the end rotations (0.11 %), not linear (2.8 %); rotations ≈ linear (1 %). Not implemented in Hekatan (its default = `deck etabs`, which is what ETABS does by default) | ⏳ measured 2026-09-08 |
