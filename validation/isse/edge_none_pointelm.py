...
try:
    edb = os.path.abspath("validation/isse/edge_none/etabs/edb/edge_none.EDB")
    ...
    json.dump(out, open("validation/isse/edge_none/etabs/edge_none_pointelm.json", "w"), indent=1)
finally:
