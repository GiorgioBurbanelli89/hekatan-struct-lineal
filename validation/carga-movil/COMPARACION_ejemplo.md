...
| campo | pico Hekatan | SAP2000 (juez) | OpenSeesPy |
|---|---|---|---|
| Ux (mm) | 3.4588 | 0.0000 % | 0.0000 % |
| Uz (mm) | 5.8512 | 0.0000 % | 0.0000 % |
| Ry (rad) | 0.0021306 | 0.0000 % | 0.0000 % |
| P (kN) | 128.93 | 0.0000 % | 0.0000 % |
| V2 (kN) | 129.40 | 0.0000 % | 0.0000 % |
| M3 (kN·m) | 77.760 | 0.0000 % | 0.0000 % |

## Envolvente del camión (147 posiciones, separación trasera fija)

| valor | Hekatan | SAP2000 (juez) | OpenSeesPy |
|---|---|---|---|
| M3 máx (kN·m) | 71.5127 | 71.5127 (0.0000 %) | 71.5127 (0.0000 %) |
| M3 mín (kN·m) | -77.7595 | -77.7595 (0.0000 %) | -77.7595 (0.0000 %) |
| |V2| máx (kN) | 129.3978 | 129.3978 (0.0000 %) | 129.3978 (0.0000 %) |
| |P| máx (kN) | 128.9331 | 128.9331 (0.0000 %) | 128.9331 (0.0000 %) |
| Uz mín (mm) | -5.8512 | -5.8512 (0.0000 %) | -5.8512 (0.0000 %) |
| asiento máx losa inf. (mm) | -5.8075 | -5.8075 (0.0000 %) | -5.8075 (0.0000 %) |
...
### SAP2000 (juez) (8184 posiciones)

| envolvente | valor | Hekatan (app) | SAP2000 (juez) | dif |
|---|---|---|---|---|
