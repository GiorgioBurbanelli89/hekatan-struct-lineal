...
edb = os.path.abspath("validation/modelos/plantillas/etabs_fix/edb/P2.EDB")
...
sm.File.Save(os.path.abspath("validation/modelos/plantillas/etabs_fix/P2_lat2.EDB")); sm.Analyze.SetRunCaseFlag("", True, True); print("run", sm.Analyze.RunAnalysis())
...
json.dump({"cargas": cargas, "nudos": out}, open("validation/modelos/plantillas/etabs_fix/P2_lat2.json", "w"), indent=1)
