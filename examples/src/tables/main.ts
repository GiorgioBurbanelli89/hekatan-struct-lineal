...
import { getViewer, getTables, getToolbar, getDialog } from "hekatan-ui";
...
document.body.append(
  getToolbar({
    ...
    buttons: ["Tables"],
    sourceCode:
      "https://github.com/GiorgioBurbanelli89/hekatan-struct-lineal/blob/main/examples/src/tables/main.ts",
